...
CODEBASE="http://www.pmmintranet.net/web_capacitacion/activexs/ImpEtiqueta.CAB#version=1,0,0,0">
</OBJECT>-->
<!--OBJECT ID="Etiqueta1"
CLASSID="CLSID:0124E5BC-E21C-4A00-B1F2-ED81FDBD9D40"
CODEBASE="http://www.pmmintranet.net/web_capacitacion/activexs/ImpEtiqueta.CAB#version=3,0,0,0">
</OBJECT -->
<OBJECT ID="Etiqueta1"
CLASSID="CLSID:0124E5BC-E21C-4A00-B1F2-ED81FDBD9D40"
CODEBASE="ImpEtiqueta.CAB#version=4,0,0,0">
</OBJECT>
<!--[if lte IE 6]><link href="css/styleie6.css" rel="stylesheet" type="text/css" /><![endif]--> 
<script>
	//declaracion de tablashey dime cual te mando tu tia
	<?
		$s = "SELECT id,descripcion FROM catalogosucursal";
	...
	/*Etiqueta1.Datos_Paqueteria = "entregas puntuales|s de rl de cv|av. benemerito de las americas 301|palos prietos|mazatlan, sinaloa|epu1004244x2"
    Etiqueta1.Datos_Paquetes = "760000000200A|07/09/2010 20:20|10000 P.VOL: 139.5   P. KG: 201.5"
    Etiqueta1.Contenido_Paquetes = "1|CAJA(S)|Colageno|40x80x80|488 KG|64 KG|"
    Etiqueta1.Datos_Remitente = "Gnt Val s De Rl De Cv|CTE: 17372    RFC: GNT090220396|Av. La Calma 3775 NO 0|ARBOLEDAS 1A SECC C.P. 45070|ZAPOPAN|TEL:"
    Etiqueta1.Datos_Destinatario = "MARIA EUGENIA SEGOVIA|23424    RFC:  |BURGOS 4113 |LAS TORRES C.P. 64103|MONTERREY |SIN SECTOR   TEL: 018183658175 "
    Etiqueta1.Datos_Guia = "TLQ|MTY|TIPO DE ENTREGA: EAD|TIPO DE FLETE: POR COBRAR|VALOR DECLARADO: 0|CONDICION DE PAGO: CONTADO|DOCUMENTO: TLQ1581"
    Etiqueta1.Datos_Totales = "LA OBSERVACION|588.00|0.00|58.84|8.00|655.22|104.84|0.00|760.06|58.84|0.00|0.00|0.00|0.00|54.84|322020100907X4760"
   
    Etiqueta1.Cargar_Datos()
    Etiqueta1.Imprimir_GuiaCliente()
    Etiqueta1.Imprimir_GuiaDestino()
    Etiqueta1.Imprimir_Paquetes()*/
	
	Etiqueta1.Impresora_Guias = "Etiquetadora 1"
    Etiqueta1.Impresora_Paquetes = "Etiquetadora 2"
    ...
    Etiqueta1.Imprimir_Paquetes();
		...
		Etiqueta1.Impresora = "Etiquetadora1"
		Etiqueta1.Datos_Paqueteria = "<?=$f->eti_nombre1?>|<?=$f->eti_nombre2?>|<?=$f->eti_direccion?>|<?=$f->eti_colonia?>|<?=$f->eti_ciudad?>|<?=$f->eti_rfc?>"
		Etiqueta1.Datos_Paquetes = folioimprimir+"|<?=date('d/m/Y')?>|"+u.totalpaquetes.value+" P.VOL: "+u.totalvolumen.value+"   P. KG: "+u.totalpeso.peso
		Etiqueta1.Contenido_Paquetes = detalle
		Etiqueta1.Datos_Remitente = u.rem_cliente.value+"|CTE: "+u.idremitente.value+"    RFC: "+u.rem_rfc.value+"|"+u.rem_calle.value+"|"+u.rem_colonia.value+" "+u.rem_numero.value+"C.P. "+u.rem_cp.value+"|"+u.rem_poblacion.value+"|TEL:"+u.rem_telefono.value
		Etiqueta1.Datos_Destinatario = u.des_cliente.value+"|CTE: "+u.iddestinatario.value+"    RFC: "+u.des_rfc.value+"|"+u.des_calle.value+"|"+u.des_colonia.value+" "+u.des_numero.value+"C.P. "+u.des_cp.value+"|"+u.des_poblacion.value+"|TEL:"+u.des_telefono.value
		
		Etiqueta1.Datos_Guia = obtenerPrefijos[<?=$_SESSION[IDSUCURSAL]?>]+"|"+obtenerPrefijos[document.all.sucdestino_hidden.value]+"|TIPO DE ENTREGA: "+((u.chocurre.value==0)?"EAD":"OCURRE")+"|TIPO DE FLETE: "+((u.lstflete.value==0)?"PAGADA":"POR COBRAR")+"|VALOR DECLARADO: "+u.txtdeclarado.value+"|CONDICION DE PAGO: "+u.lstpago.value+"|DOCUMENTO: <?=$_SESSION[NOMBREUSUARIO]?>"
	...
	function imprimirDocumentos(valor,folio){
		if(valor!=6 && valor!=2  && valor!=4){
			...
			?>
			window.open("../guias/imprimiretiquetaguia_elegir.php?valor="+valor+"&folio="+folio+"&tipo=1&codigo="+folioimprimir,"1","width=3 height=3 left=2500 top=1500");
		}else{
			cambiarImpresora1_solo(valor,folio);
		}
	}
	
	function cambiarImpresora1_solo(valor,folio){
		<? /*
		...
		?>
		//window.open("../guias/imprimiretiquetapaquete_elegir.php?valor="+valor+"&folio="+folio+"&tipo=1&codigo="+folioimprimir,"2","width=3 height=3 left=2500 top=1500");
		...
		Etiqueta1.Impresora = "Etiquetadora1"
		Etiqueta1.Datos_Paqueteria = "entregas puntuales|s de rl de cv|av. benemerito de las americas 301|palos prietos|mazatlan, sinaloa|epu1004244x2"
		Etiqueta1.Datos_Paquetes = "760000000200A|07/09/2010 20:20|1 P.VOL: 139.5   P. KG: 201.5"
		Etiqueta1.Contenido_Paquetes = "1|CAJA(S)|Colageno|40x80x80|488 VOL|64 KG"
		Etiqueta1.Datos_Remitente = "Gnt Val s De Rl De Cv|CTE: 17372    RFC: GNT090220396|Av. La Calma 3775 NO 0|ARBOLEDAS 1A SECC C.P. 45070|ZAPOPAN|TEL:"
		Etiqueta1.Datos_Destinatario = "MARIA EUGENIA SEGOVIA|23424    RFC:  |BURGOS 4113 |LAS TORRES C.P. 64103|MONTERREY |SIN SECTOR   TEL: 018183658175 "
		Etiqueta1.Datos_Guia = "TLQ|MTY|TIPO DE ENTREGA: EAD|TIPO DE FLETE: POR COBRAR|VALOR DECLARADO: 0|CONDICION DE PAGO: CONTADO|DOCUMENTO: TLQ1581"
		Etiqueta1.Datos_Totales = "LA OBSERVACION|588.00|0.00|58.84|8.00|655.22|104.84|0.00|760.06|58.84|0.00|0.00|0.00|0.00|54.84|322020100907X4760"
	...
	function cambiarImpresora1(){
		...
		?>
		//window.open("imprimiretiquetapaquete.php?tipo=1&codigo="+folioimprimir,"2","width=3 height=3 left=2500 top=1500");
	}
	...
	function calcularservicios(){
		u = document.all;
			...
			//alert("xx");
			if(u.pc_recoleccion.value != "" && u.pc_recoleccion.value != " " && u.t_txtrecoleccion.value != "" && u.txtrecoleccion.value != "" && u.txtrecoleccion.value!= " "){
...
<div class="content" style="width:830px">
  ...
  <div class="observaciones" style="height:280px"> 
    ...
    <strong style="width:400px; margin-left:5px;" id="embarcadafaltantes"></strong>
...
<input type="button" name="imprimir" value="Imprimir" onclick="imprimirAuto()" />
</body>
</html>
