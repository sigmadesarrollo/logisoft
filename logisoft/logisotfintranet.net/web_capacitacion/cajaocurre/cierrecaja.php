...
<script>
	...
	function obtenerTotales(){
		consultaTexto("mostrarTotales","cajaocurre_con.php?accion=1&fecha="+u.fecha.value+"&rd="+Math.random());
	}
	...
	function cierreCaja(cierre){
		/*if(cierre=="parcial"){
			u.d_parcial.style.visibility = "hidden";
			consultaTexto("registroParcial","cajaocurre_con.php?accion=2&tipo=parcial&efectivo="+u.efectivo.value
			+"&cheque="+u.cheque.value+"&tarjeta="+u.tarjeta.value+"&transferencia="+u.transferencia.value
			+"&fecha="+u.fecha.value+"&iniciocaja="+u.iniciocaja.value+"&val="+Math.random());
		}else{*/
		u.d_definitivo.style.visibility = "hidden";
		consultaTexto("registroDefinitivo","cajaocurre_con.php?accion=2&tipo=definitivo&efectivo="+u.efectivo.value
		+"&cheque="+u.cheque.value+"&tarjeta="+u.tarjeta.value+"&transferencia="+u.transferencia.value
...
/*		if(datos.indexOf("ok")>-1){
			...
			u.parcial.value = "parcial";
			
		}else{
			u.d_parcial.style.visibility = "visible";
			alerta3("Hubo un error al tratar de hacer el cierre parcial "+datos,"¡Atención!");
		}*/
	}
	...
	function obtenerParcial(){
		consultaTexto("mostrarParcial","cajaocurre_con.php?accion=3&fechacierrecaja="+u.fecha.value+"&s="+Math.random());
	}
