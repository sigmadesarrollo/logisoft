...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td background="imagen/bazul1.jpg" width=5 height=54></td>

        <td background="imagen/bazul2.jpg" width=150 class="style1">CONFIGURADOR FLETES </td>

        <td background="imagen/bazul3.jpg" width=59></td>

        <td background="imagen/bazul4.jpg">&nbsp;</td>
		  ...
		  <table width="666" border="0" cellpadding="0" class="Tablas" cellspacing="0">
			...
			<tr>
				 ...
				 <td colspan="4" class="Tablas">
				  ...
				  <form name="form2" method="post" action="" enctype="multipart/form-data" >
					  ...
					  <input type="hidden" name="txtpuede" value ="<?= $_POST[txtpuede]?>">
                   	  ...
                   	  <input name="btnbuscar" type="image" onClick="JavaScript:window.open('buscarconfiguracion.php', '_blank', 'titlebar=no,scrollbars=no,resizable=no,width=610,height=320');return false;" src="imagen/buscar.gif" alt="Buscar Configuraciones" width="16" height="17" <?=$disabled5?>>
		  	...
		  	<tr>
				...
				<td width="574">
					...
					<table width="562" border="0" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<input type="text" maxlength="12" size="12" style="font:tahoma;font-size:9px; text-transform:uppercase; " name="txtzonai" value="<?=$_POST[txtzonai]?>" onKeyPress="if(event.keyCode==13){document.all.txtzonaf.focus();return false;}else{return solonumeros(event);}" onKeyDown="if (window.event.keyCode==27){limpiar();document.form1.submit();return false;}">					
                            ...
                            <input type="text" maxlength="12" size="12" style="font:tahoma;font-size:9px; text-transform:uppercase; " name="txtzonaf" value="<?=$_POST[txtzonaf]?>" onKeyPress="if(event.keyCode==13){document.all.txtintervalozona.focus();return false;}else{return solonumeros(event);}" onKeyDown="if (window.event.keyCode==27){limpiar();document.form1.submit();return false;}">					
                            ...
                            <input type="text" maxlength="12" size="12" style="font:tahoma;font-size:9px; text-transform:uppercase;" name="txtintervalozona" value="<?=$_POST[txtintervalozona]?>" onKeyPress="if(event.keyCode==13){document.all.costo1.focus();return false;}else{return solonumeros(event);}" onKeyDown="if (window.event.keyCode==27){limpiar();document.form1.submit();return false;}">					
				...
				<input name="btncrear2" type="image" src="Boton_Agregari.gif" width="70" height="20" style="cursor:hand" onClick="if(validar()){pedirDatos(document.all.txtzonai.value,document.all.txtzonaf.value,document.all.txtintervalozona.value,document.all.txtclave2.value);return false;}else{return false;}" <?=$disabled?>>
			  ...
			  <td colspan="3" align="right">
			              ...
			              <hr class="boxlookLila">
      			          ...
      			          <input name="btnaceptar" type="image" src="Boton_Agregari.gif"  alt="F10"  value="Aceptar " <?=$disabled?> onClick="if(validar()){document.form1.submit();return false;} else else {return false;}">

						  <input name="btncancelar" type="image" src="Boton_Cancelar.gif"   value="Cancelar" onClick="limpiar();document.form2.value==0;document.form1.submit();void(0);">

						  <input name="btneliminar" type="image" src="Boton_Eliminar.gif"  value="Eliminar"  <?=$disabled2?> onClick="cnf=confirm('¿Esta Seguro de Eliminar la Configuracion?'); if(cnf==true){document.form1.txtstatus.value=3;document.form1.submit();return false;} else {return false;}">
