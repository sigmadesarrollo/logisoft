...
<script>
	...
	function registro(datos){
		if(datos.indexOf("ok")>-1){
			...
			window.open(document.location.href.replace("reporteFaltante.php","reporteFaltante_impre.php")+
						"&observaciones="+u.observaciones.value+"&folioreporte="+dat[1],null,"top=1500 left=5000 width=5 height=5");
  ...
  <table width="500" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
    ...
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td>Observaciones:</td>
          <td colspan="5"><textarea name="observaciones" id="observaciones" class="Tablas" style="width:400px; text-transform:uppercase" onblur="this.value=this.value.toUpperCase()"></textarea></td>
          </tr>
        <tr>
        ...
        <tr>
          <td colspan="6"><table border="0" align="right" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="84"><div class="ebtn_nuevo" id="d_nuevo" onclick="mens.show('C','&iquest;Desea limpiar los datos?','&iexcl;Atencion!','','','limpiar()')"></div></td>
            </tr>
          </table></td>
          </tr>
