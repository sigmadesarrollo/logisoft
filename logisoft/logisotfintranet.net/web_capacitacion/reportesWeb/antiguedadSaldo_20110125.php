...
<script>
	...
	function obtenerDetalle(){
		...
		consultaTexto("resTabla4","reportes_con.php?accion=5&sucursal="+u.sucursal_hidden.value+"&contador="+u.pag4_contador.value
	...
	function paginacion4(movimiento){
		switch(movimiento){
			case 'primero':
				consultaTexto("resTabla4","reportes_con.php?accion=5&contador=0&sucursal="+u.sucursal_hidden.value+
					  "&todassucursales="+u.todassucursales.checked+"&s="+Math.random());
				break;
			case 'adelante':
	...
	function imprimirReporte(){
		if(tabla4.getRecordCount()>0){
			if(document.URL.indexOf("web_capacitacionPruebas/")>-1){		
				var v_dir = "http://www.pmmintranet.net/web_capacitacionPruebas/general/cobranza/";
			...
			window.open(v_dir+"generarExcelAntiguedadSaldos.php?reporteweb=s&sucursal="+u.sucursal_hidden.value
			+"&val="+Math.random());
		}else{
      ...
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="80%"><table width="100%" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td width="83%"><input name="sucursal" type="text" id="sucursal" style="width:250px" autocomplete="array:desc" onkeypress="if(event.keyCode==13){document.all.sucursal_hidden.value = this.codigo; }" onblur="document.all.sucursal_hidden.value = this.codigo;" />
                  <img id="botonBuscar" src="../img/Buscar_24.gif" width="24" height="23" align="absbottom" style="cursor:pointer" onclick="abrirVentanaFija('../buscadores_generales/buscarsucursal.php', 600, 450, 'ventana', 'Busqueda');" /></td>
		  ...
		  <tr>
		  	<td colspan="5"><table align="right">
        	<tr>
            	<td>Vencido</td>
                <td>Al Corriente</td>
                <td>Total</td>
          ...
          <tr>
            <td colspan="5" ><div id="div_paginado4" align="center" style="visibility:hidden">
