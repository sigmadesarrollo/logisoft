...
<div class="content" style="width:830px">
  ...
  <div class="remi-desti">
    <div class="remi"> <img src="../css_ne/style/arrow.jpg" style="position:absolute; left:260px;"/>
      ...
      onClick="abrirVentanaFija('../buscadores_generales/buscarClienteGenGuia.php?funcion=devolverRemitente', 835, 418, 'ventana', 'Busqueda')"/>
    ...
    <div class="desti">
      ...
      <input type="button" id="b_destinatario" value=" " class="srch-btn" title="Buscar" onClick="abrirVentanaFija('../buscadores_generales/buscarClienteGenGuia.php?funcion=devolverDestinatario', 835, 418, 'ventana', 'Busqueda')"/>
