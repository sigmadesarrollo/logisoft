...
<script>
	...
	function imprimir(){
		...
		?>
		window.open("imprimiretiquetaguia.php?codigo="+document.all.folioSeleccionado.innerHTML,"1","width=500,height=500");
	}
	function cambiarImpresora1(){
		...
		?>
		window.open("imprimiretiquetapaquete.php?codigo="+document.all.folioSeleccionado.innerHTML,"2","width=500,height=500");
	}
	...
	function registrarGuia(){//registrar como no autorizada
		...
		//alerta3("guia_cargar_sustitucion_con.php?accion=1&folio="+u.idsustitucion.value+"&motivo="+u.motivocancelacion.value+"&rand="+Math.random());

		consulta("resNoAutorizada","guia_cargar_sustitucion_con.php?accion=2&folio="+u.idsustitucion.value+"&motivo="+u.motivocancelacion.value+"&rand="+Math.random())
            ...
            <tr>
              ...
              <td width="284" align="center">
              	...
              	<? if($_GET[desde]==1){ ?>
					...
					<img id="botonimprimir" src="../img/Boton_Imprimir.gif" onclick="imprimir()" style="cursor:hand; visibility:hidden">
                <? } ?>
