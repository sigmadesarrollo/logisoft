	...
	function imprimirEmbarque(){
		if(u.guardado.value == 1){		
			if(document.URL.indexOf("web_capacitacionPruebas/")>-1){		
				window.open("https://www.pmmintranet.net/web_capacitacionPruebas/fpdf/reportes/relacionEmbarque.php?sucursal=<?=$_SESSION[IDSUCURSAL]?>&folio="+u.folio.value+"&unidad="+u.unidad.value+"&fechaembarque="+u.fecha.value+"&destino="+u.destino.value);
