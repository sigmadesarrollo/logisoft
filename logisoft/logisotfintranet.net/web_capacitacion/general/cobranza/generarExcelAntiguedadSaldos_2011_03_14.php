...
<?
	...
	IFNULL(co.contrarecibo,'') AS contrarecibo, idcliente
	FROM reporte_cobranza1 rc1
	LEFT JOIN registrodecontrarecibos co ON rc1.factura = co.factura
	WHERE rc1.estado = 'ACTIVA' AND rc1.pagado = 'N' AND rc1.folio<>0 $and $folioCliente
...
?>
	<table width="1406">
    	...
    	<tr>
    	  <td width="70" style="font-weight:bold; border:#000 solid 1px"">SUCURSAL</td>
    	  <td width="126" style="font-weight:bold; border:#000 solid 1px"">GUIA/FACTURA</td>
    	  <td width="53" style="font-weight:bold; border:#000 solid 1px"">FECHA</td>
    	  <td width="73" style="font-weight:bold; border:#000 solid 1px"">FECHA VTO.</td>
    	  <td width="67" style="font-weight:bold; border:#000 solid 1px"">DIAS VENC.</td>
    	  <td width="103" style="font-weight:bold; border:#000 solid 1px"">AL CORRIENTE</td>
    	  <td width="73" style="font-weight:bold; border:#000 solid 1px"">1-15 DIAS</td>
    	  <td width="80" style="font-weight:bold; border:#000 solid 1px"">16-30 DIAS</td>
    	  <td width="72" style="font-weight:bold; border:#000 solid 1px"">31-60 DIAS</td>
    	  <td width="74" style="font-weight:bold; border:#000 solid 1px"">60- DIAS</td>
    	  <td width="97" style="font-weight:bold; border:#000 solid 1px"">SALDO</td>
    	  <td width="114" style="font-weight:bold; border:#000 solid 1px"">FACTURA</td>
    	  <td width="123" style="font-weight:bold; border:#000 solid 1px">CONTRARECIBO</td>
      </tr>
      	<?
		$arre = array();
		$arr = 0;
		...
		while($f = mysql_fetch_array($r)){
			...
			if($cliente!=cambio_texto($f[cliente])){
				...
				<tr>
				  ...
				  <td style="border-bottom: 1px #000 solid; ">&nbsp; </td>
				  <td colspan="2" style="border-bottom: 1px #000 solid; border-right:1px #000 solid">&nbsp;</td>
			  </tr>
              <tr>
              ...
              <tr>
                  ...
                  <td style="border-top:#000 1px solid; font-weight:bold">No. <?=$f[idcliente]?></td>
                  ...
                  <td style="border-top:#000 1px solid">&nbsp;</td>
                  <td style="border-top:#000 1px solid">&nbsp;</td>
                  <td colspan="2" style="border-top:#000 1px solid; border-right:#000 1px solid">&nbsp;</td>
              </tr>
				<?
			}
			if($cliente == cambio_texto($f[cliente])){
