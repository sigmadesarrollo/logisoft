...
<script>
	...
	tabla2.setAttributes({
		...
		campos:[
			...
			{nombre:"SALDO", medida:150, tipo:"moneda" ,onDblClick:"imprimirDetallado",alineacion:"right",  datos:"saldo"}
		],
		filasInicial:30,
		alto:250,
		seleccion:true,
	...
	function ObtenerDetalle(){
		...
		if(u.pag1_fecha.value=="" || u.pag1_fecha2.value==""){
			...
			if (fec2 < fec1){
				...
				consultaTexto("resTabla1","principal_con.php?accion=1&fecha="+u.pag1_fecha.value+"&sucursal="+<?=$_SESSION[IDSUCURSAL]?>
	...
	function paginacion1(movimiento){
		...
		+"&fecha2="+u.pag1_fecha2.value+"&sucursal="+<?=$_SESSION[IDSUCURSAL]?>+"&contador=0&s="+Math.random());
				break;
			case 'adelante':
				if(u.pag1_adelante.value==1){
					consultaTexto("resTabla1","principal_con.php?accion=1&fecha="+u.pag1_fecha.value
		+"&fecha2="+u.pag1_fecha2.value+"&sucursal="+<?=$_SESSION[IDSUCURSAL]?>+"&contador="+(parseFloat(u.pag1_contador.value)+1)+"&s="+Math.random());
				}
				break;
			case 'atras':
		...
		+"&fecha2="+u.pag1_fecha2.value+"&sucursal="+<?=$_SESSION[IDSUCURSAL]?>+"&contador="+(parseFloat(u.pag1_contador.value)-1)+"&s="+Math.random());
			...
			case 'ultimo':
				...
				consultaTexto("resTabla1","principal_con.php?accion=1&fecha="+u.pag1_fecha.value+"&fecha2="+u.pag1_fecha2.value
				+"&sucursal="+<?=$_SESSION[IDSUCURSAL]?>+"&contador="+contador+"&s="+Math.random());
				break;
		}
	}
	...
	function agregatotal(){
			...
			+"&sucursal="+<?=$_SESSION[IDSUCURSAL]?>+"&contador="+u.pag2_contador.value+"&s="+Math.random());
	}
	...
	function paginacion2(movimiento){
		switch(movimiento){
			case 'primero':
				...
				+"&sucursal="+<?=$_SESSION[IDSUCURSAL]?>+"&contador=0&s="+Math.random());
				break;
			case 'adelante':
				if(u.pag2_adelante.value==1){
					consultaTexto("resTabla2","total_con.php?accion=1&fecha="+u.pag2_fecha.value+"&fecha2="+u.pag2_fecha2.value
					+"&sucursal="+<?=$_SESSION[IDSUCURSAL]?>+"&contador="+(parseFloat(u.pag2_contador.value)+1)+"&s="+Math.random());
					break;
				}
				break;
			case 'atras':
	...
	function imprimirReporte(tipo){
		...
		switch (tipo){
			case 1:
				...
				+"&sucursal="+<?=$_SESSION[IDSUCURSAL]?>+"&fecha2="+u.pag1_fecha2.value+"&val="+Math.random());
			break;
			case 2:
				window.open(v_dir+"generarExcelIngresos.php?accion=2&titulo=CONCILIACION DE INGRESOS&fecha="+u.pag2_fecha.value
				+"&sucursal="+<?=$_SESSION[IDSUCURSAL]?>+"&fecha2="+u.pag2_fecha2.value+"&val="+Math.random());
			break;
			case 3:
	...
	function imprimirDetallado(){
		...
		window.open(v_dir+"generarExcelIngresos.php?accion=10&titulo=CONCILIACION DE INGRESOS DETALLADO&fecha="+u.pag2_fecha.value
				+"&fecha2="+u.pag2_fecha2.value+"&sucursal="+b_sucursal+"&val="+Math.random());
	}
</script>
  ...
  <tr>
  	<td colspan="8" align="right">
    	<table align="right">
			...
			<tr>
  				<td align="center" colspan="9" align="right">
				<div class="ebtn_imprimir" onclick="imprimirReporte(2)"></div>
				</td>
		  </tr>
		  <tr><td>&nbsp;</td></tr>
        </table>
