...
<form id="form1" name="form1" method="post" action="">
  <table width="716" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td><table width="592" height="15" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="3">&nbsp;</td>
            <td width="481"><div align="right">Total</div></td>
            <td width="108" align="center"><span class="style31">
              <input name="tsaldo" type="text" class="style2" id="tsaldo" style="width:100px;background-color:#FFFF99;" readonly="" />
            </span></td>
          </tr>
      </table></td>
    </tr>
