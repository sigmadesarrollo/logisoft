...
<style>
	...
	<table border="0" cellpadding="1" cellspacing="0">
    	<tr>
        	<td colspan="15" align="center" class="titulo">PAQUETERIA Y MENSAJERIA</td>
        </tr>
    	<tr>
    	  <td width="126">REPORTE:</td>
    	  <td colspan="14">RELACION DE ENVIADO</td>
   	  </tr>
    	<tr>
    	  <td>SUCURSAL:</td>
    	  <td colspan="14" align="left"><?=$nsucursal?></td>
   	  </tr>
    	<tr>
    	  <td>FECHAS</td>
    	  <td colspan="14" align="left"><?=$fechas?></td>
   	  </tr>
    	<tr>
    	  <td height="9px"></td>
    	  <td width="73">&nbsp;</td>
    	...
    	<tr>
          ...
          <td width="95" class="cabecera" align="center" >TIPO PAGO</td>
    	    ...
    	    <?
					...
					(SELECT gv.id, DATE_FORMAT(gv.fecha,'%d/%m/%Y') fecha, gv.tflete,
					gv.tdescuento, gv.trecoleccion, gv.tcostoead, gv.tseguro, gv.totros, gv.tcombustible, gv.tiva, gv.ivaretenido, gv.total, gv.estado,
					...
					$andfec1)
					UNION
					(SELECT ge.id, DATE_FORMAT(ge.fecha,'%d/%m/%Y') fecha, ge.tflete,
					ge.tdescuento, ge.trecoleccion, ge.tcostoead, ge.tseguro, ge.totros, ge.tcombustible, ge.tiva, ge.ivaretenido, ge.total, ge.estado,
					...
					?>
                            ...
                            ?>
                              ...
                              <? $cont++;?>     
			<tr>
    	      <td colspan="15" class="cabecera" align="left">&nbsp;DESTINO: <?=$f->sucursal?></td>
          </tr>
					<?
								$final = true;
							}
    	    ...
    	    <tr>
    	      ...
    	      <td align="center"><?='$ '.number_format($f->estado,2)?></td>
          </tr>
					<?
    ...
    <table border="0" cellpadding="1" cellspacing="0">
    	...
    	<tr>
    	  <td width="126">REPORTE:</td>
    	  <td colspan="14">RELACION DE RECIBIDO</td>
   	  </tr>
    	<tr>
    	  <td>SUCURSAL:</td>
    	  <td colspan="14" align="left"><?=$nsucursal?></td>
    	    ...
    	    <?					
					...
					?>
                            ...
                            ?>
                              ...
                              <? $cont++;?>     
			<tr>
    	      <td colspan="15" class="cabecera" align="left">ORIGEN: <?=$f->sucursal?></td>
          </tr>
					<?
								$final = true;
							}
