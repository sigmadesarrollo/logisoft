          ...
          <td colspan="4"><table width="549" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              ...
              <td colspan="3"><label>
                ...
                <img src="../img/Buscar_24.gif" width="24" height="23" align="absbottom" style="cursor:pointer" onclick="mostrarBuscador();" /></label>                <input name="nombre" type="text" class="Tablas" id="nombre" readonly="" style="width:300px; background-color:#FFFF99" /></td>
              </tr>
