<? session_start();
	...
	$get = @mysql_query("SELECT COUNT(*) FROM catalogounidad AS CU 
			...
			AND bitacorasalida.cancelada = 0");
...
<table width="500"  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
  ...
  <tr> 
	...
	$sql = @mysql_query("SELECT CU.id, CU.numeroeconomico, bitacorasalida.folio,
			...
			AND bitacorasalida.cancelada = 0 limit $st,$pp",$link);
...
//echo "<br>($ff->sucursal == $_SESSION[IDSUCURSAL] && $ff->hrllegada!='00:00:00') || 
//			($ff->hrsalida=='' && $ffx->sucursal==$_SESSION[IDSUCURSAL])<br>";
				
				echo "<br>if(($ff->sucursal == $_SESSION[IDSUCURSAL] && $ff->hrllegada!='00:00:00') || (($ff->hrsalida=='' || $ff->hrsalida=='00:00:00') && $ffx->sucursal==$_SESSION[IDSUCURSAL] ))$row[numeroeconomico]<br>";
