...
<table width="619" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
  <tr>
    <td width="615" class="FondoTabla Estilo4">ENTREGAS OCURRE VENTANILLA  </td>
  </tr>
  <tr>
    <td><table width="615" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td colspan="2"><table width="615" border="0" cellpadding="0" cellspacing="0">
            <tr>
              <td width="59">Gu&iacute;a:</td>
              <td width="127"><input name="nguia" class="Tablas" type="text" id="nguia" value="<?=$nguia ?>" onkeypress="if(event.keyCode==13){pedirGuiasPGuia(this.value)}" /></td>
              <td width="428"><div class="ebtn_buscar" onclick="abrirVentanaFija('../buscadores_generales/buscarGuiasEmpresariales_VentanillaGen.php?funcion=pedirGuiasPGuia&tipo=1', 600, 550, 'ventana', 'Buscar')"></div></td>
            </tr>
        </table></td>
      </tr>
      <tr>
        <td colspan="2"><table width="100%" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="60" class="Tablas"><input name="cliente" type="text" class="Tablas" id="cliente" style="width:50px;" value="<?=$cliente ?>" onkeypress="if(event.keyCode==13){pedirGuiasPCliente(this.value)}"/></td>
              <td width="40" class="Tablas"><div class="ebtn_buscar" onclick="abrirVentanaFija('../buscadores_generales/buscarClienteGen.php?funcion=pedirGuiasPCliente', 600, 450, 'ventana', 'Buscar')"></div></td>
              ...
              <td width="97"><img src="../img/Boton_Firma.gif" width="105" height="20" align="absbottom" style="cursor:pointer" onclick="agregarFirma()" /></td>
            </tr>
        </table></td>
      </tr>
      <tr>
