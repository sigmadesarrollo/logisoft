...
<script>
	...
	//	window.open("solicitudContratoAperturaCredito_con.php?accion=1&credito="+id+"&s="+Math.random());
	...
	function mostrarDatos(datos){ 
		if(datos.indexOf("no encontro")<0){
			...
			u.fecha.innerHTML		= obj.principal.fechasolicitud;
		...
		<div class="content">
			<div class="det-guia">
			 ...
			 <div class="datos-cliente" style="font-size:11px;">
              ...
              abrirVentanaFija('../buscadores_generales/buscarClienteGen.php?funcion=obtenerClienteBusqueda&amp;tipo=moral', 835, 418, 'ventana', 'Busqueda')
