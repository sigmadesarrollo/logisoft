<?	session_start();
	...
	$sql="SELECT ge.id AS guia,cc.id AS cliente,
...
<script>
	...
	function obtenerTotal(){
		...
		parent.document.all.iframe_id8.src="../ventasconsignacion/total.php?cliente="+arr.cliente+" &fechaini=<?=$_GET[fechaini] ?>&fechafin=<?=$_GET[fechafin] ?>&guia="+arr.guia;
