...
<table width="600" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
  <tr>
    <td width="596" class="FondoTabla Estilo4">REPORTE CONSOLIDADO DE GASTOS CAJA CHICA</td>
  </tr>
  <tr>
            ...
            <tr>
              ...
              <td width="143"><table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="105">
              	<span class="Tablas">
                  <input name="fecha_inicio" type="text" class="Tablas" id="fecha_inicio" style="width:100px;"  value="<?=$_POST['fecha_inicio'] == "" ? "" : $_POST['fecha_inicio'] ?>" />
                  </span>
                  </td>
                 <td>
            ...
            <tr>
              ...
              <td width="143"><table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="105">
              	<span class="Tablas">
                  <input name="fecha_fin" type="text" class="Tablas" id="fecha_fin" style="width:100px;"  value="<?=$_POST['fecha_fin'] == "" ? "" : $_POST['fecha_fin'] ?>" />
                  </span>
                  </td>
                 <td>
          ...
          <td><table width="532" border="0" align="left" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td width="9" class="formato_columnas_der"></td>
					...
					{
						$sWhere .= " AND DATE(fechagenerada) BETWEEN '".cambiaf_a_mysql($_POST['fecha_inicio'])."' AND '".cambiaf_a_mysql($_POST['fecha_fin'])."'";
					}
                    $s .= $sWhere;				
					$sq = mysql_query($s) or die($s);
        ...
        <tr>
          <td><table width="600" border="0" cellpadding="0" cellspacing="0">
            <tr><!--kryzzo home-->
              ...
              <td align="right"></td>
              <td width="72" align="right"><div class="ebtn_imprimir" onClick="imprimir()"></div></td>
            </tr>
          </table></td>
        </tr>
        <tr>
...
function imprimir(){
	var u = document.all;
	if((u.fecha_inicio.value != '' && u.fecha_fin.value == '') || (u.fecha_fin.value != '' && u.fecha_inicio.value == '')){
		alerta('Debe seleccionar Fecha Inicio y Fecha Fin para continuar','¡Atención!','fecha_inicio');
		return;
	}	
	
		if(document.URL.indexOf("web/")>-1){		
			window.open("http://www.pmmintranet.net/web/cajachica/excel_reporteconsolidado.php?sucursal="+u.idsucursal.value
	+"&fechainicio="+u.fecha_inicio.value+"&fechafin="+u.fecha_fin.value+"&estado="+u.select_estado.value);
		
		}else if(document.URL.indexOf("web_capacitacion/")>-1){
		window.open("http://www.pmmintranet.net/web_capacitacion/cajachica/excel_reporteconsolidado.php?sucursal="+u.idsucursal.value
	+"&fechainicio="+u.fecha_inicio.value+"&fechafin="+u.fecha_fin.value+"&estado="+u.select_estado.value);
		
		}else if(document.URL.indexOf("web_pruebas/")>-1){
		window.open("http://www.pmmintranet.net/web_pruebas/cajachica/excel_reporteconsolidado.php?sucursal="+u.idsucursal.value
	+"&fechainicio="+u.fecha_inicio.value+"&fechafin="+u.fecha_fin.value+"&estado="+u.select_estado.value);
		}
