...
function consultaPoblacion(e,obj){
	...
	if(tecla==13 && obj!=""){
		if(obj.length >= 4){
			PoblacionConsulta('municipio',obj);
		}else{
  ...
  <table width="500"  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
	...
	?> 
       ...
       <td width="10%" class="Tablas" >
         <a href="../../menu/webministator.php"><span onclick="window.parent.obtenerMunicipiox('<?=$row['id'];?>');parent.VentanaModal.cerrar();" style="cursor: pointer; color:#0000FF">
         <?=$row['id'];?>
         </span></a></td>
            <td width="79%" class="Tablas"><a href="../../menu/webministator.php">
              <input name="descripcion" type="text" class="Tablas" value="<?=$row['descripcion']; ?>" size="50" readonly="true" style="border:none; cursor:pointer" />
            </a></td>
            <td width="19px"></td>
          </tr>
          <? } ?>
    ...
    <tr>
      <td colspan="2" align="center"><font color="#FF0000" size="-1"><? echo paginacion($total, $pp, $st, 'buscarMunicipioPoblacion.php?st='); ?></font></td>
    </tr>
  </table> 
</form>
<script>foco();</script>
