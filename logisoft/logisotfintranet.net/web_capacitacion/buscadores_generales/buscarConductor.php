  ...
  <tr>
    <td colspan="3" class="Tablas" height="300px" valign="top">
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="Tablas">
        <?		
			$get = mysql_query("SELECT id, CONCAT(nombre,' ',apellidopaterno,' ',apellidomaterno) as enombre FROM catalogoempleado
			WHERE $puesto 
        ...
        <tr>
          ...
          <td width="405" class="Tablas"><input class="Tablas" name="descripcion" type="text" value="<?=$row['enombre']; ?>" readonly="true" style="width:320px; border:none; cursor:default"></td>         
          <td width="42"></td>
        </tr>
        <? } ?>
      </table>
