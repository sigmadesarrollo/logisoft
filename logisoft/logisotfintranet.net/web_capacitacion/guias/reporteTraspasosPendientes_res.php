...
<script>
	...
	tabla1.setAttributes({
		...
		campos:[
			...
			{nombre:"FOLIO SOLICITUD", medida:90, alineacion:"left", datos:"foliotraspaso"},
	...
	function aceptarTraspaso(){
		...
		for(var i=0;i<tabla1.getRecordCount();i++){
			if(u["detalle_ACEPTAR"][i].checked == true){
				folios += u["detalle_ACEPTAR"][i].value + ",";
  ...
  <table width="610" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
    ...
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td align="right"><div class="ebtn_aceptar" onclick="mens.show('C',' &iquest; Esta seguro de Aceptar la(s) solicitud de Traspaso de cargo?', '', '', 'aceptarTraspaso()')"></div></td>
        </tr>
      </table></td>
    </tr>
  </table>
