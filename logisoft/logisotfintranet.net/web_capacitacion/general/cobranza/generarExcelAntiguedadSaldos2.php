...
?>
	<table width="1211">
    	...
    	<tr>
		  ...
		  <td width="230" style="font-weight:bold; border:#000 solid 1px">CLIENTE</td>
    	  <td width="100" style="font-weight:bold; border:#000 solid 1px">FOLIO</td>
    	  <td width="76" style="font-weight:bold; border:#000 solid 1px">FECHA</td>
		  <td width="76" style="font-weight:bold; border:#000 solid 1px">FECHA VENC.</td>
    	  <td width="40" style="font-weight:bold; border:#000 solid 1px">DIAS VENCIDOS</td>
    	  <td width="90" style="font-weight:bold; border:#000 solid 1px">AL CORRIENTE</td>
    	  <td width="70" style="font-weight:bold; border:#000 solid 1px">1-15 DIAS</td>
    	  <td width="70" style="font-weight:bold; border:#000 solid 1px">16-30 DIAS</td>
    	  <td width="70" style="font-weight:bold; border:#000 solid 1px">31-60 DIAS</td>
    	  <td width="70" style="font-weight:bold; border:#000 solid 1px">60- DIAS</td>
    	  <td width="100" style="font-weight:bold; border:#000 solid 1px">SALDO</td>
		...
		while($f = mysql_fetch_array($r)){
			...
			?>
              ...
              <tr>
				  ...
				  <td style="border-bottom: 1px #000 solid; ">&nbsp;</td>
				  <td style="border-bottom: 1px #000 solid; ">&nbsp;</td>
				  <td style="border-bottom: 1px #000 solid; ">TOTAL</td>
				  <td style="border-bottom: 1px #000 solid; ">&nbsp;</td>
				  <td style="border-bottom: 1px #000 solid; ">&nbsp;</td>
