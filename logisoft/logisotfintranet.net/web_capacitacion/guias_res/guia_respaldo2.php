...
<script>
	...
	var botonesnuevo = '<img src="../img/Boton_Guardar.gif" style="cursor:hand" onClick="if(validarDatos()){ if(document.all.lstflete.value==0 && document.all.lstpago.value==0){ abrirVentanaFija(\'formapago.php?total=\' + document.all.t_txttotal.value, 600, 400, \'ventana\', \'Forma de Pago\'); }else{ ejecutarSubmit(); } };">&nbsp;&nbsp;<img src="../img/Boton_Nuevo.gif" style="cursor:hand" onClick="limpiar_evaluacion();limpiar_destinatario();limpiar_remitente();parent.frames[4].document.all.foliobusqueda.value = \'\';">';
	...
	function obtenerMecanciaConvenio(datos){
		...
		if(u.lstflete.value==1){
			...
			if(valCon.validarDestRestEADF(u.lstflete.value)){

				msg += "El destino seleccionado tiene restringida la entrega a domicilio a<br>";

				u.chocurre.checked = 1;

			}

			if(valCon.restringEADDestinatario()){
			...
			if(valCon.restringVDDestinatario()){
			...
			if(valCon.restringRXCDestinatario()){
		...
		if(valCon.validaEADsucursal(valCon.validarConvenioAUsar(u.lstflete.value),u.sucdestino_hidden.value)){

			u.t_txteadh2.value = "1";

		}

		if(valCon.validaRecsucursal(valCon.validarConvenioAUsar(u.lstflete.value),u.sucdestino_hidden.value))
	...
	function pedirDatosEvaluacion(idevaluacion){
		...
		if('<?=$_SESSION[IDSUCURSAL]?>'!=""){
			...
			//document.all.recibio.value = "guia_consulta.php?accion=1&folio="+idevaluacion+"&idsucorigen="+sucursalorigen+"&valrandom="+Math.random();
	...
	function guiaGuardada(datos){
		...
		if(guardado==1){
			...
			parent.frames[4].document.all.folioSeleccionado.innerHTML = folio;
  ...
  <tr>
    ...
    <td colspan="2">
      ...
      <tr>
        ...
        <td width="47%" id="estado" style="font:tahoma; font-size:15px; font-weight:bold">&nbsp;</td>

        <td width="25%" align="right"><a onClick="limpiar_cajas()" href="../menu/webministator.php" >
          ...
          <img src="../img/inicio_30.gif" name="IMG0"  border="0"  id="IMG0" /></a></td>
  ...
  <tr>
    ...
    <td colspan="2" ><table width="618" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="3%"><input name="chocurre" onClick="solicitarDatosConv(); if(document.all.restringiread.value==1){alerta('El destino tiene restringida la Entrega a Domicilio','¡Atencion!','chocurre'); this.checked=true;}else{if(this.checked==false){document.all.t_txtead.value = document.all.t_txteadh.value}else{document.all.t_txtead.value = '$ 0.00';}} calculartotales();" type="checkbox" id="chocurre" style="width:8px; height:8px" value="SI" /></td>
        ...
        onkeyup="if(!this.redOnly){ajax_showOptions(this,'getCountriesByLetters',event,'buscarSucursales.php')}" 

        onChange="if(!this.redOnly){devolverDestino()}" onKeyPress="if(event.keyCode==13 && !this.redOnly){devolverDestino(); document.all.idremitente.focus();}"

        onBlur="if(!this.redOnly){devolverDestino()}"> 
            ...
            <tr>
              ...
              <td><table width="100%" border="0" cellpadding="0" cellspacing="1">
                  ...
                  <tr>
                    ...
                    <td><input name="idremitente" type="text" onKeyPress="if(event.keyCode==13 && this.readOnly==false){ devolverRemitente(this.value)}" style="font:tahoma; font-size:9px" value="<?=$remitente ?>" size="4" />
              ...
              <td><table width="100%" border="0" cellpadding="0" cellspacing="1">
                ...
                <tr>
                  ...
                  <td><input name="iddestinatario" onKeyPress="if(event.keyCode==13 && this.readOnly==false){devolverDestinatario(this.value)}" type="text" style="font:tahoma; font-size:9px" value="<?=$remitente ?>" size="4" />
  ...
  <tr>
    ...
    <td colspan="2"><table width="623" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="381"><table width="377" border="0" cellpadding="0" cellspacing="0" bordercolor="#016193">
        ...
        <td width="242"><table width="243" border="0" align="left" cellpadding="0" cellspacing="0">

            <tr>

              <td valign="middle" id="idsguardar" align="center"><img src="../img/Boton_Guardar.gif" style="cursor:hand" onClick="if(validarDatos()){ if(document.all.lstflete.value==0 && document.all.lstpago.value==0){ abrirVentanaFija('formapago.php?total=' + document.all.t_txttotal.value, 600, 400, 'ventana', 'Forma de Pago'); }else{ ejecutarSubmit(); } };">&nbsp;&nbsp;

              <img src="../img/Boton_Nuevo.gif" style="cursor:hand" onClick="limpiar_evaluacion();limpiar_destinatario();limpiar_remitente();parent.frames[4].document.all.foliobusqueda.value = '';">
