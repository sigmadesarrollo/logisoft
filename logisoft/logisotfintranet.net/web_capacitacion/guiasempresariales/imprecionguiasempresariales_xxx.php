...
<script>
	...
	function imprimirEtiquetas(){
		...
		if(document.all.ncliente.value == ""){
			mens.show("A","Seleccione el remitente","¡ATENCIÓN!");
			return false;
		}
		
		if(document.all.ncliente2.value == ""){
			mens.show("A","Seleccione el destinatario","¡ATENCIÓN!");
			return false;
		}
		
		if(document.all.h_origen.value == undefined){
			mens.show("A","Seleccione origen","¡ATENCIÓN!");
			return false;
		}
		
		if(document.all.h_destino.value == undefined){
			mens.show("A","Seleccione el destino","¡ATENCIÓN!");
			return false;
		}
		
		window.open('imprimiretiquetaguiaemp_serie.php?folioinicio='+document.all.finicial.value+
					'&foliofinal='+document.all.fondo2.value+
					'&idremitente='+((document.all.impremitente.checked)?document.all.ncliente.value:"")+
					'&iddestinatario='+((document.all.impdestinatario.checked)?document.all.ncliente2.value:"")+
					'&sorigen='+document.all.h_origen.value+
					'&sdestino='+document.all.h_destino.value);
	}
...
Consignación</td>
      ...
      <tr>
        <td height="21" colspan="5"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="22%"><input class="Tablas"  type="checkbox" name="impremitente" value="" />
Imprimir Remitente</td>
      ...
      <tr>
        <td height="21" colspan="5"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="22%"><input class="Tablas"  type="checkbox" name="impdestinatario" value="" />
Imprimir Destinatario</td>
      ...
      <tr>
        <td colspan="5"><label>
        <input class="Tablas"  name="observaciones" type="text" id="observaciones" style="width:605px;font:tahoma; font-size:9px"/>
        </label></td>
      </tr>
      <tr>
      ...
      <tr>
        <td colspan="5" align="center"><div class="ebtn_imprimir" onclick="imprimirEtiquetas();"></div></td>
      </tr>
    </table>
