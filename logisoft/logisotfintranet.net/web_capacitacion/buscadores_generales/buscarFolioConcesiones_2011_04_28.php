  ...
  <table width="500"  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
    ...
    <tr>
      ...
      <td colspan="3" class="Tablas" height="300px" valign="top"><table width="100%" border="0" align="center" class="Tablas">
		...
		$get = mysql_query('select m.folio, c.descripcion as sucursal, date_format(m.fechaconcesion,"%d/%m/%Y") as fecha from moduloconcesiones m
...
<span onclick="parent.obtenerFolio('<?= $row[0];?>');parent.VentanaModal.cerrar();" style="cursor: pointer; color:#0000FF"><?= $row[0];?></span></td>
