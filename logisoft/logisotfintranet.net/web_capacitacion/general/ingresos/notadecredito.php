...
<script>
	...
	tabla1.setAttributes({
		...
		campos:[
			...
			{nombre:"SUCURSAL", medida:80, alineacion:"left", datos:"sucursal"},


			{nombre:"NUMERO DE NOTAS DE CREDITO", medida:150, alineacion:"center",  datos:"nc"},			
...
<table width="426" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td><table width="422" height="16" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="89" align="center"><div align="right">Total Gral: </div></td>


        <td width="95" align="center"><input name="total" type="text" class="Tablas" id="total" style="text-align:right;width:100px;background:#FFFF99" value="<?=$total ?>
