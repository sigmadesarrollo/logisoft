...
<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">  
  <tr>
    <td height=602 valign=top><table width="150" border="0" align="center" cellpadding="0" cellspacing="0">    
      <tr>
        <td class="tituloVerde">
         No. Guia</td>
      </tr>
      <tr>
      	<td>
        	<table width="152" border="0" cellpadding="0" cellspacing="0" class="fondoVerdePalo">
	            <tr>
                	<td width="5px"></td>
                  <td height="5px" ></td>
                    <td width="5px"></td>
...
<tr>
      ...
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" class="fondoVerdePalo">
          ...
          <tr>
            ...
            <td colspan="2" class="Tablas">No. Guia</td>
          </tr>
          <tr>
            <td><input name="radiobutton" type="radio" value="radiobutton" style="width:12px" ></td>
            <td width="121" class="Tablas">No. Rastreo </td>
          </tr>
          <tr>
            <td><input name="radiobutton" type="radio" value="radiobutton" style="width:12px" ></td>
            <td colspan="2" class="Tablas">No. Recolección </td>
          </tr>
          <tr>
      ...
      <tr>
        <td><table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
          ...
          <tr class="filaR">
            <td align="left" onClick="parent.frames[2].mostrarEvaluaciones(2)">Evaluaciones Pen. Generar Guias</td>
            <td align="right" class="total">0</td>
          </tr>
          <tr class="filaR2">
