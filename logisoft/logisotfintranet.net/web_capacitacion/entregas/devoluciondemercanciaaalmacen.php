...
<script>
	...
	function resGuardar(datos){
		if(datos.indexOf("guardado")>-1){
			...
			if(datos.indexOf("Esta devolucion")>-1){
				alerta3("Esta devolucion ya fue cerrada","¡Atencion!");
			}else{
      ...
      <tr>
        ...
        <table width="276">
        	<tr>
            	...
            	<td><div id="cerrar" class="ebtn_cerradevolucion" onclick="confirmar('UNA VEZ CERRADA LA DEVOLUCION NO SE PODRAN HACER NINGUN CAMBIO,¿ESTA SEGURO DE CERRAR LA DEVOLUCION?','','cerrardevolucion()','')"></div></td>
            	<td>
