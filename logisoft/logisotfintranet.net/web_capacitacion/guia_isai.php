...
<script>
	...
	tabla1.setAttributes({
		...
		campos:[
			...
			{nombre:"Descripcion", medida:118, alineacion:"left", datos:"descripcion"},
			{nombre:"Contenido", medida:118, alineacion:"left", datos:"contenido"},
	...
	function mostrarGuiasPCS(){
		abrirVentanaFija('../buscadores_generales/buscarGuiasDCS.php?funcion=cambiarPaginaGYS&estado=SUSTITUCION', 650, 450, 'ventana', 'Guias pendientes para cancelacion')
	}
	
	function mostrarGuiasAPS(){
		abrirVentanaFija('../buscadores_generales/buscarGuiasDCS.php?funcion=cambiarPaginaGYS2&estado=AUTORIZADA PARA SUSTITUIR', 650, 450, 'ventana', 'Guias pendientes para cancelacion')
	}
	...
	function cancelarGuia(){
		u = document.all;
		if(u.estado.innerHTML=='ALMACEN DESTINO' && u.lstflete.value == 1){
	...
	function limpiar_remitente(){
		...
		u.rem_cliente.value 	= "";
		u.rem_numero.value		= "";
		u.celda_rem_calle.innerHTML = '<input name="rem_calle" readonly="true" type="text" style="font:tahoma; font-size:9px" value="" /><input type="hidden" name="rem_direcciones">';
		u.rem_cp.value			= "";
		u.rem_colonia.value		= "";
	...
	function limpiar_destinatario(){
		...
		u.des_numero.value		= "";
		u.des_cp.value			= "";
		u.celda_des_calle.innerHTML = '<input name="des_calle" readonly="true" type="text" style="font:tahoma; font-size:9px" value="" /><input type="hidden" name="des_direcciones">'
	...
	function limpiar_evaluacion(){
			...
			document.all.danosfaltantes.innerHTML = "";
			tabla1.clear();
	...
	function mostrarRemitente(datos){
		...
		if(encon>0){
			...
			if(endir==1){
				...
				+'style="font:tahoma; font-size:9px" value="" /><input type="hidden" name="rem_direcciones">';
	...
	function mostrarDestinatario(datos){
		...
		if(encon>0){
			...
			if(endir==1){
				...
				+'style="font:tahoma; font-size:9px" value="" /><input type="hidden" name="des_direcciones">';
  ...
  <table width="731" border="0" cellpadding="0" cellspacing="0">
    <tr>
    	<td width="731">
        	<table width="732" border="0" cellpadding="0" cellspacing="0">
            	<tr>
                	<td width="253" id="folioSeleccionado" class="fuenteCabecera">&nbsp;</td>
                    <td width="229"><input name="DetalleGrip" type="hidden" id="DetalleGrip" value="<?=$DetalleGrip ?>" /></td>
                    <td width="257"id="estado" class="fuenteCabecera"></td>
                </tr>
        	</table>
        </td>
    </tr>
    <tr>
    	<td>
			...
			?>
               	  <input name="fecha" readonly="true" type="text" id="fecha" value="<?=$f->fecha ?>" align="top" /></td>
                    <td width="229"><a onclick="limpiar_cajas()" href="../menu/webministator.php" >
                    ...
                    <td width="257" id="unidadSubida" class="fuenteCabecera">&nbsp;</td>
                </tr>
        	</table>
        </td>
    </tr>
...
<table width="233" border="0" cellpadding="0" cellspacing="0">
                        	<tr>
                            	<td class="azul_ezqizq_up"></td>
                              <td width="211" class="azul_ezqcen_up" valign="middle" align="center">CONTROL</td>
                              <td class="azul_ezqder_up"></td>
                   		  </tr>
                        	<tr>
                            	<td height="183" colspan="3" align="center" class="gris_cen">
                    	<table width="219" border="0" cellpadding="0" cellspacing="0">
   	  <tr>
                   	<td width="88" class="fuentePloma" align="left">Tipo Flete</td>
                            <td width="131" align="left">
                            <select name="lstflete" style=" font-size:9px; width:100px" onchange="solicitarDatosConv(); calculartotales()">
                              <option value="0">Pagado</option>
                              <option value="1">Por Cobrar</option>
                            </select></td>
                        </tr>
                    	<tr>
                    	  <td class="fuentePloma" align="left">Entrega</td>
                    	  <td align="left"><select name="chocurre" id="chocurre" onchange="solicitarDatosConv(); if(document.all.restringiread.value==1){alerta('El destino tiene restringida la Entrega a Domicilio','¡Atencion!','chocurre'); this.value=1;}else{if(this.value==0){document.all.t_txtead.value = document.all.t_txteadh.value}else{document.all.t_txtead.value = '$ 0.00';}} calculartotales();" style="width:77px; font-size:9px; width:100px;">
                    	    <option value="0">EAD</option>
                    	    <option value="1">Ocurre</option>
                  	    </select></td>
                  	  </tr>
                    	<tr>
                    	  <td class="fuentePloma" align="left">Destino
                    	    <input type="hidden" name="destino_hidden" />
                          <input type="hidden" name="npobdes" /></td>
                    	  <td align="left"><input type="text" name="destino" readonly="true" id="destino" class="estiloCajas" ></td>
                  	  </tr>
                    	<tr>
                    	  <td class="fuentePloma" align="left">Sucursal Destino</td>
                    	  <td align="left"><input name="sucdestino" type="text" id="sucdestino" class="estiloCajas" readonly="readonly" value="<?=$destino?>" poblacion="" />
                          <input type="hidden" name="sucdestino_hidden" /></td>
                  	  </tr>
                    	<tr>
                    	  <td class="fuentePloma" align="left">Condicion Pago</td>
                    	  <td align="left"><select name="lstpago" id="lstpago" style="font-size:9px; width:100px">
                    	    <option value="0">Contado</option>
                    	    <option value="1">Credito</option>
                  	    </select></td>
                  	  </tr>
                    	<tr>
                    	  <td class="fuentePloma" align="left">Tiempo/Ocurre</td>
                    	  <td align="left"><input name="txtocu" readonly="true" type="text" class="estiloCajas" value="<?=$drfc ?>"/></td>
                  	  </tr>
                    	<tr>
                    	  <td class="fuentePloma" align="left">Tiempo/EAD
                   	      <input name="txteadh" type="hidden" /></td>
                    	  <td align="left"><input name="txtead" readonly="true" type="text" class="estiloCajas" value="<?=$drfc ?>" /></td>
                  	  </tr>
                    	<tr>
                    	  <td class="fuentePloma" align="left">Restrincciones<input name="txtrestrinccionh" type="hidden" /></td>
                    	  <td align="left"><textarea name="txtrestrinccion" readonly="readonly" style=" font-size:9px; text-transform:uppercase; width:94px"></textarea></td>
                  	  </tr>
                    </table>                   			  </td>
                   		  </tr>
                        	<tr>
                            	<td class="gris_ezqizq_dw"></td>
                                <td class="gris_cen"></td>
                                <td class="gris_ezqder_dw"></td>
                    		</tr>
                   	  </table></td>
                    <td width="244">
...
<tr>
                            	<td class="azul_ezqizq_up"></td>
                              <td width="200" class="azul_ezqcen_up" valign="middle" align="center">REMITENTE</td>
                              <td class="azul_ezqder_up"></td>
               		  </tr>
                        	<tr>
                            	<td colspan="3" class="gris_cen" align="center">
                    	...
                    	<tr>
                    	  ...
                    	  <td align="left"><input name="rem_rfc" readonly="true" type="text" class="estiloCajas" value="<?=$rrfc ?>" /></td>
                  	  </tr>
                    	<tr>
                    	  <td class="fuentePloma" align="left">Nombre</td>
                    ...
                    value="<?=$rcliente ?>" /></td>
                    	...
                    	<tr>
                    	  <td class="fuentePloma" align="left">Calle</td>
                    	  <td id="celda_rem_calle" align="left">
                          <table border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            <td width="100"><input class="estiloCajas" name="rem_calle" readonly="true" type="text" value="" /></td>
                          	<td width="20"><input type="hidden" name="rem_direcciones"></td>
                          </tr>
                          </table>
                          </td>
                  	  </tr>
                    	<tr>
                    	  <td class="fuentePloma" align="left">Número</td>
                    	  <td align="left"><input class="estiloCajas" name="rem_numero" type="text" readonly="true" value="<?=$rnumero ?>" /></td>
                  	  </tr>
                    	<tr>
                    	  <td class="fuentePloma" align="left">C.P.</td>
                    	  <td align="left"><input class="estiloCajas" name="rem_cp" readonly="true" type="text" value="<?=$rcp ?>" /></td>
                  	  </tr>
                    	<tr>
                    	  <td class="fuentePloma" align="left">Colonía</td>
                    	  <td align="left"><input class="estiloCajas" name="rem_colonia" type="text" readonly="true" value="<?=$rcolonia ?>" /></td>
                  	  </tr>
                    	<tr>
                    	  <td class="fuentePloma" align="left">Población</td>
                    	  <td align="left"><input class="estiloCajas" name="rem_poblacion" readonly="true" type="text" value="<?=$rpoblacion ?>" /></td>
                  	  </tr>
                    	<tr>
                    	  <td class="fuentePloma" align="left">Teléfono</td>
                    	  <td align="left"><input class="estiloCajas" name="rem_telefono" type="text" readonly="true" value="<?=$rtelefono ?>" /></td>
                  	  </tr>
                    </table>                   			  </td>
                    		</tr>
                        	<tr>
...
<tr>
                            	<td class="azul_ezqizq_up"></td>
                              <td width="211" class="azul_ezqcen_up" valign="middle" align="center">DESTINATARIO</td>
                              <td class="azul_ezqder_up"></td>
                   		  </tr>
                        	<tr>
                            	<td colspan="3" class="gris_cen" align="center">
                      ...
                      <tr>
                        <td width="57" class="fuentePloma" align="left">Cliente
                      ...
                      <tr>
                        <td class="fuentePloma" align="left">R.F.C.</td>
                        <td align="left"><input name="des_rfc" type="text" readonly="true" id="rrfc22" class="estiloCajas" value="<?=$rrfc ?>" /></td>
                      </tr>
                      <tr>
                        <td class="fuentePloma" align="left">Nombre</td>
                        <td align="left"><table width="145" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                   ...
                   class="estiloCajas" value="<?=$rcliente ?>"/></td>
                      ...
                      <tr>
                        <td class="fuentePloma" align="left">Calle</td>
                        <td id="celda_des_calle" align="left"><input name="des_calle" readonly="true" type="text" class="estiloCajas" value="" /><input type="hidden" name="des_direcciones" /></td>
                      </tr>
                      <tr>
                        <td class="fuentePloma" align="left">Número</td>
                        <td align="left"><span >
                          <input name="des_numero" type="text" readonly="true" class="estiloCajas" value="<?=$rnumero ?>" />
                        </span></td>
                      </tr>
                      <tr>
                        <td class="fuentePloma" align="left">C.P.</td>
                        <td align="left"><input name="des_cp" type="text" readonly="true" class="estiloCajas" value="<?=$rcp ?>" /></td>
                      </tr>
                      <tr>
                        <td class="fuentePloma" align="left">Colonía</td>
                        <td align="left"><span >
                          <input name="des_colonia" type="text" readonly="true" class="estiloCajas" value="<?=$rcolonia ?>" />
                        </span></td>
                      </tr>
                      <tr>
                        <td class="fuentePloma" align="left">Población</td>
                        <td align="left"><input name="des_poblacion" readonly="true" type="text" class="estiloCajas" value="<?=$rpoblacion ?>" /></td>
                      </tr>
                      <tr>
                        <td class="fuentePloma" align="left">Teléfono</td>
                        <td align="left"><span >
                          <input name="des_telefono" type="text" readonly="true" class="estiloCajas" value="<?=$rtelefono ?>"/>
                        </span></td>
                      </tr>
                    </table>                   			  </td>
                    		</tr>
            	...
            	<tr>
            	  <td height="107" colspan="2" valign="top">
                  	<table border="0" cellpadding="0" cellspacing="0" id="tablaconteva">
              </table>              </td>
<td rowspan="2" valign="top"><table width="233" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td class="azul_ezqizq_up"></td>
    <td width="211" class="azul_ezqcen_up"></td>
    <td class="azul_ezqder_up"></td>
  </tr>
  <tr>
    <td colspan="3" class="azul_cen" align="center"><table width="90%" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="41%" valign="middle" ><input type="hidden" value="0" name="pagoregistrado" />
              ...
              <input type="hidden" value="" name="nc_folio" /></td>
        <td colspan="2" ><input type="hidden" name="pc_ead" />
      ...
      <tr>
        <td class="fuenteBlanca" align="left">Flete:</td>
        <td align="left"><input name="flete" readonly="true" type="text" style="font:tahoma; font-size:9px; text-align:right; width:94px" value="<?=$rrfc ?>"  /></td>
        <td >&nbsp;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td align="left"><input name="t_txtdescuento2" type="text" readonly="true" style="font:tahoma; font-size:9px; text-align:right; width:94px" value="<?=$rrfc ?>" /></td>
        <td >&nbsp;</td>
      </tr>
      <tr>
        <td  class="fuenteBlanca" align="left">EAD:
          <input name="t_txteadh" type="hidden" />
              <input name="t_txteadh2" type="hidden" /></td>
        <td align="left"><input readonly="true" name="t_txtead" type="text" style="font:tahoma; font-size:9px; text-align:right; width:94px" value="<?=$rrfc ?>"  /></td>
        <td >&nbsp;</td>
      </tr>
      <tr>
        <td  class="fuenteBlanca" align="left">Recolecci&oacute;n:
          <input name="t_txtrecoleccionh" type="hidden" /></td>
        <td align="left"><input readonly="true" name="t_txtrecoleccion" type="text" style="font:tahoma; font-size:9px; text-align:right; width:94px" value="<?=$rrfc ?>"  /></td>
        <td >&nbsp;</td>
      </tr>
      <tr>
        <td  class="fuenteBlanca" align="left">Seguro:</td>
        <td align="left"><input readonly="true" name="t_txtseguro" type="text" style="font:tahoma; font-size:9px; text-align:right; width:94px" value="<?=$rrfc ?>"  /></td>
        <td >&nbsp;</td>
      </tr>
      <tr>
        <td  class="fuenteBlanca" align="left">Otros:</td>
        <td align="left"><input name="t_txtotros" readonly="true" type="text" style="font:tahoma; font-size:9px; text-align:right; width:94px" value="<?=$rrfc ?>"  /></td>
        <td >&nbsp;</td>
      </tr>
      <tr>
        <td  class="fuenteBlanca" align="left" valign="middle"> Excedente</td>
        <td align="left"><input name="t_txtexcedente" readonly="true" type="text" style="font:tahoma; font-size:9px; text-align:right; width:94px" value="<?=$rrfc ?>"  /></td>
        <td >&nbsp;</td>
      </tr>
      <tr>
        <td  class="fuenteBlanca" align="left" valign="middle">Combustible</td>
        <td align="left"><input name="t_txtcombustible" readonly="true" type="text" style="font:tahoma; font-size:9px; text-align:right; width:94px" value="<?=$rrfc ?>"  /></td>
        <td >&nbsp;</td>
      </tr>
      <tr>
        <td  class="fuenteBlanca" align="left" valign="middle">Subtotal</td>
        <td align="left"><input name="t_txtsubtotal" readonly="true" type="text" style="font:tahoma; font-size:9px; text-align:right; width:94px" value="<?=$rrfc ?>"  /></td>
        <td >&nbsp;</td>
      </tr>
      <tr>
        <td  class="fuenteBlanca" align="left" valign="middle">Iva</td>
        <td align="left"><input name="t_txtiva" readonly="true" type="text" style="font:tahoma; font-size:9px; text-align:right; width:94px" value="<?=$rrfc ?>"  /></td>
        <td >&nbsp;</td>
      </tr>
      <tr>
        <td  class="fuenteBlanca" align="left" valign="middle">Iva Retenido</td>
        <td align="left"><input name="t_txtivaretenido" readonly="true" type="text" style="font:tahoma; font-size:9px; text-align:right; width:94px" value="<?=$rrfc ?>"  /></td>
        <td >&nbsp;</td>
      </tr>
      <tr>
        <td  class="fuenteBlanca" align="left" valign="middle">Total</td>
        <td align="left"><input name="t_txttotal" readonly="true" type="text" style="font:tahoma; font-size:9px; text-align:right; width:94px" value="<?=$rrfc ?>"  /></td>
        <td >&nbsp;</td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td class="azul_ezqizq_dw"></td>
    <td class="azul_cen"></td>
    <td class="azul_ezqder_dw"></td>
  </tr>
</table></td>
           	  </tr>
            	<tr>
       	    ...
       	    <tr>
                	<td align="left" valign="top">                                        
                      <table width="206" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          <td class="azul_ezqizq_up"></td>
                          <td width="284" class="azul_ezqcen_up"></td>
                          <td class="azul_ezqder_up"></td>
                        </tr>
                        <tr>
                          <td colspan="3" class="azul_cen" align="center">
                            <table width="177" border="0" align="right" cellpadding="0" cellspacing="0">
                              <tr>
                                <td width="120" align="left" class="fuenteBlanca">Total Paquetes: </td>
                                <td width="65" align="left"><input name="totalpaquetes" type="text" readonly="true" style="font:tahoma; font-size:9px; width:40px" value="<?=$rcp ?>"/></td>
                              </tr>
                              <tr>
                                <td width="120" align="left" class="fuenteBlanca">Total Peso Kg: </td>
                                <td width="65" align="left"><input name="totalpeso" type="text" readonly="true" style="font:tahoma; font-size:9px; width:40px" value="<?=$rcp ?>" /></td>
                              </tr>
                              <tr>
                                <td width="120" align="left" class="fuenteBlanca">Total Volumen: </td>
                                <td width="65" align="left"><input name="totalvolumen" type="text" readonly="true" style="font:tahoma; font-size:9px; width:40px" value="<?=$rcp ?>" /></td>
                              </tr>
                            </table>                          </td>
                          </tr>
                        <tr>
...
<tr>
                            	<td class="gris_ezqizq_up"></td>
                              <td width="238" class="gris_cen"></td>
                              <td class="gris_ezqder_up"></td>
                   		  </tr>
                        	<tr>
                            	<td colspan="3" class="gris_cen" align="center">
                                
                                <table width="241" height="76" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td width="7%" ><input name="chkemplaye" type="checkbox" style="width:8px; height:8px" value="SI" onclick="if(!this.checked){document.all.txtemplaye.value='';}else{document.all.txtemplaye.value = document.all.txtemplayeh.value} calculartotales();" /></td>
      <td class="fuentePloma" align="left">Emplaye </td>
      <td width="48%" ><input name="txtemplaye" readonly="true" type="text" style="font:tahoma; font-size:9px; text-align:right" />
    ...
    <tr>
      ...
      <td class="fuentePloma" align="left">Bolsa Empaque
      ...
      <td ><input name="txtbolsaempaque1" readonly="true" onblur="if(this.readOnly==false){calculartotales();}" onkeypress="if(this.readOnly==false &amp;&amp; event.keyCode==13){document.all.txtbolsaempaque2.value='$ '+numcredvar((parseFloat((document.all.txtbolsaempaque3h.value=='')?'0':document.all.txtbolsaempaque3h.value.replace('$ ', '').replace(/,/g,''))*parseFloat(this.value)).toLocaleString());calculartotales();}else{return solonumeros(event);}" type="text" style="font:tahoma; font-size:9px; text-align:right" value="<?=$rrfc ?>"  /></td>
    </tr>
    <tr>
    	<td></td>
        <td>&nbsp;</td>
        <td><input name="txtbolsaempaque2" readonly="true" type="text" style="font:tahoma; font-size:9px; text-align:right" /></td>
    </tr>
    <tr>
      ...
      <td class="fuentePloma" align="left">Aviso Celular
        <input name="txtavisocelular1h" type="hidden" />
          <input name="txtavisocelular2h" type="hidden" /></td>
      <td ><input name="txtavisocelular1" readonly="true" type="text" style="font:tahoma; font-size:9px; text-align:right" /></td>
    </tr>
    <tr>
    	<td></td>
        <td>&nbsp;</td>
        <td><input name="txtavisocelular2" readonly="true" type="text" style="font:tahoma; font-size:9px" value="<?=$rrfc ?>" /></td>
    </tr>
    <tr>
      ...
      <td class="fuentePloma" align="left">Valor Declarado
        <?
			  	$s = "SELECT maxvalordeclaradoguia FROM configuradorgeneral";
				$rmvd = mysql_query($s,$l) or die($s);
				$fmvd = mysql_fetch_object($rmvd);
			  ?></td>
      <td ><input name="txtdeclarado" type="text" readonly="true" onblur="if(this.readOnly==false){this.value=this.value.replace('$ ','').replace(/,/,'');  if(this.value==''){this.value='$ 0.00';}else{ if(parseFloat(this.value) &gt; <?=$fmvd->maxvalordeclaradoguia?>){this.value = <?=$fmvd->maxvalordeclaradoguia?>; alerta3('El maximo valor declarado permitido es <?=$fmvd->maxvalordeclaradoguia?>', '¡Atencion!');} this.value='$ '+numcredvar(this.value); calculartotales(); }}" onkeypress="if(this.readOnly==false){ if(event.keyCode==13){ if(this.value==''){this.value=0;} this.value='$ '+numcredvar(this.value.replace('$ ','').replace(/,/,'')); calculartotales();}else{return solonumeros(event);}} " style="font:tahoma; font-size:9px; text-align:right" value="<?=$rrfc ?>" /></td>
    </tr>
    <tr>
      <td>
        <input name="chkacuserecibo" onclick="if(!this.checked){document.all.txtacuserecibo.value='';}else{document.all.txtacuserecibo.value=document.all.txtacusereciboh.value;} calculartotales();" type="checkbox" style="width:8px; height:9px" value="SI" />      </td>
      <td class="fuentePloma" align="left">Acuse Recibo</td>
      <td ><input readonly="true" name="txtacuserecibo" type="text" style="font:tahoma; font-size:9px; text-align:right" value="<?=$rrfc ?>" />
          <input name="txtacusereciboh" type="hidden" /></td>
    </tr>
    <tr>
      <td>
        <input name="chkcod" onclick="if(!this.checked){document.all.txtcod.value='';}else{document.all.txtcod.value=document.all.txtcodh.value;} calculartotales();" type="checkbox" style="width:8px; height:8px" value="SI" />      </td>
      <td class="fuentePloma" align="left">COD</td>
      <td ><input readonly="true" name="txtcod" type="text" style="font:tahoma; font-size:9px; text-align:right" value="<?=$rrfc ?>" />
          <input name="txtcodh" type="hidden" /></td>
    </tr>
    <tr>
      <td>
        <input name="chkrecoleccion" type="checkbox" onclick="if(!this.checked){document.all.txtrecoleccion.value=''; document.all.t_txtrecoleccion.value=''; }else{document.all.txtrecoleccion.value=document.all.txtrecoleccionh.value; } calculartotales();" id="chocurre24" style="width:8px; height:8px" value="SI" />      </td>
      <td class="fuentePloma" align="left">Recolecci&oacute;n</td>
      <td ><input readonly="true" name="txtrecoleccion" type="text" style="font:tahoma; font-size:9px; text-align:right; text-align:right" value="<?=$rrfc ?>" />
       	    ...
       	    <td colspan="3"><table border="0" cellpadding="0" cellspacing="0">
            	...
            	<tr>
            	  <td colspan="3">
            	    <table>
                  	<tr>
                    	<td width="253"><textarea name="txtobservaciones" style="width:320px; font-size:9px; font:tahoma; text-transform:uppercase"></textarea></td>
                    </tr>
                  </table>           	      </td>
          	  </tr>
            	<tr>
            	  <td colspan="3"><table width="616" border="0" cellpadding="0" cellspacing="0">
            	    <tr>
            	      <td width="50" >Recibio</td>
            	      <td width="211" ><input type="text" name="recibio" readonly="true" style="width:200px; font-size:9px" /></td>
            	      <td width="75" >Fecha Entrega</td>
            	      <td width="122" ><input type="text" name="fechaentrega" readonly="true" style="width:110px; font-size:9px" /></td>
            	      <td width="38" >Factura</td>
            	      <td width="120" ><input type="text" name="factura" readonly="true" style="width:110px; font-size:9px" /></td>
          	      </tr>
          	    </table></td>
          	  </tr>
            	<tr>
