...
if($_GET['accion']==1){// BUSCAR Detalle
	$s = "SELECT nombre,puesto, telefono, celular,email
	FROM catalogoproveedordetalle  WHERE idproveedor='".$_GET['idproveedor']."' ";
		...
		if(mysql_num_rows($r)>0){
			...
			$xml.="<puesto>".$f->puesto."</puesto>";
			$xml.="<telefono>".$f->telefono."</telefono>";
			$xml.="<celular>".$f->celular."</celular>";
...
if($_GET['accion']==2){ // Buscar codigo postal catalogoproveedores
