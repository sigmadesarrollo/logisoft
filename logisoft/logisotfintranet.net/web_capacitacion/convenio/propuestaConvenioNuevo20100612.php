...
Persona F&iacute;sica</td>
		...
		<div class="dvTable clearfix" style="width:780px;  margin-top:5px; float:left;">
                 <div class="c2">Valor declarado</div>
                <div class="c3"></div>
                 <div class="c2"></div>
                <div class="c3"></div>
				<div class="c2"></div>
				<div class="c2"></div>
				<div class="c3" style="width:20px"></div>				
                 <div class="c3" style="width:40px" >Costo</div>
                <div class="c2" style="text-align:left; width:120px"><input name="valordeclarado" id="valordeclarado" type="text" class="text" style="width:100px; font-size:11px; margin:0px;" onKeyPress="if(event.keyCode==13){ this.value = convertirMoneda(this.value);document.all.limite.focus();}else{return tiposMoneda(event,this.value)}"/></div>
                <div class="c3" style="width:45px">Límite</div>
                <div class="c2" style="text-align:left; width:120px"><input name="limite" id="limite" onKeyPress="if(event.keyCode==13){document.all.porcada.focus();}else{return solonumeros2(event)}" type="text" class="text" style="width:80px;font-size:11px; margin:0px;" /></div>
                <div class="c3" style="width:55px">Por cada</div>
                <div class="c2" style="text-align:left; width:120px"><input name="porcada" id="porcada" onKeyPress="if(event.keyCode==13){document.all.costoextra.focus();}else{return solonumeros2(event)}" type="text" class="text" style="width:80px;font-size:11px; margin:0px;" /></div>
                <div class="c3">Costo Extra</div>
                <div class="c2"><input name="costoextra" id="costoextra" type="text" class="text" style="width:100px;font-size:11px; margin:0px;" onKeyPress="if(event.keyCode==13){this.value = convertirMoneda(this.value);document.all.radiogrupo[0].focus();}else{return tiposMoneda(event,this.value)}"/></div>
          </div>		 
		  </div>-->
         		<div class="doc-req2">
			    <div class="menu">
          ...
          <tr>
            ...
            onClick="ubi.div_descripcion.innerHTML = conveniodescripcion; ubi.descuentoflete.value=''; ubi.descuentoflete.readOnly=true; ubi.descuentoflete.style.backgroundColor = '#FFFF99'; document.all.boton_agregarpreciokg.style.visibility = (this.checked)?'visible':'hidden'; if(!this.checked){ubi.div_preciokg.innerHTML = conveniopesokg; ubi.tienedatoskg.value=0} bloquearObjeto(ubi.boton_agregarcajapaquete,true); ubi.tienedatoskg.value = 0;  ubi.tienedatoskg_excedio.value = 0; ubi.tienedatosprecio.value = 0; ubi.tienedatosprecio_excedio.value = 0; " onDblClick="desahabilitarNormal('1')" />
            Precio por KG</td>
            <td colspan="2"><input type="radio" name="radiogrupo" value="checkbox" 
             onclick=" ubi.div_preciokg.innerHTML = conveniopesokg; ubi.descuentoflete.value=''; document.all.boton_agregarcajapaquete.style.visibility = (this.checked)?'visible':'hidden'; if(!this.checked){ubi.div_descripcion.innerHTML = conveniodescripcion; ubi.tienedatosprecio.value=0}else{ubi.descuentoflete.style.backgroundColor = ''; ubi.descuentoflete.readOnly=false;}bloquearObjeto(ubi.boton_agregarpreciokg,true);" ondblclick="desahabilitarNormal('2')"/>
            ...
            <td width="121"><input name="descuentoflete" type="text" class="text" id="descuentoflete" onkeypress="return solonumeros(event)" style="width:100px;font-size:11px; margin:0px;" readonly="readonly" onblur="if(this.value &gt; '<?=$f->desmaximopermitido?>'){alerta3('El descuento maximo permitido es de <?=$f->desmaximopermitido?>','&iexcl;Atenci&oacute;n!');}" /></td>
      </tr>
