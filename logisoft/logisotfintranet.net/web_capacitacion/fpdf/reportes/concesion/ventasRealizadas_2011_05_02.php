<?	require_once('../../fpdf.php');
	...
	comision,recoleccion,comisionrad,entrega,comisionead,ifnull(sobrepeso,0) as sobrepeso,total,condicion,estado
	FROM reporte_concesiones WHERE tipo = 'V' AND folioconcesion = ".$_GET[folio]."";
	...
	$pdf->AliasNbPages();
	$titulos = array('GUIA','FECHA','FLETE','DESCUENTO','FLETE NETO','COMISION','RECOLECCION','COMISION RAD','ENTREGA','COMISION EAD','COM. SOBREPESO','TOTAL','CONDICION','STATUS');
	$medidas = array(22,15,20,20,25,20,20,20,20,20,20,35,25,40);
	$pdf->AddPage();
