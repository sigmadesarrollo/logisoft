<?
	...
	*/
	...
	$_POST[total] = $f->total;
		...
		$s = "update facturacion SET facturaestado = 'GUARDADO', tipofactura='NORMAL', 
		...
		*/
		...
		$s = "update pagoguias SET guia = '$nfact', tipo='FACT', total='$_POST[valorcontado]', 
		fechacreo = CURRENT_DATE, usuariocreo = $_SESSION[IDUSUARIO], sucursalcreo = $_POST[sucorigen], 
		cliente = '$_POST[cliente]', credito='SI',
		sucursalacobrar = '$_POST[sucorigen]', pagado='N' WHERE guia = '$lafactura'";
		...
		$s = "delete from facturadetalle where factura = $lafactura";
		mysql_query($s,$l) or die($s);

		$s = "INSERT INTO facturadetalle
		SELECT 0 AS id, ".$lafactura." AS factura, ge.id AS folio, 'CONSIGNACION' AS tipoguia, ge.fecha,
