	...
	function imprimirActivado(){
		...
		if(ubi.estadoc.innerHTML == "ACTIVADO"){
			...
			if(document.URL.indexOf("web/")>-1){		
				window.open("http://www.pmmintranet.net/web/fpdf/reportes/convenio.php?sucursal=<?=$_SESSION[IDSUCURSAL]?>&folio="+ubi.folio.value);			
			}else if(document.URL.indexOf("web_capacitacion/")>-1){
				window.open("http://www.pmmintranet.net/web_capacitacion/fpdf/reportes/convenio.php?sucursal=<?=$_SESSION[IDSUCURSAL]?>&folio="+ubi.folio.value);			
			}else if(document.URL.indexOf("web_pruebas/")>-1){
				window.open("http://www.pmmintranet.net/web_pruebas/fpdf/reportes/convenio.php?sucursal=<?=$_SESSION[IDSUCURSAL]?>&folio="+ubi.folio.value);
			}
