        ...
        <td colspan="2"><table width="532" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="94"><span class="Tablas">
              <input name="vencimiento" type="text" class="Tablas" id="vencimiento" style="width:80px;" value="<?=$vencimiento ?>"  onKeyUp="mascara(this,'/',patron,true);" onKeyPress="validarFecha(event,this.value,this.name);"/>
            </span></td>
...
<tr>
      ...
      <tr>
        <td colspan="2">
        	<select name="sucursalesead1" style="width:200px;">
              	<? 
				...
				?>
        	<select name="serviciosr1" style="width:200px;">
              	<? 
      ...
      <tr>
        <td colspan="2"><table width="534" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="52">Precio KG Excedente</td>
            <td width="83"><input name="preciokgexcedente" type="text" class="Tablas" style="width:70px;background:#FFFF99; text-align:right" onKeyPress="return tiposMoneda(event,this.value)" readonly value="<?=$Costo ?>"/></td>
          </tr>
        </table></td>
      </tr>
      <tr>
