...
<script>
	...
	function imprimirDocumentos(valor,folio){
		...
		alert(obtenerPrefijos[u.idsucursalorigen.value]+"|"+obtenerPrefijos[document.all.sucdestino_hidden.value]);
		...
		"|CONDICION DE PAGO: "+((u.tipopago.value==0)?'CONTADO':'CREDITO')+"|DOCUMENTO: <?=$_SESSION[NOMBREUSUARIO]?>";
