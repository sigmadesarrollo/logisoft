  ...
  <table width="500" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
    ...
    <tr>
      <td><table width="100%" align="center" cellpadding="0" cellspacing="0" >
          ...
          <tr>
            <td colspan="4"><input name="tguiacancelada" type="hidden" id="tguiacancelada" />
                <input name="tfactura" type="hidden" id="tfactura" readonly=""/>
            <input name="h_fecha" type="hidden" id="h_fecha" value="<?=date('d/m/Y') ?>" readonly=""/></td>
          </tr>
          <tr>
            <td colspan="4"><input name="accion" type="hidden" id="accion" />
                <input name="codigo" type="hidden" id="codigo"  />
                <input name="parcial" type="hidden" id="parcial"  />
                <input name="iniciocaja" type="hidden" id="iniciocaja"  />
                <input name="tefectivo" type="hidden" id="tefectivo"  />
                <input name="ttarjeta" type="hidden" id="ttarjeta"  />
                <input name="ttransferencia" type="hidden" id="ttransferencia"  />
                <input name="tcheque" type="hidden" id="tcheque"  />
                <input name="tretiros" type="hidden" id="tretiros"  />
                <input name="tnotascredito" type="hidden" id="tretiros"  />
                <input name="cambiafecha" type="hidden" id="cambiafecha" /></td>
          </tr>
          <tr>
            <td colspan="4">
