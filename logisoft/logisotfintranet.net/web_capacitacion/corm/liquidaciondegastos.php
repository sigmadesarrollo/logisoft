...
function validar(){
	...
	if(u.foliobitacora.value==""){
			...
			return false;			
	}else if(tabla1.getRecordCount()==0 && u.favor.value==0){
		...
		var con = datos.getElementsByTagName('encontro').item(0).firstChild.data;		
			if(con>0){
				if(datos.getElementsByTagName('existe').item(0).firstChild.data == "si"){
					alerta("El folio de bitacora de salida ya fue registrado en una liquidación",'¡Atención!','foliobitacora');
					return false;
				}			
				...
				u.favor.value			= datos.getElementsByTagName('favor').item(0).firstChild.data;
			}else{
				alerta("El folio de bitacora de salida no existe",'¡Atención!','foliobitacora');
			}
}
        ...
        <tr>
          <td><table width="461" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="24"><div class="ebtn_buscar" onClick="abrirVentanaFija('buscarBitacoraLiquidacion.php', 550, 450, 'ventana', 'Busqueda')"></div></td>
          ...
          <td width="461"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr> 
                    <td height="11"><input name="accion" type="hidden" id="accion" value="<?=$accion?>"> 
                      ...
                      <input name="favor" type="" id="favor"></td>
