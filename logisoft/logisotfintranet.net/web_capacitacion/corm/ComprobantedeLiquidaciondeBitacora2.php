...
<table width="550" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
 ...
 id="unidad" style="width:100px; background:#FF9" onKeyDown="return tabular(event,this)" value="<?=$unidad ?>" readonly ></td>
              <td>Gastos<br></td>
              <td><input name="gastos2" type="text" class="Tablas"
 id="gastos2" style="width:100px; background:#FF9" onKeyDown="return tabular(event,this)" value="<?=$gastos2 ?>" readonly  ></td>
            </tr>
          </table></td>
          </tr>
        <tr>
 ...
 id="foliopre" style="width:180px; background:#FF9" onKeyDown="return tabular(event,this)" value="<?=$foliopre ?>" readonly ></td>
              <td>Cantidad</td>
              <td><input name="cantidadpre2" type="text" class="Tablas"
 id="cantidadpre2" style="width:150px; background:#FF9" onKeyDown="return tabular(event,this)" value="<?=$cantidadpre2 ?>" readonly  ></td>
            </tr>
          </table></td>
        </tr>
        <tr>
 ...
 id="conductor" style="width:440px; background:#FF9" onKeyDown="return tabular(event,this)" value="<?=$conductor ?>" readonly  ></td>
            </tr>
          </table></td>
        </tr>
        <tr>
