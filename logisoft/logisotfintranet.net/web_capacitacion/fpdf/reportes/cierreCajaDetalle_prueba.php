<?	require_once("../../Conectar.php");
	...
	AND ".((!empty($_GET[fechainicio]))? "ge.fecha BETWEEN '".cambiaf_a_mysql($_GET[fechainicio])."' AND '".cambiaf_a_mysql($_GET[fechafin])."'" 
	: "ge.fecha = '".cambiaf_a_mysql($_GET[fecha])."'")." ORDER by ce.id";
	...
	AND ".((!empty($_GET[fechainicio]))? "c.fechacorreo BETWEEN '".cambiaf_a_mysql($_GET[fechainicio])."' AND '".cambiaf_a_mysql($_GET[fechafin])."'" 
	: "c.fechacorreo = '".cambiaf_a_mysql($_GET[fecha])."'")." AND c.estado='GUARDADO' order by ce.id";
	...
	: "fp.fecha = '".cambiaf_a_mysql($_GET[fecha])."'")." AND gv.estado<>'CANCELADO' order by ce.id";
	...
	$criterioingresoguiasforaneacobrarcontadoentregadas = " WHERE gv.tipoflete = 1 AND gv.condicionpago = 0 AND (gv.estado = 'ENTREGADA' OR gv.estado = 'POR ENTREGAR') AND gv.idsucursaldestino = ".$_GET[sucursal]." 
	AND ".((!empty($_GET[fechainicio]))? "gv.fechaentrega BETWEEN '".cambiaf_a_mysql($_GET[fechainicio])."' AND '".cambiaf_a_mysql($_GET[fechafin])."'" 
	: "gv.fecha = '".cambiaf_a_mysql($_GET[fecha])."'")." AND gv.estado<>'CANCELADO' order by ce.id";
	...
	$criterioingresoguiasforaneacobrarcreditoentregadas = " WHERE gv.tipoflete = 1 AND gv.condicionpago = 1 AND (gv.estado = 'ENTREGADA' OR gv.estado = 'POR ENTREGAR') AND gv.idsucursaldestino = ".$_GET[sucursal]." 
	AND ".((!empty($_GET[fechainicio]))? "gv.fechaentrega BETWEEN '".cambiaf_a_mysql($_GET[fechainicio])."' AND '".cambiaf_a_mysql($_GET[fechafin])."'" 
	: "gv.fecha = '".cambiaf_a_mysql($_GET[fecha])."'")." AND gv.estado<>'CANCELADO' order by ce.id";
	...
	$criterioguiasforaneapagadacontadoentregadas = " WHERE gv.tipoflete = 0 AND gv.condicionpago = 0 AND (gv.estado = 'ENTREGADA' OR gv.estado = 'POR ENTREGAR') AND gv.idsucursaldestino = ".$_GET[sucursal]." 
	AND ".((!empty($_GET[fechainicio]))? "gv.fechaentrega BETWEEN '".cambiaf_a_mysql($_GET[fechainicio])."' AND '".cambiaf_a_mysql($_GET[fechafin])."'" 
	: "gv.fecha = '".cambiaf_a_mysql($_GET[fecha])."'")." AND gv.estado<>'CANCELADO' order by ce.id";
	...
	$criterioguiasforaneapagadacreditoentregadas = " WHERE gv.tipoflete = 0 AND gv.condicionpago = 1 AND (gv.estado = 'ENTREGADA' OR gv.estado = 'POR ENTREGAR') AND gv.idsucursaldestino = ".$_GET[sucursal]." 
	AND ".((!empty($_GET[fechainicio]))? "gv.fechaentrega BETWEEN '".cambiaf_a_mysql($_GET[fechainicio])."' AND '".cambiaf_a_mysql($_GET[fechafin])."'" 
	: "gv.fecha = '".cambiaf_a_mysql($_GET[fecha])."'")." AND gv.estado<>'CANCELADO' order by ce.id";
	...
	AND ".((!empty($_GET[fechainicio]))? "gv.fecha BETWEEN '".cambiaf_a_mysql($_GET[fechainicio])."' AND '".cambiaf_a_mysql($_GET[fechafin])."'" 
	: "gv.fecha = '".cambiaf_a_mysql($_GET[fecha])."'")." ORDER BY gv.idusuario";
