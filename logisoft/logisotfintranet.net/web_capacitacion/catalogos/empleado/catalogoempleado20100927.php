...
CLASSID="CLSID:36ECA653-F56F-421B-8FD4-A1803009DF8A"
...
<script>
	...
	window.onload = function(){
		...
		huella.Inicializar();
		huella.ponerBaseDatos("pmm_curso");
		verificarSiPuso();
	}
	...
	function verificarSiPuso(){
		...
		if(document.getElementById('imagenHuella').style.visibility!="visible")
			setTimeout("verificarSiPuso()","1000");
	}
	
	function Verificar(){
		var claveusu = huella.IdentificaUsuario();
		if(claveusu==0){
	...
	function CapturarHuella(){
		if(document.getElementById('imagenHuella').style.visibility!="visible"){
			mens.show('A','Por favor proporcione la huella',"¡Atencion!");
			return false;
		}
		...
		if(huella.guardarHuella(document.all.empleado.value)==1){
      ...
      <td><table width="499" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td colspan="2" align="center" bgcolor="#EFEFEF">
            <img src="../../img/huella_azul.jpg" width="47" height="56" id="imagenHuella" style="visibility:hidden"></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        </tr>
        <tr>
