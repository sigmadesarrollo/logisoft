...
alerta('El Porcentaje de Comisión no debe ser Mayor al 100%','¡Atención!','comision'); document.getElementById('lleno').value="NO";
	...
	function limpiar(){
		...
		document.getElementById('ventas').value="0"; 	document.getElementById('recibido').value="0"; 
		document.getElementById('porcead').value="0"; 	document.getElementById('porcrecoleccion').value="0"; 
		document.getElementById('lleno').value="0"; 		document.form1.concesion.checked=false; 
		document.getElementById('comision').value="0"; 	document.getElementById('colonia').value=""; 
		...
		document.getElementById('iva').value="0"; 		document.getElementById('oculto').value=""; 
		document.all.bascula.checked=false; 			document.all.cajachica.value ="0"; 
		document.all.hrs.value="00"; 					document.all.min.value="00"; 
		document.all.entrecalles.value="";				document.getElementById('accion').value = ""; 
		document.getElementById('colonia_hidden').value = ""; 	document.getElementById('txtnconces').value=""; 
		u.monitoreo.checked = false;	u.fleteenviado.value = "0"; 
		u.sobrepeso.value = "0";			u.fleterecibido.value = "0";
		u.frontera.checked = false;
		obtenerGeneral();                  
	}
function limpiartodo(){
document.getElementById('oculto').value=""; document.getElementById('prefijo').value=""; document.getElementById('descripcion').value=""; document.getElementById('idsucursal').value="";	document.getElementById('calle').value="";	document.getElementById('numero').value="";	document.getElementById('cp').value="";	document.getElementById('ventas').value="0"; document.getElementById('recibido').value="0"; document.getElementById('porcead').value="0"; document.getElementById('porcrecoleccion').value="0"; document.getElementById('lleno').value="0"; document.form1.concesion.checked=false; document.getElementById('comision').value="0"; document.getElementById('colonia').value=""; document.getElementById('poblacion').value=""; document.getElementById('municipio').value=""; document.getElementById('estado').value=""; 	document.getElementById('pais').value=""; document.getElementById('arreglo').value=""; document.getElementById('telefono').value=""; document.getElementById('fax').value="";  document.form1.lectores.checked=false; document.getElementById('iva').value="0";document.all.bascula.checked=false; document.all.cajachica.value ="0";document.all.entrecalles.value=""; u.fleteenviado.value = "0"; u.fleterecibido.value = "0"; u.sobrepeso.value = "0"; document.getElementById('txtnconces').value=""; 
 document.all.hrs.value=""; document.all.min.value=""; u.frontera.checked = false;
	...
	function mostrarSucursal(datos){
		...
		if(con>0){
			...
			u.txtnconces.value=datos.getElementsByTagName('nconcesionario').item(0).firstChild.data;
...
function HabilitarComision(){
	...
	document.getElementById('txtnconces').disabled=false
	document.getElementById('txtnconces').style.backgroundColor='';
	...
	document.getElementById('txtnconces').disabled=true
	document.getElementById('txtnconces').value="";
	document.getElementById('txtnconces').style.backgroundColor='#FFFF99';
	}
} 
              ...
              <tr>
               ...
               <tr>
                <td colspan="4"><table border="0" align="right" cellpadding="0" cellspacing="0">
                  <tr>
                    <td class="Tablas" width="115px" colspan="2">Nombre Concesionario:</td>
					<td colspan="2"><input name="txtnconces" type="text" id="txtnconces" value="<?=$nconces; ?>" size="44" class="Tablas"  disabled="disabled" style="font:tahoma;font-size:9px; background:#FFFF99"/></td>
					<td></td><td></td>
				  </tr>
				  <tr>
