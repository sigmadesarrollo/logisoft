...
<script>
	...
	tabla8.setAttributes({//CONSIGNACION SIN FACTURAR
		...
		campos:[
			...
			{nombre:"IMPORTE POR FACTURAR", medida:85, tipo:"moneda", alineacion:"right", onDblClick:"guiasSinFacturar", datos:"total"}
		],
		filasInicial:30,
		alto:250,
		seleccion:true,
	...
	tabla14.setAttributes({ // guias pendientes de facturar
		nombre:"detalle14",
		campos:[
			{nombre:"FOLIO", medida:100, alineacion:"center", datos:"folio"},
			{nombre:"TIPO GUIA", medida:120, alineacion:"center",datos:"tipoguia"},
			{nombre:"FECHA", medida:80, alineacion:"center",datos:"fecha"},
			{nombre:"FLETE", medida:80, tipo:"moneda", alineacion:"right", datos:"flete"},
			{nombre:"DESCUENTO", medida:80, tipo:"moneda", alineacion:"right", datos:"descuento"},
			{nombre:"EXCEDENTE", medida:80, tipo:"moneda", alineacion:"right", datos:"excedente"},
			{nombre:"EAD", medida:80, tipo:"moneda", alineacion:"right", datos:"ead"},
			{nombre:"RECOLECCION", medida:80, tipo:"moneda", alineacion:"right", datos:"recoleccion"},
			{nombre:"SEGURO", medida:80, tipo:"moneda", alineacion:"right", datos:"seguro"},
			{nombre:"COMBUSTIBLE", medida:80, tipo:"moneda", alineacion:"right", datos:"combust"},
			{nombre:"OTROS", medida:80, tipo:"moneda", alineacion:"right", datos:"otros"},
			{nombre:"SUBTOTAL", medida:80, tipo:"moneda", alineacion:"right", datos:"subtotal"},
			{nombre:"IVA", medida:50, tipo:"moneda", alineacion:"right", datos:"iva"},
			{nombre:"IVA RET.", medida:50, tipo:"moneda", alineacion:"right", datos:"ivaretenido"},
	...
	window.onload = function(){
		...
		tabs.agregarTabs('Guias pendientes de facturar',13,null);
		...
		u.tab_contenedor_id13.disabled = true;
		tabs.seleccionar(0);
	}
	...
	function paginacion1(movimiento){
		switch(movimiento){
			case 'primero':
				...
				+"&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text+"&s="+Math.random());
				break;
			case 'adelante':
				if(u.pag2_adelante.value==1){
					consultaTexto("resTabla2","consultas.php?accion=2&contador="+(parseFloat(u.pag2_contador.value)+1)+"&sucursal="+u.sucursal_hidden.value
					+"&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text+"&s="+Math.random());
				}
				break;
			case 'atras':
				if(u.pag2_atras.value==1){
					...
					+"&sucursal="+u.sucursal_hidden.value+"&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text+"&s="+Math.random());
				}
				break;
			case 'ultimo':
				var contador = Math.floor((parseFloat(u.pag2_total.value)-1)/parseFloat(pag1_cantidadporpagina));
				consultaTexto("resTabla2","consultas.php?accion=2&contador="+contador+"&sucursal="+u.sucursal_hidden.value
				+"&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text+"&s="+Math.random());
				break;
		}
	}
	...
	function obtenerFacturado(){
		...
		consultaTexto("resTabla3","consultas.php?accion=3&sucursal="+u.sucursal_hidden.value+"&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text
	...
	function paginacion2(movimiento){
		switch(movimiento){
			case 'primero':
				...
				+"&sucursal="+u.sucursal_hidden.value+"&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text);
				break;
			case 'adelante':
				if(u.pag3_adelante.value==1){
					consultaTexto("resTabla3","consultas.php?accion=3&contador="+(parseFloat(u.pag3_contador.value)+1)+"&sucursal="+u.sucursal_hidden.value
					+"&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text+"&s="+Math.random());
				}
				break;
			case 'atras':
			...
			case 'ultimo':
				...
				consultaTexto("resTabla3","consultas.php?accion=3&contador="+contador+"&sucursal="+u.sucursal_hidden.value
				+"&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text+"&s="+Math.random());
				break;
		}
	}
	function obtenerTotalFacturado(){
		...
		consultaTexto("resTabla4","consultas.php?accion=4&sucursal="+obj.idsucursal+"&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text
	...
	function paginacion3(movimiento){
		switch(movimiento){
			case 'primero':
				...
				+"&sucursal="+v_suc1+"&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text);
				break;
			case 'adelante':
				if(u.pag4_adelante.value==1){
					consultaTexto("resTabla4","consultas.php?accion=4&contador="+(parseFloat(u.pag4_contador.value)+1)
					+"&sucursal="+v_suc1+"&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text+"&s="+Math.random());
				}
				break;
			case 'atras':
			...
			case 'ultimo':
				...
				consultaTexto("resTabla4","consultas.php?accion=4&contador="+contador+"&sucursal="+v_suc1
				+"&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text+"&s="+Math.random());
				break;
		}
	}
	...
	function obtenerTotalFacturadoSucursal(){
		...
		consultaTexto("resTabla9","consultas.php?accion=9&sucursal="+obj.idsucursal+"&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text
	...
	function obtenerVigentes(){
		...
		consultaTexto("resTabla10","consultas.php?accion=10&sucursal=<?=$_SESSION[IDSUCURSAL]?>&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text
		+"&contador="+u.pag10_contador.value+"&s="+Math.random());
	}
	...
	function obtenerVencidos(){
		...
		consultaTexto("resTabla11","consultas.php?accion=11&sucursal=<?=$_SESSION[IDSUCURSAL]?>&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text
		+"&contador="+u.pag11_contador.value+"&s="+Math.random());
	}
	...
	function obtenerTotalConvenios(){
		...
		consultaTexto("resTabla12","consultas.php?accion=12&sucursal=<?=$_SESSION[IDSUCURSAL]?>&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text
		+"&contador="+u.pag12_contador.value+"&s="+Math.random());
	}
	...
	function guiasSinFacturar(){		
		var obj = tabla8.getSelectedRow();
		v_idcliente=obj.idcliente;
		v_prefijo=obj.prefijosucursal;
		if(!tabla14.creada()){
			tabla14.create();
		}
		consultaTexto("resTabla14","consultas.php?accion=15&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text
		+"&idcliente="+obj.idcliente+"&prefijo="+obj.prefijosucursal
		+"&contador="+u.pag14_contador.value+"&s="+Math.random());
	}
	
	function resTabla14(datos){
		var obj = eval(convertirValoresJson(datos));		
		u.pag14_total.value 	= obj.total;
		u.pag14_contador.value 	= obj.contador;
		u.pag14_adelante.value 	= obj.adelante;
		u.pag14_atras.value 	= obj.atras;
		u.totales14.value		= obj.totales.total;
		
		if(obj.registros.length>0){			
			tabla14.setJsonData(obj.registros);
		}
		
		u.tab_contenedor_id13.disabled=false;
		tabs.seleccionar(13);
		tabs.moverManual(-1030);
		if(obj.paginado==1){
			document.getElementById('paginado14').style.visibility = 'visible';
		}else{
			document.getElementById('paginado14').style.visibility = 'hidden';
		}
	}
	
	function paginacion14(movimiento){
		switch(movimiento){
			case 'primero':
				consultaTexto("resTabla14","consultas.php?accion=15&contador=0&s="+Math.random()
				+"&idcliente="+v_idcliente+"&prefijo="+v_prefijo
				+"&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text);
				break;
			case 'adelante':
				if(u.pag14_adelante.value==1){
					consultaTexto("resTabla14","consultas.php?accion=15&contador="+(parseFloat(u.pag14_contador.value)+1)
					+"&idcliente="+v_idcliente+"&prefijo="+v_prefijo
					+"&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text
					+"&s="+Math.random());
				}
			...
			case 'ultimo':
				...
				var contador = Math.floor((parseFloat(u.pag14_total.value)-1)/parseFloat(pag1_cantidadporpagina));
				
				consultaTexto("resTabla14","consultas.php?accion=15&contador="+contador
				+"&idcliente="+v_idcliente+"&prefijo="+v_prefijo
				+"&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text				
				+"&s="+Math.random());
				break;
	...
	function imprimirReporte(tipo){
		...
		switch (tipo){
			...
			case 10:
				window.open(v_dir+"convenioExcel.php?accion=1&s=ACTIVADO&titulo=CONVENIOS VIGENTES&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text
				+"&val="+Math.random());
			break;
			
			case 11:
				window.open(v_dir+"convenioExcel.php?accion=1&s=EXPIRADO&titulo=CONVENIOS VENCIDOS&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text
				+"&val="+Math.random());
			break;
			...
			case 13:
				window.open(v_dir+"historialExcel.php?cliente="+v_clien10+"&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text+"&val="+Math.random());
			break;
			
			case 14:
				window.open(v_dir+"generarExcel.php?accion=10&titulo=GUIAS SIN FACTURAR&cliente="+v_idcliente+"&prefijo="+v_prefijo
				+"&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text+"&val="+Math.random());
			break;
		}
	}
...
<div style="position:absolute; left: 2px; top: 24px; width: 621px; visibility:visible;" id="tab_tab_id13">
	<table width="550" border="0" cellspacing="0" cellpadding="0">  
  <tr>
    <td width="700" colspan="6">
	<div style="height:280px; width:700px; overflow:auto">
	<table width="100%" border="0" cellspacing="0" cellpadding="0" id="detalle14">
	</table>
	</div>	</td>
  </tr>
  <tr>
    <td colspan="6"><div id="paginado14" align="center" style="visibility:hidden">
              <img src="../../img/first.gif" name="primero" width="16" height="16" id="primero" style="cursor:pointer"  onclick="paginacion14('primero')" /> 
			  <img src="../../img/previous.gif" name="d_atrasdes" width="16" height="16" id="d_atrasdes" style="cursor:pointer" onclick="paginacion14('atras')" /> 
			  <img src="../../img/next.gif" name="d_sigdes" width="16" height="16" id="d_sigdes" style="cursor:pointer" onclick="paginacion14('adelante')" /> 
			  <img src="../../img/last.gif" name="d_ultimo" width="16" height="16" id="d_ultimo" style="cursor:pointer" onclick="paginacion14('ultimo')" />
      	  <input type="hidden" name="pag14_total" />
          <input type="hidden" name="pag14_contador" value="0" />
          <input type="hidden" name="pag14_adelante" value="" />
          <input type="hidden" name="pag14_atras" value="" />
          </div></td>
  </tr>
  <tr>
    <td colspan="6"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="84%" align="right">Total:</td>
        <td width="16%"><span class="style31">
          <input name="totales14" type="text" class="Tablas" id="totales14" readonly="" style="background-color:#FFFF99; width:90px; text-align:right;">
        </span></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td align="right"><div class="ebtn_imprimir" onclick="imprimirReporte(14)"></div></td>
      </tr>
    </table></td>
  </tr>  
</table>
