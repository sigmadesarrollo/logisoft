...
<script>
	...
	var botonesdesguardar = '<img src="../img/Boton_Imprimir.gif">&nbsp;&nbsp;<img src="../img/Boton_Nuevo.gif" style="cursor:hand" onClick="limpiar_evaluacion();limpiar_destinatario();limpiar_remitente();">';

	var botonesconsulta = '<img src="../img/Boton_Imprimir.gif">&nbsp;<img src="../img/Boton_Liberar.gif" style="cursor:hand" onClick="cancelarGuia()">&nbsp;<img src="../img/Boton_Nuevo.gif" style="cursor:hand" onClick="limpiar_evaluacion();limpiar_destinatario();limpiar_remitente();bloquear(false);">';
	...
	function calcularservicios(){
		...
		if(u.t_txteadh2.value=="0"){
			...
			if(u.t_txtrecoleccion.value != "$ 0.00" && u.t_txtrecoleccionh.value=="0"){
	...
	function registrarGuia(){
		...
		consulta("guiaGuardada","guiasempresariales_consulta.php?accion=4&evaluacion="+evaluacion+"&newfolio="+newfolio
				 ...
				 +"&convenioaplicado="+convenioaplicado+"&ran="+Math.random());
	...
	function cancelarGuia(){
		...
		if(u.estado.innerHTML=='AUTORIZACION PARA CANCELAR'){
			...
			if(u.estado.innerHTML != "ALMACEN ORIGEN"){
				...
				confirmar("Realmente desea liberar la guia","¡Atención!","liberarGuia()","");
	...
	function liberarGuia(){
		...
		consulta("respuestaLiberacion","guiasempresariales_consulta.php?accion=6&folio="+document.all.folioSeleccionado.innerHTML
	...
	function valcreditodisponible(){
		...
		if(u.tipoguia.value!="PREPAGADA"){
			...
			if(u.tipopago.value=="CREDITO"){
				...
				}else if(parseFloat(u.creditodisponible.value)<parseFloat(u.t_txttotal.value.replace("$ ","").replace(",",""))){
...
<table width="601" border="1" cellpadding="0" cellspacing="0" bordercolor="#016193">
  ...
  <tr>
    ...
    <td class="FondoTabla Estilo3">GUIAS EMPRESARIALES</td>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
 ...
 <tr>
        ...
        <td height=25 colspan="4">
        	...
        	<table width="619" cellpadding="0" cellspacing="0" border="0"><tr>

                <td width="204" align="left" id="folioSeleccionado" style="color:#F00000; font-size:15px; font-weight:bold; text-transform:uppercase;"></td>
        	  ...
        	  <tr>
        	    ...
        	    <td colspan="3" align="right" id="danosfaltantes" style="color:#C60; font-size:15px; font-weight:bold"></td>
 ...
 <tr>
    ...
    <table width="604" border="0" cellpadding="0" cellspacing="0">
    	...
    	<tr>
        	...
        	<td width="41" align="left">Estado</td>

        	<td width="446" id="estado" style="font:tahoma; font-size:15px; font-weight:bold" align="left"></td>

        	<td width="78" align="left"><img src="../img/Boton_Detalle.gif" style="cursor:pointer"

        onClick="abrirVentanaFija('../guias/informacionextra.php?tipo=1&folio='+document.all.folioSeleccionado.innerHTML, 660, 418, 'ventana', 'Detalle')"></td>
      ...
      <tr>
        ...
        <td colspan="4"><table width="609" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <select name="chocurre" id="chocurre" onchange="solicitarDatosConv(); if(document.all.restringiread.value==1){alerta('El destino tiene restringida la Entrega a Domicilio','&iexcl;Atencion!','chocurre'); this.checked=true;}else{if(this.value==1){document.all.t_txtead.value = document.all.t_txteadh.value}else{document.all.t_txtead.value = '$ 0.00';}} calculartotales();">
...
<input type="hidden" name="destino_hidden" />
          ...
          <tr>
            ...
            <td><table width="100%" border="0" cellpadding="0" cellspacing="1">
                ...
                <tr>
                  ...
                  <td><input name="iddestinatario" onkeypress="if(event.keyCode==13 &amp;&amp; this.readOnly==false){devolverDestinatario(this.value)}else{return solonumeros(event)}" type="text" style="font:tahoma; font-size:9px; width:30px;" value="<?=$remitente ?>" />
      ...
      <tr>
        ...
        <td colspan="4"><table width="609" border="0" cellspacing="0" cellpadding="0">
        ...
        <table border="0" cellpadding="0" cellspacing="0" id="tablaconteva"></table></td>
            ...
            <td width="173"><table width="177" border="0" cellpadding="0" cellspacing="0" bordercolor="#016193">
              ...
              <tr>
                ...
                <td><table width="163" height="0" align="center" bordercolor="#016193">
                  ...
                  <table width="176" height="0" border="0" cellpadding="0" cellspacing="0" bordercolor="#016193">
      ...
      <tr>
        ...
        <td colspan="4" align="center"><table width="621" border="0" cellspacing="0" cellpadding="0">

          <tr>

            <td width="331" height="19"><table width="322" border="0" cellpadding="0" cellspacing="0">

              <tr>

                <td width="67" class="Tablas">T. Paquetes: </td>

                <td width="40" class="Tablas"><input name="totalpaquetes" type="text" readonly="true" style="background:#FFFF99;font:tahoma; font-size:9px; width:40px" value="<?=$rcp ?>"/></td>

                <td width="56" class="Tablas">T. Peso Kg: </td>

                <td width="42" class="Tablas"><input name="totalpeso" type="text" readonly="true" style="background:#FFFF99;font:tahoma; font-size:9px; width:40px" value="<?=$rcp ?>" /></td>

                <td width="62" class="Tablas">T. Volumen: </td>

                <td width="55" class="Tablas"><input name="totalvolumen" type="text" readonly="true" style="background:#FFFF99;font:tahoma; font-size:9px; width:55px" value="<?=$rcp ?>" /></td>

              </tr>

            </table></td>

            <td width="290" bgcolor="#74B051"><span class="Estilo5">Totales</span>
                ...
                <input type="hidden" name="desrrecoleccion" />                <input type="hidden" name="desporcobrar" />            </td>
...
<tr>
        ...
        <td width="330" class="FondoTabla Estilo4">Servicios</td>

        <td width="3">&nbsp;</td>

        <td colspan="2" bgcolor="#74B051">&nbsp;</td>

    </tr>

      <tr>

        <td rowspan="2" align="left" valign="top"><table width="99%" height="76" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
              ...
              <td><input name="chkvalordeclarado" type="checkbox" style="width:8px; height:8px" value="SI"
               ...
               onclick="if(!this.checked){document.all.txtdeclarado.value='';document.all.txtdeclarado.readOnly=true; document.all.txtdeclarado.style.backgroundColor='#FFFF99'; document.all.txtdeclarado.readOnly=true;}else{document.all.txtdeclarado.readOnly=false; document.all.txtdeclarado.style.backgroundColor='#FFFFFF'; document.all.txtdeclarado.readOnly=false;document.all.txtdeclarado.focus();} if(valCon.validarServiciosNoCobro(0, 'VALOR DECLARADO')){u.t_txtead.value = '$ 0.00';} calculartotales();" /></td>
        ...
        <td colspan="2" align="left"><table width="290" height="116" border="1" cellpadding="0" cellspacing="0" bordercolor="#74B051">

          <tr>

            <td height="114"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#74B051">

              <tr>

                <td class="Tablas">&nbsp;&nbsp;Flete:</td>

                <td width="38%" class="Tablas"><input name="flete" readonly="true" type="text" style="background:#FFFF99; width:70px; font:tahoma; font-size:9px; text-align:right" value="<?=$rrfc ?>" /></td>

                <td class="Tablas">Excedente:</td>

                <td class="Tablas"><input name="t_txtexcedente" id="t_txtexcedente" readonly="true" type="text" style="background:#FFFF99; width:70px;font:tahoma; font-size:9px; text-align:right" value="<?=$rrfc ?>" /></td>
              ...
              <tr>
                ...
                <td class="Tablas"><input name="t_txtcombustible" readonly="true" type="text" style="background:#FFFF99;font:tahoma; width:70px; font-size:9px; text-align:right" value="<?=$rrfc ?>" /></td>
              ...
              <tr>
                ...
                <td class="Tablas"><input readonly="true" name="t_txtead" type="text" style="background:#FFFF99; width:70px;font:tahoma; font-size:9px; text-align:right" value="<?=$rrfc ?>" size="10" />
                ...
                <td class="Tablas"><input name="t_txtsubtotal" readonly="true" type="text" style="background:#FFFF99;font:tahoma; width:70px; font-size:9px; text-align:right" value="<?=$rrfc ?>" /></td>
              ...
              <tr>
                ...
                <td class="Tablas"><input readonly="true" name="t_txtrecoleccion" type="text" style="background:#FFFF99;font:tahoma; width:70px; font-size:9px; text-align:right" value="<?=$rrfc ?>" size="10" />

                    <input name="t_txtrecoleccionh" type="hidden" /></td>

                <td class="Tablas">IVA:</td>

                <td class="Tablas"><input name="t_txtiva" readonly="true" type="text" style="background:#FFFF99;font:tahoma; width:70px; font-size:9px; text-align:right" value="<?=$rrfc ?>" /></td>
              ...
              <tr>
                ...
                <td class="Tablas"><input readonly="true" id="t_txtseguro" name="t_txtseguro" type="text" style="background:#FFFF99; width:70px;font:tahoma; font-size:9px; text-align:right" value="<?=$rrfc ?>" /></td>

                <td width="23%" class="Tablas">IVA Retenido: </td>

                <td width="15%" class="Tablas"><input name="t_txtivaretenido" readonly="true" type="text" style="background:#FFFF99;font:tahoma; font-size:9px; text-align:right; width:70px;" value="<?=$rrfc ?>" /></td>

              </tr>

              <tr>

                <td height="16" class="Tablas">&nbsp;&nbsp;Otros:</td>

                <td class="Tablas"><input name="t_txtotros" readonly="true" type="text" style="background:#FFFF99;font:tahoma; width:70px; font-size:9px; text-align:right" value="<?=$rrfc ?>" /></td>

                <td class="Tablas">Total:</td>

                <td class="Tablas"><input name="t_txttotal" readonly="true" type="text" style="background:#FFFF99;font:tahoma; width:70px; font-size:9px; text-align:right" value="<?=$rrfc ?>" /></td>
      ...
      <tr>
        ...
        <td height="11" colspan="2" align="left"><span class="Tablas">
      ...
      <tr>
        ...
        <td colspan="4"><table width="616" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td width="211" class="Tablas"><input type="text" name="recibio" readonly="true" style="background:#FFFF99;width:200px; font-size:9px" /></td>

            <td width="75" class="Tablas">Fecha Entrega</td>

            <td width="122" class="Tablas"><input type="text" name="fechaentrega" readonly="true" style="background:#FFFF99;width:110px; font-size:9px" /></td>

            <td width="38" class="Tablas">Factura</td>

            <td width="120" class="Tablas"><input type="text" name="factura" readonly="true" style="background:#FFFF99;width:110px; font-size:9px" /></td>
