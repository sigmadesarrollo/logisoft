...
<script>
	...
	function limpiarDatos(){
		...
		consultaTexto("ponerId","repartoMercanciaEad_con.php?accion=12");
	}
	...
	function obtenerInicio(){
		consultaTexto("mostrarInicio", "repartoMercanciaEad_con.php?accion=12&and="+Math.random());
	}
	...
	function obtenerConductorBusqueda(idconductor,valor){
		...
		consultaTexto(respuesta,"repartoMercanciaEad_con.php?accion=1&idempleado="+idconductor+"&and="+Math.random());
	}
	...
	function obtenerGuiaIzq(){
		...
		if(tabla1.getValSelFromField('guia','No_GUIA')!=""){
			consultaTexto("mostrarDatosGuiaIzq","repartoMercanciaEad_con.php?accion=3&folioguia="+tabla1.getValSelFromField('guia','No_GUIA')+"&cosA="+Math.random());
		}else{
			tabla2.clear();
		}
	}
	function obtenerGuiaDer(){
		...
		if(tabla3.getValSelFromField('guia','No_GUIA')!=""){
			consultaTexto("mostrarDatosGuiaDer","repartoMercanciaEad_con.php?accion=4&folioguia="+tabla3.getValSelFromField('guia','No_GUIA')+"&cosA="+Math.random());
	...
	function pedirGuiasSector(valor){
		consultaTexto("mostrarGuiasSector","repartoMercanciaEad_con.php?accion=2&sector="+valor+"&and="+Math.random());
	...
	function guardarValores(){
		...
		if(tabla3.getRecordCount()>0 && u.guardado.value == 0){
			consultaTexto("resValidar","repartoMercanciaEad_con.php?accion=9&mathrand="+Math.random());
		}else{
	...
	function guardarFinal(){
		...
		consultaTexto("resGuardar","repartoMercanciaEad_con.php?accion=10&unidad="+unidad
	...
	function moverAlaDerecha(){
		if(tabla1.getRecordCount()==""){
			...
			if(tabla1.getSelectedIdRow()!=""){
				document.getElementById('moverderecha').style.visibility = 'hidden';
				consultaTexto("resMovADerC","repartoMercanciaEad_con.php?accion=5&folio="+tabla1.getSelectedRow().guia);
			}else{
	...
	function resMovADerC(datos){
		...
		document.getElementById('moverderecha').style.visibility = 'visible';
	}
	...
	function moverAlaizquierda(){
		if(tabla3.getRecordCount()==""){
			...
			if(tabla3.getSelectedIdRow()!=""){
				consultaTexto("resMovAIzqC","repartoMercanciaEad_con.php?accion=7&folio="+tabla3.getSelectedRow().guia);
			}else{
				alerta3('Debe seleccionar la fila que desea mover a la derecha','¡Atención!');	
			}
			
			/*else if(tabla4.getSelectedIdRow()!=""){
				consultaTexto("resMovAIzqU","repartoMercanciaEad_con.php?accion=8&folio="+tabla4.getSelectedRow().guia
...
/********************/
	function obtenerFolioManual(valor){
		consultaTexto("showObtenerFolioManual","repartoMercanciaEad_con.php?accion=11&folio="+valor);
	}
  ...
  <tr>
    <td><table width="620" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td colspan="4"><span class="Tablas"><img id="buscar1" src="../img/Buscar_24.gif" width="24" height="23" align="absbottom" onClick="abrirVentanaFija('../buscadores_generales/buscarConductor.php?caja=1', 600, 500, 'ventana', 'Busqueda')" style="cursor:pointer"></span><span class="Tablas">
      ...
      <tr>
        ...
        <td colspan="4"><span class="Tablas"><img id="buscar2" src="../img/Buscar_24.gif" width="24" height="23" align="absbottom" onClick="abrirVentanaFija('../buscadores_generales/buscarConductor.php?caja=2', 600, 500, 'ventana', 'Busqueda')" style="cursor:pointer">
