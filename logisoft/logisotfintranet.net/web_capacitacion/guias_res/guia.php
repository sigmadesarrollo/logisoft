...
CODEBASE="http://www.pmmentuempresa.com/web/activexs/Impresion.CAB#version=1,1,0,0">
</OBJECT>
<script>
	...
	function obtenerMecanciaConvenio(datos){
		...
		if(valCon.getValorDeclarado(u.lstflete.value)!=null){
			...
			u.pc_porcada.value 		= (vdec.porcada!=null)?vdec.porcada:u.pc_porcadah.value;
			u.pc_costo.value 		= (vdec.costo!=null)?vdec.costo:u.pc_costoh.value;
			u.pc_vdcostoextra.value = (vdec.costoextra!=null)?vdec.costoextra:u.pc_vdcostoextrah.value;
			u.pc_vdlimite.value 	= (vdec.limite!=null)?vdec.limite:u.pc_vdlimiteh.value;
		}else{
      ...
      <tr>
        <td colspan="2" ><table width="618" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="16%"><input type="text" name="destino" readonly="true" id="destino" style="background:#d9e6f0;width:100px; font-size:9px" >
                  <input type="hidden" name="destino_hidden">
                  <input type="hidden" name="npobdes">              </td>
              <td width="10%"><span class="Tablas">Suc. Destino:</span></td>
              <td width="13%"><input name="sucdestino" type="text" id="sucdestino" style="background:#d9e6f0;font:tahoma; font-size:9px" readonly value="<?=$destino?>" poblacion="" size="20" />
