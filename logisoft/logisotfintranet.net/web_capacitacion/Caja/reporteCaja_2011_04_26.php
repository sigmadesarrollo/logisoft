 ...
 <Worksheet ss:Name="Hoja1">
  <Table ss:ExpandedColumnCount="8" ss:ExpandedRowCount="51" x:FullColumns="1"
   ...
   <Row>
    ...
    <Cell ss:Index="6"><Data ss:Type="Number">'.$f->guiaspagadocontado.'</Data></Cell>
   ...
   <Row>
    ...
    <Cell ss:Index="6"><Data ss:Type="Number">'.$f->guiaspagadocredito.'</Data></Cell>
   ...
   <Row>
    ...
    <Cell ss:Index="6"><Data ss:Type="Number">'.$f->guiasporcobrarcontado.'</Data></Cell>
   ...
   <Row>
    ...
    <Cell ss:Index="6"><Data ss:Type="Number">'.$f->guiasporcobrarcredito.'</Data></Cell>
   ...
   <Row>
    ...
    <Cell ss:Index="6"><Data ss:Type="Number">'.$f->facturasguiasprepagadascontado.'</Data></Cell>
   ...
   <Row>
    ...
    <Cell ss:Index="6"><Data ss:Type="Number">'.$f->facturasguiasprepagadascredito.'</Data></Cell>
   ...
   <Row>
    ...
    <Cell ss:Index="6"><Data ss:Type="Number">'.$f->factguiasconsignacioncontado.'</Data></Cell>
   ...
   <Row>
    ...
    <Cell ss:Index="6"><Data ss:Type="Number">'.$f->factguiasconsignacioncredito.'</Data></Cell>
   ...
   <Row>
    ...
    <Cell ss:Index="6"><Data ss:Type="Number">'.$f->facturassobrepesocontado.'</Data></Cell>
   ...
   <Row>
    ...
    <Cell ss:Index="6"><Data ss:Type="Number">'.$f->facturassobrepesocredito.'</Data></Cell>
   ...
   <Row>
    ...
    <Cell ss:Index="6"><Data ss:Type="Number">'.$f->valordeclaradocontado.'</Data></Cell>
   ...
   <Row>
    ...
    <Cell ss:Index="6"><Data ss:Type="Number">'.$f->valordeclaradocredito.'</Data></Cell>
   ...
   <Row>
    ...
    <Cell ss:Index="6"><Data ss:Type="Number">'.$f->facturacionotrosconceptoscontado.'</Data></Cell>
   ...
   <Row>
    ...
    <Cell ss:Index="6"><Data ss:Type="Number">'.$f->facturacionotrosconceptoscredito.'</Data></Cell>
   ...
   <Row ss:Index="24">
    ...
    <Cell ss:Index="6" ss:Formula="=SUM(R[-16]C:R[-2]C)"><Data ss:Type="Number">0</Data></Cell>
   ...
   <Row>
    ...
    <Cell ss:Index="6"><Data ss:Type="Number">'.$f->guiascobrarcontadoentregadas.'</Data></Cell>
   ...
   <Row>
    ...
    <Cell ss:Index="6"><Data ss:Type="Number">'.$f->guiascobrarcreditoentregadas.'</Data></Cell>
   ...
   <Row>
    ...
    <Cell ss:Index="6"><Data ss:Type="Number">'.$f->guiaspagadascontadoentregas.'</Data></Cell>
   ...
   <Row>
    ...
    <Cell ss:Index="6"><Data ss:Type="Number">'.$f->guiaspagadascreditoentregas.'</Data></Cell>
    <Cell><Data ss:Type="Number">'.$f->registrosguiaspagadascreditoentregas.'</Data></Cell>
   </Row>
   <Row ss:Index="32">
    <Cell ss:StyleID="s24"><Data ss:Type="String">TOTALES:</Data></Cell>
    <Cell ss:Index="6" ss:Formula="=SUM(R[-5]C:R[-2]C)"><Data ss:Type="Number">0</Data></Cell>
   ...
   <Row>
    ...
    <Cell ss:Index="6"><Data ss:Type="Number">'.$f->cobranza.'</Data></Cell>
   ...
   <Row ss:Index="45">
    <Cell ss:StyleID="s24"><Data ss:Type="String">TOTALES:</Data></Cell>
    <Cell ss:Index="6" ss:Formula="=SUM(R[-10]C:R[-2]C)"><Data ss:Type="Number">0</Data></Cell>
   ...
   <Row ss:Index="47">
    ...
    <Cell ss:Index="6"><Data ss:Type="Number">'.$f->guiascanceladas.'</Data></Cell>
   ...
   <Row>
    ...
    <Cell ss:Index="6"><Data ss:Type="Number">'.$f->facturascanceladas.'</Data></Cell>
   ...
   <Row>
    ...
    <Cell ss:Index="6"><Data ss:Type="Number">'.$f->guiasautorizacioncancelar.'</Data></Cell>
    <Cell><Data ss:Type="Number">'.$f->registrosguiasautorizacioncancelar.'</Data></Cell>
   </Row>
   <Row ss:Index="51">
    <Cell ss:StyleID="s24"><Data ss:Type="String">TOTALES:</Data></Cell>
    <Cell ss:Index="6" ss:Formula="=SUM(R[-4]C:R[-2]C)"><Data ss:Type="Number">0</Data></Cell>
