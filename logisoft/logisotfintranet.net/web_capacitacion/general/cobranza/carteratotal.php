...
<form id="form1" name="form1" method="post" action="">
  <table width="716" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td><table width="674" height="15" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="3">&nbsp;</td>
            <td width="566"><div align="right">Total</div></td>
            <td width="105" align="center"><span class="style31">
