function alerta2(mensaje, titulo,caja) {	
	...
	var styleMensaje = 'font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 10px; color: #000000; height: ' + (alto - 150) + 'px; vertical-align: center;';
	...
	+ '<img src="' + src + 'aceptar.gif" alt="Aceptar" title="Aceptar" style="cursor: pointer;" onclick="document.form1.' + caja + '.focus();VentanaModal.cerrar()">'
	+ '</td></tr></table>'
