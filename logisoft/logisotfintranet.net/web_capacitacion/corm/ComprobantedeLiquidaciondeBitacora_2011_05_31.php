		...
		if(u.afavorencontra.value=="0"){//ENCONTRA
			if(parseFloat(u.totalentregar.value)==0){
				...
				for(var i=0;i<tabla1.getRecordCount();i++){
					can = u["tabladetalle_CANTIDAD"][i].value.replace("$ ","").replace(/,/g,"") + can;
...
<table width="550" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
 ...
 class="Tablas" id="folio" style="width:100px; background:#FF9" value="<?=$folio ?>" readonly="readonly"></td>
        ...
        <tr>
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="10%"><input name="foliobitacora" type="text" class="Tablas"
 id="foliobitacora" style="width:100px" onKeyPress="" onKeyDown="if(event.keyCode=='13'){obtener(this.value);};return tabular(event,this)" value="<?=$foliobitacora ?>" ></td>
              <td><div class="ebtn_buscar" onClick="abrirVentanaFija('buscarBitacora_ComprobantedeliquidaciondeBitacora.php', 550, 450, 'ventana', 'Busqueda')"></div></td>
              <td>Unidad<br></td>
              <td><input name="unidad" type="text" class="Tablas"
 id="unidad" style="width:100px; background:#FF9" onKeyDown="return tabular(event,this)" value="<?=$unidad ?>" readonly="readonly" ></td>
              <td>Gastos<br></td>
              <td><input name="gastos2" type="text" class="Tablas"
 id="gastos2" style="width:100px; background:#FF9" onKeyDown="return tabular(event,this)" value="<?=$gastos2 ?>" readonly="readonly"  ></td>
            </tr>
          </table></td>
          </tr>
        <tr>
          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td style="width:115px">Folio Pre- Liquidaci&oacute;n<br></td>
              <td style="width:200px"><input name="foliopre" type="text" class="Tablas"
 id="foliopre" style="width:180px; background:#FF9" onKeyDown="return tabular(event,this)" value="<?=$foliopre ?>" readonly="readonly" ></td>
              <td>Cantidad</td>
              <td><input name="cantidadpre2" type="text" class="Tablas"
 id="cantidadpre2" style="width:150px; background:#FF9" onKeyDown="return tabular(event,this)" value="<?=$cantidadpre2 ?>" readonly="readonly"  ></td>
            </tr>
          </table></td>
        </tr>
        <tr>
 ...
 id="conductor" style="width:440px; background:#FF9" onKeyDown="return tabular(event,this)" value="<?=$conductor ?>" readonly="readonly"  ></td>
            </tr>
          </table></td>
        </tr>
        <tr>
            ...
            <tr>
              ...
              <td style="width:285px" ><label>
                <select name="concepto" id="concepto" class="Tablas" style="width:200px">
                  <option value=""></option>
				  <? 
				  	$con=mysql_query("select id,descripcion from catalogogastos_liquidacionbitacora",$link); 
              ...
              <td >Cantidad<br></td>
              <td><input name="cantidad" type="text" class="Tablas"
 id="cantidad" style="width:100px"  ></td>
            </tr>
          </table></td>
          </tr>
        <tr>
