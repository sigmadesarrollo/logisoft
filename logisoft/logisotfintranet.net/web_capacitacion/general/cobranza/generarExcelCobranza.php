...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <Worksheet ss:Name="Hoja1">';
	...
	if($_GET[accion]==1){//REPORTE PRINCIPAL
		...
		".(($_GET[sucursal]==1)?"":" AND pg.sucursalacobrar = $_GET[sucursal]")." GROUP BY pg.sucursalacobrar
		UNION
		...
		FROM tmp_clientes$x temp INNER JOIN catalogosucursal cs ON temp.sucursal=cs.id 	$suc  GROUP BY temp.sucursal
