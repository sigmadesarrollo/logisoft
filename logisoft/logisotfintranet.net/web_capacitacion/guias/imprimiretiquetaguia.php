...
<table width="495" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="228" height="150" valign="top"><table width="228" border="0" cellpadding="0" cellspacing="0" class="texto_normal4">
          ...
          <table width="228" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="153" class="texto_normal5"><?=$fx->eti_nombre1?>
                ...
                <?=$fx->eti_nombre2?>
                <br />
                <?=substr($fx->eti_direccion,0,19)?><br />
                <?=substr($fx->eti_direccion,19,30)?>
                <br />
                <?=$fx->eti_colonia?>
                <br />
                <?=$fx->eti_ciudad?>
      ...
      <tr>
        <td>
          <div style="overflow:hidden; width:225px; height:11px">CTE: <?=$f->idremitente?> &nbsp;&nbsp;&nbsp;&nbsp;RFC: <?=$f->rfc1?></div></td>
      </tr>
      <tr>
      ...
      <tr>
        <td><div  style="overflow:hidden; width:225px; height:11px">CTE:
          <?=$f->iddestinatario?> &nbsp;&nbsp;&nbsp;&nbsp;RFC: <?=$f->rfc2?></div></td>
      </tr>
      <tr>
        <td><div  style="overflow:hidden; width:225px; height:11px">CALLE:
          <?=$f->dcalle?>
  ...
  <tr>
    <td height="19" colspan="2" valign="middle" class="texto_normal5" align="center"> 
        ...
        <tr>
        	<td width="389"><? if($f->valordeclarado=="0"){?>*Este envio viaja a cuenta y riesgo del remitente por no declarar valor &nbsp;&nbsp;&nbsp;&nbsp; <? } ?></td>
        	<td width="79"><strong class="texto_bold3">Cliente</strong></td>
        </tr>
        </table>
    </td>
  </tr>
...
<table width="495" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="228" height="150" valign="top"><table width="228" border="0" cellpadding="0" cellspacing="0" class="texto_normal4">
      ...
      <tr>
        <td><div  style="overflow:hidden; width:225px; height:11px">CTE:
          <?=$f->idremitente?> &nbsp;&nbsp;&nbsp;&nbsp;RFC: <?=$f->rfc1?></div></td>
      </tr>
      <tr>
        <td><div  style="overflow:hidden; width:225px; height:11px">CALLE:
          <?=$f->rcalle?>
