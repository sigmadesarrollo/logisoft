...
<script>
	...
	function obtenerDetalle(){
		...
		consultaTexto("resTabla5","reportes_con.php?accion=1&cliente="+u.cliente.value+"&contador="+u.pag5_contador.value+"&sucursal="+u.sucursal_hidden.value+"&val="+Math.random());
	}
	...
	function paginacion5(movimiento){
		switch(movimiento){
			case 'primero':
					consultaTexto("resTabla5","reportes_con.php?accion=1&cliente="+u.cliente.value+"&contador=0&val="+Math.random());
				break;
			case 'adelante':
				if(u.pag5_adelante.value==1){
					consultaTexto("resTabla5","reportes_con.php?accion=1&cliente="+u.cliente.value+"&contador="+(parseFloat(u.pag5_contador.value)+1)+"&val="+Math.random());
				}
				break;
			case 'atras':
			...
			case 'ultimo':
				...
				consultaTexto("resTabla5","reportes_con.php?accion=1&cliente="+u.cliente.value+"&contador="+contador+"&val="+Math.random());
				break;
		}
	}
        	...
        	<td>
                <table border="0" cellpadding="0" cellspacing="0">
                  ...
                  <img src="../img/Buscar_24.gif" id="imagenBuscarSucursal" width="24" height="23" align="absbottom" style="cursor:pointer; display:none" onclick="abrirVentanaFija('../buscadores_generales/buscarsucursal.php', 600, 450, 'ventana', 'Busqueda');" /> </td>
                        <td width="102"><div class="ebtn_Generar" onclick="obtenerDetalle()" ></div></td>
                    </tr>
                </table>
            </td>
        </tr>
