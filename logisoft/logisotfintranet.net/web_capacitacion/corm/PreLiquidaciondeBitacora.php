        ...
        <tr>
          <td colspan="2" align="right"><table width="60%" height="18" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="33%"><input name="folio" type="text" class="Tablas" id="folio" style="width:100px;" value="<?=$folio ?>" 
			  onkeypress="if(event.keyCode=='13'){OptenerFolioPreliberacion(this.value);}" ></td>
              <td width="7%"><div class="ebtn_buscar" 
			  onClick="abrirVentanaFija('../buscadores_generales/buscarPreliberaciondeGastosGen.php?funcion=OptenerFolioPreliberacion', 550, 450, 'ventana', 'Busqueda')" ></div></td>
