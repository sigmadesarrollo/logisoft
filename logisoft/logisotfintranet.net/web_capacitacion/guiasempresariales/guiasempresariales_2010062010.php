...
<script>
	...
	var botonesnuevo = '<img src="../img/Boton_Guardar.gif" style="cursor:hand" onClick="if(validarDatos() && valcreditodisponible()){if(u.tipopago.value==\'CONTADO\'){mostrarformapago();}else{ejecutarSubmit();}};">&nbsp;&nbsp;<img src="../img/Boton_Nuevo.gif" style="cursor:hand" onClick="limpiar_evaluacion();limpiar_destinatario();limpiar_remitente();">';
	var botonesdesguardar = '<img src="../img/Boton_Imprimir.gif" onclick="imprimir()">&nbsp;&nbsp;<img src="../img/Boton_Nuevo.gif" style="cursor:hand" onClick="limpiar_evaluacion();limpiar_destinatario();limpiar_remitente();">';
	var botonesconsulta = '<img src="../img/Boton_Imprimir.gif" onclick="imprimir()">&nbsp;<img src="../img/Boton_Liberar.gif" style="cursor:hand" onClick="cancelarGuia()">&nbsp;<img src="../img/Boton_Nuevo.gif" style="cursor:hand" onClick="limpiar_evaluacion();limpiar_destinatario();limpiar_remitente();bloquear(false);">';
	...
	function imprimir(){
		...
		if(document.all.estado.innerHTML=='ENTREGADA'){
			...
			?>
			window.open("../guias/imprimiretiquetaguia.php?tipo=2&codigo="+document.all.folioSeleccionado.innerHTML,"1","width=500,height=500");
		}
	}
	function cambiarImpresora1(){
		...
		?>
		window.open("../guias/imprimiretiquetapaquete.php?tipo=2&codigo="+document.all.folioSeleccionado.innerHTML,"2","width=500,height=500");
	}
	...
	function pedirDatosEvaluacion(idevaluacion){
		if('<?=$_SESSION[IDSUCURSAL]?>'!=""){
			...
			consulta("devolverDatosEvaluacion", "../guiasempresariales/guiasempresariales_consulta.php?accion=1&folio="+idevaluacion+"&idsucorigen="+sucursalorigen+"&valrandom="+Math.random());
		}else{
	...
	function mostrarDestinatario(datos){
		...
		if(encon>0){
			...
			if(endir==1){
				...
				document.all.celda_des_calle.innerHTML ='<input name="des_calle" readonly="true" type="text" style="width:170px" class="textoSB"/><input type="hidden" name="des_direcciones">';
...
<div class="content" style="width:830px">
      ...
      <table width="254">
        <tbody>
          ...
          <tr>
            ...
            <th><select name="tipopago" id="tipopago" class="text">
  ...
  <div class="extra-data">
    <ul>
      ...
      Empaque: <strong style="width:60px;">
