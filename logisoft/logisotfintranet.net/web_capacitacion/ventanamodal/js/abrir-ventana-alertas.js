...
function info(mensaje, titulo) {
	...
	var styleTitulo = 'font-family: Arial, Verdana, Helvetica, sans-serif; font-size: 12px; font-weight: bold; color: #000000;';
	var styleMensaje = 'font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 10px; color: #000000; height: ' + (alto - 150) + 'px; vertical-align: top; text-align: left;';
