...
<script>
	...
	function mostrarCliente(datos){
		...
		if(objeto[0].datoscliente[0].id!=undefined){
			...
			u.comboSucursal.value = objeto[0].datoscliente[0].sucursal;
			u.comboSucursal.disabled= true;
	...
	function mostrarSolicitud(datos){
		...
		u.comboSucursal.value = objeto.datoscliente.sucursal;
		u.comboSucursal.disabled= true;
		...
		bloquearTodo(true);
		if(objeto.datoscliente.prepagada=="SI" && (objeto.datoscliente.foliofactura==0 || objeto.datoscliente.foliofactura=="")){
			u.lstpago.disabled = false;
		}
	...
	function imprimirSolicitud(){
		if(document.URL.indexOf("web/")>-1){		
				window.open("http://www.pmmintranet.net/web/fpdf/reportes/acuseRecibo.php?sucursal=<?=$_SESSION[IDSUCURSAL]?>&venta="+u.folio.value);
			
		}else if(document.URL.indexOf("web_capacitacion/")>-1){
			window.open("http://www.pmmintranet.net/web_capacitacion/fpdf/reportes/acuseRecibo.php?sucursal=<?=$_SESSION[IDSUCURSAL]?>&venta="+u.folio.value);
			
		}else if(document.URL.indexOf("web_pruebas/")>-1){
			window.open("http://www.pmmintranet.net/web_pruebas/fpdf/reportes/acuseRecibo.php?sucursal=<?=$_SESSION[IDSUCURSAL]?>&venta="+u.folio.value);
			}
	}
          ...
          <tr>
            ...
            <table width="225" border="0" cellpadding="0" cellspacing="0">
            	...
            	<tr>
            	  ...
            	  <td>
                  	<select name="comboSucursal" style="width:120px">
