...
<script>
	...
	function Validar(){
		if(u.ncliente.value==""){
			alerta("Capture #Cliente","¡Atencion!","ncliente");
			return false;
			...
			alerta("Capture la cantidad","¡Atencion!","cantidad");
			return false;
		}
	...
	function mostrarResult(datos){
		if(datos.indexOf("1")>-1){
			...
			u.Guardar.className="ebtn_cancelar";
			u.Guardar.onclick =Cancelar;
		}
	}
	...
	function Limpiar(){
		...
		u.preocon[1].disabled=true;
		u.cantidad.disabled=false;
		u.Guardar.className="ebtn_guardar";
		u.Guardar.onclick =Validar;
...
<form id="form1" name="form1" method="post" action="">
  <table width="500" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
    ...
    <tr>
      <td><table width="500" border="0" cellpadding="0" cellspacing="0" class="Tablas">
          <tr>
            <td><table width="500" border="0" cellpadding="0" cellspacing="0" class="Tablas">
                <tr>
                  <td width="9%">Folio:</td>
                  <td width="11%"><input name="folio" class="Tablas" type="text" id="folio" style="width:50px;background:#FFFF99" readonly="" /></td>
                  <td width="53%"><div class="ebtn_buscar" onclick="abrirVentanaFija('../buscadores_generales/BuscarSolicitudGuasEmpresariales_Gen_New.php?funcion=obtenerSolicitud&con=1', 625, 430, 'ventana', 'Buscar Solicitud')"></div></td>
                  <td width="8%">Fecha:</td>
                  <td width="19%"><input name="fecha" class="Tablas" type="text" id="fecha" style="background:#FFFF99; width:80px"/></td>
                </tr>
            </table></td>
          </tr>
          <tr>
          ...
          <tr>
            <td><table width="500" height="12" border="0" cellpadding="0" cellspacing="0" class="Tablas">
              <tr>
                <td width="11%"><span style="width:70px"># Cliente:</span></td>
                <td width="15%"><input name="ncliente" class="Tablas" type="text" id="ncliente" style="width:70px"  onkeypress="if(event.keyCode==13){pedirCliente(this.value);}"/></td>
                <td width="8%"><div id="btncliente" class="ebtn_buscar" onclick="abrirVentanaFija('../buscadores_generales/buscarClienteGen.php?funcion=pedirCliente', 625, 430, 'ventana', 'Buscar Cliente')"></div></td>
                <td width="10%"><span style="width:70px">Nombre:</span></td>
                <td width="56%"><input name="nombre" class="Tablas" type="text" id="nombre" style="width:260px;background:#FFFF99"  readonly=""/></td>
              </tr>
            </table></td>
          </tr>
          <tr>
            <td><table width="500" border="0" cellpadding="0" cellspacing="2" class="Tablas">
              <tr>
                <td width="67">Ap. Paterno:</td>
                <td colspan="2"><input name="paterno" class="Tablas" type="text" id="paterno" style="width:150px;background:#FFFF99" readonly=""/></td>
                <td width="70">Ap. Materno:</td>
                <td width="169"><input name="materno" class="Tablas" type="text" id="materno" style="width:150px;background:#FFFF99" readonly=""/></td>
              </tr>
            </table></td>
          </tr>
          <tr>
          ...
          <tr>
            <td><table width="500" border="0" cellpadding="0" cellspacing="2" class="Tablas">
              <tr>
                <td colspan="2"><input name="preocon" type="radio" value="1"  />
                  Pre-Pagadas
              ...
              <tr>
                ...
                <td width="91%"><input name="cantidad" class="Tablas" type="text" id="cantidad" />
                  <label>
          ...
          <tr>
            <td class="Tablas"><table width="234" border="0" align="right" cellpadding="0" cellspacing="2">
              <tr>
                <td width="64" ><div id="btnAutorizar" class="ebtn_autorizar" onclick="confirmar('¿Desea realizar la asignacion de guias empresariales?','¡Atencion!','AbrirAsignacionGuiasEmp()','Autorizar()')" style="visibility:hidden"></div></td>
                <td width="64" ><div id="Guardar" class="ebtn_guardar" onclick="Validar()"></div></td>
                <td width="70"><div class="ebtn_nuevo" onclick="Limpiar()"></div></td>
              </tr>
            </table></td>
          </tr>
      </table></td>
