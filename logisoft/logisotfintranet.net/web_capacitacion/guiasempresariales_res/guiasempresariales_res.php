...
<script>
	...
	var botonesnuevo = '<img src="../img/Boton_Guardar.gif" style="cursor:hand" onClick="if(validarDatos()){ejecutarSubmit();};">&nbsp;&nbsp;<img src="../img/Boton_Nuevo.gif" style="cursor:hand" onClick="limpiar_evaluacion();limpiar_destinatario();limpiar_remitente();">';
	...
	var botonesconsulta = '<img src="../img/Boton_Imprimir.gif">&nbsp;<img src="../img/Boton_Cancela_Guia.gif" style="cursor:hand" onClick="cancelarGuia()">&nbsp;<img src="../img/Boton_Nuevo.gif" style="cursor:hand" onClick="limpiar_evaluacion();limpiar_destinatario();limpiar_remitente();bloquear(false);">';
	...
	function obtenerMecanciaConvenio(datos){
		...
		if(valCon.validarServiciosNoCobro(0, "E.A.D.")){
			u.t_txtead.value = "$ 0.00";
