    ...
    <tr>
      <td width="426"><table width="454" border="0" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="100"><input name="fechainicio" type="text" class="Tablas" id="fechainicio" style="width:100px" value="<?=$fecha ?>" /></td>
            <td width="32"><div class="ebtn_calendario" onClick="displayCalendar(document.all.fechainicio,'dd/mm/yyyy',this)"></div></td>
            <td width="15">Al:</td>
            <td width="100"><input name="fechafin" type="text" class="Tablas" id="fechafin" style="width:100px" value="<?=$fecha ?>" /></td>
