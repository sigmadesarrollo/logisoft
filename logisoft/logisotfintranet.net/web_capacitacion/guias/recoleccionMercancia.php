...
<script>
	...
	tabla1.setAttributes({
		...
		campos:[
			...
			{nombre:"CARTA PORTE", medida:60, alineacion:"left", datos:"cartaporte"},
	...
	function mostrarRecoleccion(datos){
		...
		for(var i=0;i<objeto.length;i++){
			...
			registro.cartaporte    = objeto[i].FolioCarta;
	...
	function verRecoleccion(){
		var obj = tabla1.getSelectedRow();
		if(obj.folio!=""){
			//document.location.href='cotizarguia.php?accion=&folio='+obj.folio+'&sucursal='+obj.sucursal+'&estado='+obj.estado;	
			parent.obtener(obj.folio, obj.sucursal,obj.cartaporte)
