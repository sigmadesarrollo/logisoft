            ...
            <tr>
              ...
              <th width="612" height="64" scope="row"><table width="608" height="75" border="0" cellspacing="0" class="Tablas">
                ...
                <tr>
                  ...
                  <td width="52" class="Tablas"><input name="NGuias" type="text" class="Tablas" id="NGuias" value="<?=$NGuias ?>" size="10" onKeyDown="return tabular(event,this)" onKeyPress="return Numeros(event)" onKeyUp="return habilitar(event,this.name)"> <? if($NRecoleccion!=""){echo"<script>HabilitarEmpresarial();</script>";} ?>
