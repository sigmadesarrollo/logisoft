...
<script>
	...
	tabla1.setAttributes({//PRINCIPAL
		...
		campos:[
			...
			{nombre:"ORIGEN", medida:115, alineacion:"center", datos:"origen"},
			{nombre:"DESTINO", medida:115, alineacion:"center", datos:"destino"},
	...
	function obtenerDetalle(){
		...
		consultaTexto("mostrarPrincipal","consultasAlertas.php?accion=32&fechainicio="+u.fechainicio.value
	...
	function paginacion1(movimiento){
		switch(movimiento){
			case 'primero':
				consultaTexto("mostrarPrincipal","consultasAlertas.php?accion=32&contador=0&fechainicio="+u.fechainicio.value
				+"&fechafin="+u.fechafin.value+"&sucursal="+u.sucursal_hidden.value+"&s="+Math.random());
				break;
			case 'adelante':
				if(u.pag1_adelante.value==1){
					consultaTexto("mostrarPrincipal","consultasAlertas.php?accion=32&contador="+(parseFloat(u.pag1_contador.value)+1)
			...
			case 'ultimo':
				...
				consultaTexto("mostrarPrincipal","consultasAlertas.php?accion=32&contador="+contador
				+"&fechainicio="+u.fechainicio.value+"&fechafin="+u.fechafin.value+"&sucursal="+u.sucursal_hidden.value+"&s="+Math.random());
				break;
		}
	}
...
<form id="form1" name="form1" method="post" action="">
  <table width="610" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
    <tr>
      <td class="FondoTabla">Historial de Guias Canceladas </td>
    </tr>
    <tr>
