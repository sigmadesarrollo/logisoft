...
<script>
	...
	function tiposMoneda(evnt,valor){
		...
		if (!elem.readOnly){
			...
			if (charCode > 31 && (charCode < 48 || charCode > 57 || charCode == 45) && charCode != 46 && charCode != 45) {
				return false;
			}else{
				if(charCode==46){
					if(caja.indexOf(".")>-1){
	...
	function calcularservicios(){
		...
		if(u.t_txteadh2.value=="0"){
			...
			if(u.txtrecoleccion.value!='' && u.t_txtrecoleccionh.value=="0"){
...
<td class="Tablas">Combustible:</td>
            ...
            <tr>
              ...
              <td class="Tablas"><input readonly="true" name="t_txtead" type="text" style="background:#FFFF99;font:tahoma; font-size:9px; text-align:right" value="<?=$rrfc ?>" size="10" /><input name="t_txteadh" type="hidden" /><input name="t_txteadh2" type="text" /></td>
