...
function respuestaLogin(datos){
	if(datos.indexOf("Ya inicio Sesion")>-1){
		...
		divC = document.getElementById("cuadroIconos");
...
<!--                  <ul> 
                ...
                <div style="float:right; width:50px; height:50px;" onclick="window.open('web_capacitacion/modulosextras/');">
                </div>
                <div id="menus1"></div>
        	</div>
            <div id="cuadroFotos">
               ...
               <div id="loginimg"></div>
                  <div id="logincontenido">
                       ...
                       <div id="mitexto">
                           ...
                           <img src="images/pmm-icons/textfield_key.png" />
                           Entrar</a>
                       </div>
                    </div>
                </div>
                <div id="cuadroIconos" style="display:none;">
                	<div id="filaiconos">
                	...
                	<!--<div id="icono" onclick="validarEntrada('TINSA EN SU EMPRESA')">-->
					<div id="icono" >
                    	<img src="images/pmm-icons/09pmm-en-tu-empresa.png" />

                		<div id="texto">TINSA en tu Empresa</div>
