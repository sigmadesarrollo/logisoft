	...
	if($_POST[accion]=="grabar"){
		for($i=0;$i<$_POST[registros];$i++){
			if($_POST["detalle_EXISTE"][$i]!="x"){
				$s = "INSERT INTO configuradorfoliosprecintos 
...
<script>
	...
	function obtenerDetalles(){
		consultaTexto("mostrarDetalle","configuradorFoliosPrecintos_con.php?accion=1");	
	}
...
<form name="form1" method="post" action="">
  <table width="360" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
    <tr>
      <td class="FondoTabla">CONFIGURADOR DE FOLIOS PRECINTOS</td>
    </tr>
    <tr>
