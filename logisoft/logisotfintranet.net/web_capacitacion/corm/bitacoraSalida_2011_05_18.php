...
<script>
	...
	var caja = datos.getElementsByTagName('caja').item(0).firstChild.data;
		...
		break;
			...
			alerta('El conductor no existe o ya fue asignado a una unidad','¡Atención!','conductor'+caja);
			switch(caja){
				case "1":
	...
	var con = datos.getElementsByTagName('encontro').item(0).firstChild.data;
		if(con>0){
			...
			alerta('La Ruta no existe','¡Atención!','ruta');
			u.ruta.value = "";
		}
	}
...
abrirVentanaFija('buscarRuta.php', 550, 450, 'ventana', 'Busqueda')
	...
	function validarLicencia(nombre){
		if(nombre=="licencia_conductor1" && u.conductor1.value ==""){
			...
			u.licencia_conductor2.checked = false;
			alerta('Debe Capturar conductor','¡Atención!','conductor2');
		}else if(nombre=="licencia_conductor3" && u.conductor3.value ==""){
			u.licencia_conductor3.checked = false;
			alerta('Debe Capturar conductor','¡Atención!','conductor3');
			...
			u.tarjeta_remolque1.checked = false;
			alerta('Debe Capturar remolque','¡Atención!','remolque1');
			...
			u.tarjeta_remolque2.checked = false;
			alerta('Debe Capturar remolque','¡Atención!','remolque2');
	...
	function confirmarCancelacion(datos){
		if(datos.indexOf("embarcada")>-1){
			alerta3("La bitacora de salida no se puede Cancelar por que ya fue utilizada en un Embarque","¡Atención!");
			return false;
		}
		if(datos.indexOf("guardo")>-1){			
			info('La bitacora ha sido cancelada correctamente', 'Operación realizada correctamente');
			u.btnImprimir.style.visibility = "hidden";
			u.d_guardar.style.visibility = "hidden";
			u.d_cancelar.style.visibility = "hidden";
		}else{
	...
	function imprimirBitacora(){
		...
		if(u.accion.value != ""){
			...
			alerta3("Debe guardar los datos para poder imprimir la bitacora de salida","¡Atención!");
		}
	}
</script>
<style type="text/css">
    ...
    <td><div align="center">
      <table width="490" border="0" cellpadding="0" cellspacing="0">
          ...
          <td colspan="6"><table width="448" border="0" align="right" cellpadding="0" cellspacing="0">
            <tr>
              <td width="448"><div align="right">Fecha:<span class="Tablas">
                <input name="fechabitacora" type="text" class="Tablas" id="fechabitacora" style="width:100px;background:#FFFF99; text-align:center" value="<?=$fecha ?>" readonly=""/>
                </span>Folio:<span class="Tablas">
                  <input name="folio" type="text" class="Tablas" id="folio" style="width:50px;background:#FFFF99; text-align:right" value="<?=$folio ?>" readonly=""/>
        ...
        <tr>
          ...
          <td width="32"><div class="ebtn_buscar" onClick="abrirVentanaFija('buscarConductor.php?caja=1', 600, 500, 'ventana', 'Busqueda')"></div></td>
...
PCD </td>
        ...
        <tr>
          ...
          <td width="160"><input name="tarjeta_remolque1" type="checkbox" id="tarjeta_remolque1" onKeyPress="return tabular(event,this)" value="1" checked="checked" <? if($tarjeta_remolque1==1){echo "checked";} ?>>
Tarjeta
...
PCD</td>
        ...
        <tr>
          ...
          <td>Precinto:</td>
          <td><span class="Tablas">
        <input name="precinto" type="text" class="Tablas" id="precinto" readonly="" style="width:70px; background-color:#FFFF99"/>
          ...
          <td colspan="2" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              <td width="43%" id="td_agregar"><img src="../img/Boton_Agregari.gif" width="70" height="20" id="d_agregar" align="absbottom" style="cursor:pointer" onclick="agregar()" /></td>
