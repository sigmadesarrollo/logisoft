	...
	if($_GET[accion]==1){//OBTENER UNIDAD
		...
		echo str_replace("null",'""',json_encode($registros));
			...
			if(mysql_num_rows($r)>0){
				...
				SELECT gvu.id, '', gvu.idguia, 'NORMAL', cs.descripcion, cs2.descripcion, gvu.codigobarras, 
				...
				$s = "INSERT INTO embarques_tmp
				SELECT geu.id, '', geu.idguia, 'EMPRESARIAL', cs.descripcion, cs2.descripcion, geu.codigobarras, 
				...
				INNER JOIN guiaventanilla_unidades gvu ON tmp.guia = gvu.idguia AND gvu.unidad = '$_GET[unidad]'
