...
var div_descripcion ='<table width="530" border="0"><tr><td>Precio por Caja/Paquete</td></tr>  <tr><td><div id="div_descripcion" style="width:535px; height:80px; overflow:auto" align="left"></div></td></tr></table>';var var_prepagadas = '<table width="530" border="0"><tr><td><table border="0" cellpadding="0" cellspacing="0" id="col_prepagadas"><tr><td width="78">Pre-Pagadas</td><td width="203" class="Tablas">Limite KG:<input name="limitekg" type="text" class="Tablas" id="limitekg" style="width:100px;background:#FFFF99; text-align:right" onkeypress="return solonumeros(event)" value="<?=$limitekg ?>" readonly="readonly" /></td><td width="40">Costo:</td><td width="205" class="Tablas"><input name="costoguia" type="text" class="Tablas" id="costoguia" style="width:100px;background:#FFFF99; text-align:right" value="<?=$Costo ?>" readonly="readonly"/></td></tr></table></td></tr></table>';var detallekgc ='<table width="530" border="0"><tr><td><table border="0" cellpadding="0" cellspacing="0" id="col_prepagadas"><tr><td width="78">Pre-Pagadas</td><td width="203" class="Tablas">Limite KG:<input name="limitekg" type="text" class="Tablas" id="limitekg" style="width:100px;background:#FFFF99; text-align:right" onkeypress="return solonumeros(event)" value="<?=$limitekg ?>" readonly="readonly" /></td><td width="40">Costo:</td><td width="205" class="Tablas"><input name="costoguia" type="text" class="Tablas" id="costoguia" style="width:100px;background:#FFFF99; text-align:right" value="<?=$Costo ?>" readonly="readonly"/></td></tr></table></td></tr><tr><td>Precio por KG</td></tr>  <tr><td><div id="detallekgc" style="width:535px; height:80px; overflow:auto" align="left"></div></td></tr></table>';var detalledescripcionc='<table width="530" border="0"><tr><td><table border="0" id="col_prepagadas" cellpadding="0" cellspacing="0"><tr><td width="78">Pre-Pagadas</td><td width="203" class="Tablas">Limite KG:<input name="limitekg" type="text" class="Tablas" style="width:100px;background:#FFFF99; text-align:right" onkeypress="return solonumeros(event)" value="<?=$limitekg ?>" readonly="readonly"></td><td width="40">Costo:</td><td width="205" class="Tablas"><input name="costoguia" type="text" class="Tablas" style="width:100px;background:#FFFF99; text-align:right" readonly="readonly" value="<?=$Costo ?>"/></td></tr>    </table></td></tr><tr><td>Precio por Caja/Paquete</td></tr>  <tr><td><div id="detalledescripcionc" name="detalle" style="width:535px; height:80px; overflow:auto" align="left"></div></td></tr></table>';var descuentocon='<table width="530" border="0" cellspacing="0" cellpadding="0"><tr><td><table border="0" cellpadding="0" cellspacing="0" id="col_prepagadas"><tr><td width="78">Pre-Pagadas</td><td width="203" class="Tablas">Limite KG:<input name="limitekg" type="text" class="Tablas" id="limitekg" style="width:100px;background:#FFFF99; text-align:right" onkeypress="return solonumeros(event)" value="<?=$limitekg ?>" readonly="readonly" /></td><td width="40">Costo:</td><td width="205" class="Tablas"><input name="costoguia" type="text" class="Tablas" id="costoguia" style="width:100px;background:#FFFF99; text-align:right" value="<?=$Costo ?>" readonly="readonly"/></td></tr></table></td></tr> <tr><td><table width="257" border="0" cellpadding="0" cellspacing="0"><tr><td>Consignaci&oacute;n Descuento</td><td width="113" class="Tablas"><input name="consignaciondes" type="text" class="Tablas" id="consignaciondes" style="width:100px;background:#FFFF99" readonly="readonly" value="<?=$consignaciondes ?>"/></td></tr></table></td></tr></table>';var descuento = '<table width="534" border="0" cellpadding="0" cellspacing="0"><tr> <td width="150">Descuento Sobre Flete:</td><td width="384"><input name="descuentoflete" type="text" class="Tablas" id="descuentoflete" style="width:100px;background:#FFFF99" readonly="readonly" /></td></tr></table>';	var u = document.all;
	...
	function obtenerCliente(cliente){
		if(cliente!=""){
			consultaTexto("mostrarCliente","consultaCredito_con.php?accion=1&tipo=1&cliente="+cliente);
		}
	}
	function mostrarCliente(datos){
		if(datos.replace("\n","").replace("\r","").replace("\n\r","")!="0"){
			var obj = eval(convertirValoresJson(datos));			
				...
				u.disponible.value		= ((obj[0].disponible<"0")?0:'$ '+numcredvar(obj[0].disponible));
	...
	consultaTexto("mostrarCGridKg", "consultasHTML.php?accion=6&valor=1&idconvenio="+u.folioconvenio.value+"&cliente=<?=$_GET[cliente] ?>");
		}
		if(preciocaja==1) {u.div1.innerHTML = div_descripcion;
	consultaTexto("mostrarCGridPeso", "consultasHTML.php?accion=6&valor=2&idconvenio="+u.folioconvenio.value+"&cliente=<?=$_GET[cliente] ?>");
		}
...
u.descuentoflete.value = datos.getElementsByTagName('cantidaddescuento').item(0).firstChild.data;	
	...
	if(consignacionkg==0 && consignacioncaja==0 && prepagadas==0 && consigdescuento==0){
		...
		v_prepagadas;
	consultaTexto("mostrarSGridKg", "consultasHTML.php?accion=6&valor=3&idconvenio="+u.folioconvenio.value+"&cliente=<?=$_GET[cliente] ?>");
		}
 		if(consignacioncaja==1){u.div2.innerHTML = detalledescripcionc;
		v_prepagadas;
	consultaTexto("mostrarSGridPeso", "consultasHTML.php?accion=6&valor=4&idconvenio="+u.folioconvenio.value+"&cliente=<?=$_GET[cliente] ?>");
		}
	...
	consultaTexto("mostrarGrids","consultasHTML.php?accion=8&idconvenio="+u.folioconvenio.value+"&cliente=<?=$_GET[cliente] ?>");
		}else{
		u.empresariales.style.display="none";
		u.normales.style.display="none";
		}
	...
	function mostrarCGridKg(datos){		u.div_preciokg.innerHTML = datos;
	}
    ...
    <td height="109"><table width="559" border="0" id="credito" cellpadding="1" cellspacing="0">
      ...
      <tr>
        ...
        <td class="Tablas"> <select name="clasificacioncliente" id="clasificacioncliente" class="Tablas" style="width:123px; font-size:9px; text-transform:uppercase">
                      <option selected="selected" class="Tablas" >Seleccionar</option>
