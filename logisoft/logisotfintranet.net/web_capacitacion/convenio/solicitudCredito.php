...
<script>
		...
		var tabla_4 = '<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td width="83%" style="text-align:right"><input name="btnimprimir" id="btnimprimir" type="button" class="button" onclick="imprimirCredito()" value="Imprimir"/></td><td width="17%" style="text-align:right"><input name="button6" type="button" class="button" onclick="confirmar(\'Perder&aacute; la informaci&oacute;n capturada &iquest;Desea continuar?\', \'\', \'limpiar(1);\', \'\')" value="Nuevo"/></td></tr></table>';
