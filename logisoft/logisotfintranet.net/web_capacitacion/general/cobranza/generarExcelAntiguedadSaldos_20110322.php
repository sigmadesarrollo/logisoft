...
<?
	...
	$s = "SELECT rc.prefijosucursal,rc.cliente,rc.folio, IFNULL(DATE_FORMAT(rc.fecha,'%d/%m/%Y'),'') AS fechaguia, 
		...
		total AS saldo,IFNULL(rc.factura,'') AS factura, IFNULL(co.contrarecibo,'') AS contrarecibo
...
?>
	<table width="1211">
    	...
    	<tr>
    	  ...
    	  <td width="100" style="font-weight:bold; border:#000 solid 1px"">GUIA/FACTURA</td>
    	  ...
    	  <td width="40" style="font-weight:bold; border:#000 solid 1px"">DIAS VENC.</td>
		...
		while($f = mysql_fetch_array($r)){
			...
			if($cliente!=cambio_texto($f[cliente])){
				...
				?>
				<tr>
				  <td colspan="6"  style="border-bottom: 1px #000 solid; border-left:1px #000 solid; font-weight:bold">TOTAL <?=cambio_texto($cliente)?></td>
              ...
              <tr>
              	<td colspan="15" style="font-weight:bold"></td>
              </tr>
			  <?
	  			$var_alco  	= 0;
				$var_115   	= 0;
				...
				?>
              <tr>
                  <td style="border-top:#000 1px solid; border-left:#000 1px solid;font-weight:bold" colspan="5">
			...
			?>
              ...
              <tr>
				  <td colspan="6"  style="border-bottom: 1px #000 solid; border-left:1px #000 solid; font-weight:bold">TOTAL</td>
				  <td style="border-bottom: 1px #000 solid; ">&nbsp;</td>
