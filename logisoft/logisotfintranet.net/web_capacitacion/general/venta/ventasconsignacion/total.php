...
<script>
	...
	tabla1.setAttributes({
		...
		campos:[
			...
			{nombre:"SUBDESTINO", medida:60, alineacion:"right", tipo:"moneda",  datos:"subdestino"},
	...
	function obtenerDetalle(){
		...
		consultaTexto("mostrarDetalle","../ventas/consultasVentas.php?accion=9&cliente=<?= (($_GET[cliente]!='')?$_GET[cliente]:0) ?>&fechaini=<?=$_GET[fechaini] ?>&fechafin=<?=$_GET[fechafin] ?>&guia=<?=$_GET[guia] ?>");
	...
	function mostrarDetalle(datos){		
		...
		if(datos.replace("\n","").replace("\r","").replace("\n\r","")!="0"){
			...
			obj.fecha	= ""; 	obj.origen	= "";

			obj.destino	= "";	obj.guia	= "";

			obj.cantidad	= 0; obj.kilogramos	= 0;

			obj.valordeclarado	= 0; obj.tflete	= 0;

			obj.excedente	= 0; obj.subdestino	= 0;

			obj.costoseg	= 0; obj.cargocombustible	= 0;

			obj.subtotal	= 0; obj.tiva	= 0;

			obj.ivaretenido	= 0; obj.total	= 0;
	...
	function tipoImpresion(valor){
		...
		if(valor=="Archivo"){			
			...
			window.open("http://www.pmmentuempresa.com/web/general/venta/ventaConsignacionTotalExcel.php?accion=9&cliente=<?=$_GET[cliente] ?>&fechaini=<?=$_GET[fechaini] ?>&fechafin=<?=$_GET[fechafin] ?>&guia=<?=$_GET[guia] ?>&m="+Math.random()+"&titulo=GUIAS Y SERVICIOS");			
...
<form id="form1" name="form1" method="post" action="">
  ...
  <table width="680" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td width="1045"><table width="463" border="0" cellpadding="0" cellspacing="0">

          <tr>

            <td width="40"> Cliente:</td>

            <td width="106"><input name="cliente" type="text" class="Tablas" id="cliente" style="width:80px;background:#FFFF99" readonly="" value="<?=$_GET[cliente] ?>"/></td>

            <td width="317"><input name="nombre" type="text" class="Tablas" id="nombre" style="width:250px;background:#FFFF99" readonly="" value="<?=$f->nombre ?>"/></td>
          </tr>
...
<tr>
    ...
    <td><div id="txtDir" style=" height:280px; width:680px; overflow:auto" align=left>
            ...
            <tr>
              ...
              <td><table width="850"  border="0" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  ...
                  <td width="53">Total Gral:</td>

                  <td width="106"><span class="style31">

                    <input name="total" type="text" class="Tablas" id="total" readonly="" style=" width:100px;background-color:#FFFF99; text-align:right" />
