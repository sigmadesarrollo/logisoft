...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 $xls .='<Worksheet ss:Name="Hoja1">
  <Table ss:ExpandedColumnCount="9" ss:ExpandedRowCount="'.($filas+8).'" x:FullColumns="1"
   ...
   <Row ss:Index="6">
    <Cell ss:StyleID="s21"><Data ss:Type="String">FECHA DE</Data></Cell>
    <Cell ss:StyleID="s21"><Data ss:Type="String">FECHA DE </Data></Cell>
    <Cell ss:StyleID="s21"><Data ss:Type="String">FECDHA DE </Data></Cell>
    <Cell ss:StyleID="s21"><Data ss:Type="String">ESTADO DE </Data></Cell>
    <Cell ss:StyleID="s21"><Data ss:Type="String">LIMITE DE </Data></Cell>
    <Cell ss:StyleID="s21"><Data ss:Type="String">TIPO DE </Data></Cell>
    <Cell ss:StyleID="s21"><Data ss:Type="String">VALOR DE </Data></Cell>
    <Cell ss:StyleID="s21"><Data ss:Type="String">PESO </Data></Cell>
    <Cell ss:StyleID="s21"><Data ss:Type="String">PRECIO </Data></Cell>
   </Row>
   <Row ss:Height="13.5">
    <Cell ss:StyleID="s22"><Data ss:Type="String">ALTA</Data></Cell>
    <Cell ss:StyleID="s22"><Data ss:Type="String">MODIFICACION</Data></Cell>
    <Cell ss:StyleID="s22"><Data ss:Type="String">VENCIMIENTO</Data></Cell>
