<? session_start();
	...
	$s = "select count(*) from catalogounidad u
			LEFT JOIN catalogotipounidad t ON u.tipounidad = t.id and u.tiporuta='FORANEA'
			$and $andunidad $inner";
  ...
  <tr>
    <td height="300px" colspan="3" valign="top" class="Tablas" >
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        <?
		$s = "SELECT u.id, t.descripcion, u.numeroeconomico FROM catalogounidad u
		LEFT JOIN catalogotipounidad t ON u.tipounidad = t.id and u.tiporuta='FORANEA' $and
		$andunidad $inner limit ".$st.",".$pp;
		//die($s);
