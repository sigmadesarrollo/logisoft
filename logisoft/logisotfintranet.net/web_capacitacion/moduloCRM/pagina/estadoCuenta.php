...
<script>
	...
	tabla1.setAttributes({
		...
		campos:[			
			...
			{nombre:"FECHA", medida:55, alineacion:"left", datos:"fecha"},

			{nombre:"SUCURSAL", medida:50, alineacion:"center", datos:"sucursal"},

			{nombre:"REF. CARGO", medida:80, alineacion:"left", datos:"referenciacargo"},

			{nombre:"REF. ABONO", medida:80, alineacion:"left", datos:"referenciabono"},

			{nombre:"CARGO", medida:85, tipo:"moneda", alineacion:"left", datos:"cargo"},

			{nombre:"ABONO", medida:85, tipo:"moneda", alineacion:"left", datos:"abono"},

			{nombre:"SALDO", medida:85, tipo:"moneda", alineacion:"left", datos:"saldo"},
	...
	function generarHistorial(){
		...
		consultaTexto("obtenerTotal","consultas_crm.php?accion=14&tipo=0&cliente=<?=$_GET[cliente] ?>&fechainicio="+u.fechainicio.value+"&fechafin="+u.fechafin.value);
	...
	function obtenerTotal(datos){
		...
		consultaTexto("mostrarDetalle","consultas_crm.php?accion=14&tipo=1&inicio=0&cliente=<?=$_GET[cliente] ?>&fechainicio="+u.fechainicio.value+"&fechafin="+u.fechafin.value);
		...
		if(tipo == "atras"){
			...
			if(parseFloat(u.totaldes.value) <= "1"){
				...
				if(u.ultimo.value == "SI"){
					...
					consultaTexto("mostrarDetalle","consultas_crm.php?accion=14&tipo=1&inicio="+u.totaldes.value+"&cliente=<?=$_GET[cliente] ?>&fechainicio="+u.fechainicio.value+"&fechafin="+u.fechafin.value);
				...
				consultaTexto("mostrarDetalle","consultas_crm.php?accion=14&tipo=1&cliente=<?=$_GET[cliente] ?>&inicio="+u.totaldes.value+"&fechainicio="+u.fechainicio.value+"&fechafin="+u.fechafin.value);
	...
	function obtenerUltimo(){
		...
		consultaTexto("mostrarDetalle","consultas_crm.php?accion=15&tipo=1&cliente=<?=$_GET[cliente] ?>&fechainicio="+u.fechainicio.value+"&fechafin="+u.fechafin.value);
