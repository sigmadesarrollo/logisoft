<? session_start();
	...
	$puesto = " and puesto = 47 or puesto =48 or puesto =60 ";
  ...
  <tr>
    ...
    <td colspan="3" height="300px" valign="top" >
      ...
      <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		$get = mysql_query("SELECT id, CONCAT(nombre,' ',apellidopaterno,' ',apellidomaterno) as enombre 
	...
	?>
        ...
        <tr>
          ...
          <td width="49"><span class="Tablas" style="cursor:pointer;color:#0000FF" onclick="window.parent.obtenerConductorBusqueda('<?=$row['id'];?>','<?=$_GET['caja']; ?>');parent.VentanaModal.cerrar();">

            <?= $row['id'];?>

          </span></td>

          <td width="405" class="Tablas"><input class="Tablas" name="descripcion" type="text" value="<?=$row['enombre']; ?>" readonly="true" style="width:300px; border:none; cursor:default"></td>         
