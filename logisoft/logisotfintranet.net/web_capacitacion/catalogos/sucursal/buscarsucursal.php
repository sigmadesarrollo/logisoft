...
<form name="buscar" >
  <table width="500"  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
    ...
    <tr>
      <td colspan="2" height="300px" valign="top"><table width="100%" border="0" align="center">
          <?	
		$get = mysql_query('select * from catalogosucursal ORDER BY descripcion ASC limit '.$st.','.$pp,$link);		
