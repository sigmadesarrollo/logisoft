...
function MostrarPedirCliente(datos){
	if(datos.indexOf("no encontro")<0){		
		...
		if(parseFloat(obj.datoscliente.registradoalmacen)<1 && obj.datoscliente.modificable=='SI')
      ...
      <tr>
        <td colspan="2"><table width="615" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="428"><div id="buscarguia" class="ebtn_buscar" onclick="abrirVentanaFija('../buscadores_generales/buscarGuiasEmpresariales_VentanillaGen.php?funcion=pedirGuiasPGuia&tipo=1', 600, 550, 'ventana', 'Buscar')"></div></td>
            </tr>
        </table></td>
      </tr>
      <tr>
