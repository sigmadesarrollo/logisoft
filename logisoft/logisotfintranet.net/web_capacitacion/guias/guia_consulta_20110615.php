<?
	...
	if($_GET[accion] == 4){
		...
		if(mysql_num_rows($r)>0){ postError("<xml version=\"1.0\" standalone=\"yes\" encoding=\"utf-8\"> 
				<datos>
				<guardado>-1</guardado>
		...
		if($_SESSION[IDSUCURSAL]==1){ postError("<xml version=\"1.0\" standalone=\"yes\" encoding=\"utf-8\"> 
				<datos>
				<guardado>-2</guardado>
