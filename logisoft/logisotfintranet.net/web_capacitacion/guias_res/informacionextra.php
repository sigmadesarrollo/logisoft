...
<div style="position:absolute; left: 2px; top: 24px; width: 621px; visibility:hidden;" id="canvas0">
...
<td width="95"><input name="dest" type="text"  id="dest" style="width:80px;background:#FFFF99" value="<?=$f->subdestino?>"  readonly=""/></td>
      ...
      <tr>
        ...
        <td width="164"><table width="164" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td>Descto.</td>
            <td><input type="text" name="destino245" style="background:#FFFF99;width:80px; font-size:9px; text-align:right" value="$ <?=number_format($f->tdescuento,2,'.',',')?>" /></td>
          </tr>
          <tr>
            <td>Sub Total </td>
...
<div style="position:absolute; left: 2px; top: 24px; width: 617px; visibility:visible; height: 260px;" id="canvas2">
<table width="617" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
	<tr>
    	<td height="13">
        <table width="567" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td colspan="3" align="center">
    	<table>
        	<tr>
            	<td><img src="paraimagenes.php?guia=<?=$_GET[folio]?>" width="100px" height="100px"></td>
            </tr>
        </table>
    </td>
  </tr>
...
<script>
	...
	tabla1.setAttributes({
		...
		campos:[
			...
			{nombre:"EVENTO REALIZADO", medida:100,alineacion:"left", datos:"evento"},	
