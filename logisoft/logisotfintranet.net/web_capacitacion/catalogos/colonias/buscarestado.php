  ...
  <table width="500"  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
    ...
    <tr>
      <td colspan="2" height="300px" valign="top"><div id="txtHint" style="width:100%; height:auto;"><table width="100%" border="0" align="center" class="Tablas">
          <?	
		$get = mysql_query('select * from catalogoestado limit '.$st.','.$pp,$link);		
...
<span onclick="window.parent.obtener('<?= $row['id'];?>');parent.VentanaModal.cerrar();" style="cursor: pointer; color:#0000FF"><?= $row['id'];?></span></td>
    ...
    <tr>
      <td colspan="2" align="center"><font color="#FF0000" size="-1"><? echo paginacion($total, $pp, $st, 'buscarestado.php?st='); ?></font></td>
    </tr>
  </table> 
</form>
<? } ?>