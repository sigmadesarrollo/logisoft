...
<script>
	...
	function mandarImpresion(datos){
		...
		if(datos.indexOf('EXCEL')>-1){
			window.open("../general/concesiones/"+reporte+"?fechainicio="+u.fechainicio.value+
			...
			<td>
			  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td colspan="2"><input name="fecha" type="text" class="Tablas" id="fecha" style="width:80px; background-color:#FFFF99" value="<?=date('d/m/Y') ?>" readonly="" /></td>
                  </tr>
                  <tr>
                    <td>Fecha Inicio: </td>
                    ...
                    <td>&nbsp;</td>
                    <td>Fecha Fin: </td>
                    <td colspan="2"><input name="fechafin" type="text" class="Tablas" id="fechafin" style="width:80px; background-color:#FFFF99" value="<?=date('d/m/Y') ?>" readonly="" /></td>
                  </tr>
                  <tr>
                    <td>Concesion:
