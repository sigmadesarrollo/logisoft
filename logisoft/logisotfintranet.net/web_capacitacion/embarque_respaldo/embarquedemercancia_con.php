<?
	...
	if($_GET['accion']==1){
		...
		WHERE bitacorasalida.status = 0 AND bitacorasalida.unidad = '$_GET[unidad]'
		...
		WHERE (isnull(gvu.proceso) or gvu.proceso = 'ALMACEN TRASBORDO') and (gv.estado='ALMACEN ORIGEN' or gv.estado='ALMACEN TRASBORDO')
		...
		WHERE (isnull(geu.proceso) or geu.proceso = 'ALMACEN TRASBORDO') and (ge.estado='ALMACEN ORIGEN' or ge.estado='ALMACEN TRASBORDO')
