...
<body>
	<table width="688" border="0" cellpadding="0" cellspacing="0">
    	...
    	<tr style="background-image:url(header4.png); filter:Alpha(Opacity=2); background-repeat:no-repeat">
    	  <td height="133" colspan="3" style="padding-left:15px">
          <table>
          	<tr>
            	<td width="88" rowspan="2"><img src="../img/logopmm.gif" /></td>
      ...
      <tr>
    	...
    	<tr>
          ...
          <?
			...
			where gr.numerorastreo = '$_GET[numerorastreo]'";
		  ...
		  ?>
    	    <table width="679" border="0" cellpadding="0" cellspacing="0">
    	      <tr  class="fuenteColumnas">
    	        ...
    	        <td width="226">NUMERO DE GUIA</td>
    	        <td width="12"></td>
    	        <td width="331"><?=$f->id?></td>
    	        </tr>
    	      <tr  class="fuenteColumnas">
    	  ...
    	  <td colspan="3">
    	    <table width="680" border="0" cellpadding="0" cellspacing="0">
    	      ...
    	      <tr class="fuenteFilas">
    	        ...
    	        <td align="center"><?=substr($f->hora,0,5)?></td>
    	        <td align="left"><?=$f->ubicacion?></td>
    	        <td align="left"><?
                	switch ($f->evento){
						case 'ALMACEN ORIGEN':
    	...
    	<tr>
    	  <td colspan="3" class="fuenteColumnas">
          <table>
          	<TR>
