...
<script>
	...
	function imprimirAuto(){
		if(document.all.estado.innerHTML=='ENTREGADA'){
			window.open("imprimiretiquetaguia_acuse.php?tipo=1&codigo="+folioimprimir,"1","width=500,height=500");
		}else{
			<? 
			...
			?>
			window.open("imprimiretiquetaguia.php?tipo=1&codigo="+folioimprimir,"1","width=500,height=500");
		}
	}
	...
	function imprimirDocumentos(valor,folio){
		if(valor!=6 && valor!=2  && valor!=4){
			...
			?>
			window.open("../guias/imprimiretiquetaguia_elegir.php?valor="+valor+"&folio="+folio+"&tipo=1&codigo="+folioimprimir,"1","width=500,height=500");
		}else{
	...
	function cambiarImpresora1_solo(valor,folio){
		...
		?>
		window.open("../guias/imprimiretiquetapaquete_elegir.php?valor="+valor+"&folio="+folio+"&tipo=1&codigo="+folioimprimir,"2","width=500,height=500");
	}
	...
	function cambiarImpresora1(){
		...
		?>
		window.open("imprimiretiquetapaquete.php?tipo=1&codigo="+folioimprimir,"2","width=500,height=500");
	}
