...
<script>
	...
	tabla1.setAttributes({
		...
		campos:[
			...
			{nombre:"DIRECCION", medida:250, alineacion:"left", datos:"direccion"},
			{nombre:"DIAS CREDITO", medida:80, alineacion:"center", datos:"diasdecredito"}
	...
	function obtenerDetalle(){
		consultaTexto("resTabla1","consultas_con.php?accion=9&contador="+u.pag1_contador.value
		+"&s="+Math.random());
	}
	...
	function paginacion(movimiento){
		switch(movimiento){
			case 'primero':
				consultaTexto("resTabla1","consultas_con.php?accion=9&contador=0&s="+Math.random());
				break;
			case 'adelante':
				if(u.pag1_adelante.value==1){
					consultaTexto("resTabla1","consultas_con.php?accion=9&contador="+(parseFloat(u.pag1_contador.value)+1)					
					+"&s="+Math.random());
				}
				break;
			case 'atras':
			...
			case 'ultimo':
				...
				consultaTexto("resTabla1","consultas_con.php?accion=9&contador="+contador
				+"&s="+Math.random());
				break;
		}
	}
...
<form id="form1" name="form1" method="post" action="">
  <table width="800" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
    <tr>
      <td class="FondoTabla">FACTURAS A REVISION </td>
    </tr>
    <tr>
