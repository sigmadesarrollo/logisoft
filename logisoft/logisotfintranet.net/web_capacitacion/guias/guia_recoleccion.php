...
<script>
	...
	function calcularservicios(){
		u = document.all;
			...
			//alert("xx");
			if(u.pc_recoleccion.value != "" && u.pc_recoleccion.value != " " && u.t_txtrecoleccion.value != ""){
				if((parseFloat(u.flete.value.replace("$ ","").replace(/,/g,""))*0.10)<parseFloat(u.pc_recoleccion.value)){
					...
					valorrecoleccion = 
					Math.round(((parseFloat(u.flete.value.replace("$ ","").replace(/,/g,""))-parseFloat((u.t_txtdescuento2.value=="")?0:u.t_txtdescuento2.value.replace("$ ","").replace(/,/g,"")))*.10)*100)/100;
...
<div class="content" style="width:830px">
  ...
  <div class="totales" style="height:280px">
    ...
    <input type="hidden" name="pc_ead">
                  <input type="text" name="pc_recoleccion">
