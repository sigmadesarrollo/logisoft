      ...
      <tr>
        <td colspan="7"><table width="618" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="290"><table border="0" cellpadding="0" cellspacing="0" id="tabladetalleder"></table>
            <table width="290" border="0" cellpadding="0" cellspacing="0">
                        <tr>
      ...
      <tr>
        <td colspan="7"><table width="315" align="center" cellpadding="0" cellspacing="0">
          <tr>
            ...
            <td width="132"><select name="buscarCombo" class="Tablas" style="width:100px" >
