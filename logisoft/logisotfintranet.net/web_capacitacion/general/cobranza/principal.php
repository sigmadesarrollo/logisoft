...
<script>
	...
	window.onload = function (){
		...
		tabs.iniciar({
			...
			paginainicial:"principalcobranza.php"
		...
		cn.crearNavegador();
			...
			contenidos:[
				...
				{nombre:"Clientes con Crédito"},

				{nombre:"Antiguedad de Saldos"},

				{nombre:"Monto Autorizado"},
...
<form id="form1" name="form1" method="post" action="">
  ...
  <table width="600" height="496" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td height="29" align="center" class="FondoTabla Estilo4">Reporte Principal de Cobranza</td>
