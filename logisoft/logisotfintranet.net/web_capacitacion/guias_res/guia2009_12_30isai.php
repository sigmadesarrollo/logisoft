...
<script>
	...
	function cancelarGuia(){
		...
		if((u.estado.innerHTML=='ALMACEN DESTINO' && u.lstflete.value == 1) || u.sustitucionguia.innerHTML.indexOf('SUSTITUCION')>-1){
			...
			if(u.fechaactual.value == u.fecha.value && u.estado.innerHTML!='ALMACEN DESTINO' && u.lstflete.value != 0){
				...
				alerta("No se puede cancelar la guia","¡Atención!","fecha");
			}
		}
	}
...
<table width="601" border="1" cellpadding="0" cellspacing="0" bordercolor="#016193">
  <tr>
    <td class="FondoTabla Estilo3" style="font-size:12px">GUÍA DE VENTANILLA</td>
  </tr>
  <tr>
            ...
            <tr>
              <td colspan="2"><table width="616" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td width="211" class="Tablas"><input type="text" name="recibio" readonly="true" style="background:#FFFF99;width:200px; font-size:9px; text-transform:uppercase" ></td>
