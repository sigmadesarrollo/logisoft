...
<table width="740px" border="0" cellpadding="0" cellspacing="0">
	<tr>
    	<td>
        	<table width="739" border="0" cellpadding="0" cellspacing="0">
            	<tr>
                	<td width="253" id="folioSeleccionado">&nbsp;</td>
                    <td width="229">&nbsp;</td>
                    <td width="257"id="estado"></td>
                </tr>
        	</table>
        </td>
    </tr>
    <tr>
    	<td>
        	<table width="739" border="0" cellpadding="0" cellspacing="0">
            	<tr>
                	<td width="253"><input name="fecha" readonly="true" type="text" id="fecha" value="<?=$f->fecha ?>" size="13" align="top" /></td>
                    <td width="229">&nbsp;</td>
                    <td width="257" id="unidadSubida">&nbsp;</td>
                </tr>
        	</table>
        </td>
    </tr>
    	...
    	<td>
        	<table width="739" border="0" cellpadding="0" cellspacing="0">
            	<tr>
                	<td width="253"></td>
                    <td width="229">&nbsp;</td>
                    <td width="257" id="danosfaltantes"></td>
                </tr>
        	</table>
        </td>
    </tr>
