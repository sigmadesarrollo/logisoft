...
<script>
	...
	tabla1.setAttributes({
		...
		campos:[
			...
			{nombre:"DIRECCION", medida:60, alineacion:"center", datos:"direccion"},
			{nombre:"DIAS EN ALMACEN", medida:90, alineacion:"center", datos:"diasenalmacen"},
	...
	function obtenerDetalle(){
		consultaTexto("mostrarDetalle","consultasAlertas.php?accion=18");
	}
