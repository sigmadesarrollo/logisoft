	...
	class VerificaGuias{
		...
		public function verificaGuiaVentanilla($folio){
			...
			if(mysql_num_rows($r)>0){
				...
				ivaretenido = if('$personamoral'='SI',(tflete-ttotaldescuento+tcostoead+trecoleccion+tseguro+totros+texcedente+tcombustible)*0.04,0)
				WHERE id = '$folio';";
				mysql_query($s,$l);
