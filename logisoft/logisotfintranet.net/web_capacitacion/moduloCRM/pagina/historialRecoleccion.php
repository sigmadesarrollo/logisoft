...
<script>
	...
	tabla1.setAttributes({
		...
		campos:[
			...
			{nombre:"ORIGEN", medida:150, alineacion:"left", datos:"origen"},
	...
	function generarHistorial(){
		...
		consultaTexto("obtenerTotal","consultas_crm.php?accion=10&tipo=0&cliente=<?=$_GET[cliente] ?>&fechainicio="+u.fechainicio.value+"&fechafin="+u.fechafin.value);
	...
	function obtenerTotal(datos){
		...
		consultaTexto("mostrarDetalle","consultas_crm.php?accion=10&tipo=1&inicio=0&cliente=<?=$_GET[cliente] ?>&fechainicio="+u.fechainicio.value+"&fechafin="+u.fechafin.value);
		...
		if(tipo == "atras"){
			...
			if(parseFloat(u.totaldes.value) <= "1"){
				...
				if(u.ultimo.value == "SI"){
					...
					consultaTexto("mostrarDetalle","consultas_crm.php?accion=10&tipo=1&inicio="+u.totaldes.value+"&cliente=<?=$_GET[cliente] ?>&fechainicio="+u.fechainicio.value+"&fechafin="+u.fechafin.value);
				...
				consultaTexto("mostrarDetalle","consultas_crm.php?accion=10&tipo=1&cliente=<?=$_GET[cliente] ?>&inicio="+u.totaldes.value+"&fechainicio="+u.fechainicio.value+"&fechafin="+u.fechafin.value);
	...
	function obtenerUltimo(){
		...
		consultaTexto("mostrarDetalle","consultas_crm.php?accion=11&cliente=<?=$_GET[cliente] ?>&fechainicio="+u.fechainicio.value+"&fechafin="+u.fechafin.value);
...
<form id="form1" name="form1" method="post" action="">
  ...
  <table width="501" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">

    <tr>

      <td class="FondoTabla">Historial de Recolecciones </td>
    ...
    <tr>
      ...
      <td><table width="500" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td><div align="left" style="overflow:auto;height:330px; width:500px">

		  <table width="599" border="0" cellspacing="0" cellpadding="0" id="detalle">           
