...
<script>
	...
	function pedirFacturas(tipo,valor2){
		if(document.all.modulo.value=="abonocliente"){
			...
			consulta("mostrarFactura", "buscarFacturasGenExtra.php?accion=1<?=(($_GET[todas])?"&todas=SI":"&todas=NO");?>&campo=cliente&valor=<?=$_GET[cliente]?>"+valor2+"&vran="+Math.random());
		}else{
			switch(tipo){
				case 1:
					consulta("mostrarFactura", "buscarFacturasGenExtra.php?accion=1<?=(($_GET[todas])?"&todas=SI":"&todas=NO");?>&campo=folio&valor="+valor2+"&vran="+Math.random());
					break;
				case 2:
					consulta("mostrarFactura", "buscarFacturasGenExtra.php?accion=1<?=(($_GET[todas])?"&todas=SI":"&todas=NO");?>&campo=nombre&valor="+valor2+"&vran="+Math.random());
					break;
			}
		}
	}
