<?	session_start();
	...
	WHERE cancelada=0 AND preliquidaciondebitacora = 1 
	AND NOT EXISTS(SELECT * FROM liquidaciongastos WHERE foliobitacora = bitacorasalida.folio) 
...
<table width="500"  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
  ...
  <tr>
    <td colspan="3" align="center"><font color="#FF0000" size="-1"><? echo paginacion($total, $pp, $st, 'buscarBitacoraLiquidacion.php?st='); ?></font></td>
  </tr>
</table>
</body>
</html>