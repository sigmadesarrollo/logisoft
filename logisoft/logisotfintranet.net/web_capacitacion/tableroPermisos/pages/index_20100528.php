...
<meta http-equiv="x-ua-compatible" content="IE=EmulateIE7" />
	...
	<link rel="stylesheet" type="text/css" href="css/tema-modificado/jquery-ui-1.7.2.custom.css" />
...
<table width="1000" border="0" cellpadding="0" cellspacing="0" id="posicionPagina">
	<tr id="parafila">	
		...
		?>
		  <select name="sucursal" style="width:203px; font-family:Verdana, Geneva, sans-serif; font-size:12px" class="styled" alcambiar="cambiarSucursal(this.value); var pg = devolverIframe().href;  devolverIframe().href='';  devolverIframe().href=pg;">
		<?
      ...
      <td colspan="2" valign="top"><?
		...
		?>        <iframe onblur="document.all.modificando.value=1;" name="pagina0" id="pagina0" scrolling="auto" 
                  ...
                  <iframe onblur="document.all.modificando.value=1;" name="pagina1" id="pagina1" scrolling="auto" 
        			align="top" width="770" height="770" src="<?=$pagina2?>" frameborder="0" style="display:none"></iframe>
                  <iframe onblur="document.all.modificando.value=1;" name="pagina2" id="pagina2" scrolling="auto" 
        			align="top" width="770" height="770" src="<?=$pagina3?>" frameborder="0" style="display:none"></iframe>
                  <iframe onblur="document.all.modificando.value=1;" name="pagina3" id="pagina3" scrolling="auto" 
        			align="top" width="770" height="770" src="<?=$pagina4?>" frameborder="0" style="display:none"></iframe>
                  <iframe onblur="document.all.modificando.value=1;" name="pagina4" id="pagina4" scrolling="auto" 
        			align="top" width="770" height="770" src="<?=$pagina5?>" frameborder="0" style="display:none"></iframe>
