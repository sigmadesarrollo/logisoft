...
<link href="../cliente/FondoTabla.css" rel="stylesheet" type="text/css">
...
<table width="480"  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
  ...
  <tr>
    ...
    <td colspan="5"><div id="txtDir" style="width:100%; height:150px; overflow: scroll;">

      <table width="95%" border="0" align="left" cellpadding="0" cellspacing="0" id="tab">

        <tr>

          <td width="40%" class="Tablas"><input name="text" type="text" style="border:none; visibility:hidden" value="<?= $row[d_asenta];?>" size="10" readonly=""></td>

          <td width="7%" class="Tablas"><input name="text" type="text" style="cursor:pointer; border:none; font-size:9px;visibility:hidden" value="<?= $row[d_codigo];?>" size="3" readonly="" /></td>
