  ...
  <table width="500" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
    ...
    <tr>
      <td><table width="100%" align="center" cellpadding="0" cellspacing="0" >
          ...
          <tr>
            <td colspan="4"><input name="tguiacancelada" type="texttttt" id="tguiacancelada" />
                <input name="tfactura" type="texttttt" id="tfactura" readonly=""/>
            <input name="h_fecha" type="texttttt" id="h_fecha" value="<?=date('d/m/Y') ?>" readonly=""/></td>
          </tr>
          <tr>
            <td colspan="4"><input name="accion" type="texttttt" id="accion" />
                <input name="codigo" type="texttttt" id="codigo"  />
                <input name="parcial" type="texttttt" id="parcial"  />
                <input name="iniciocaja" type="texttttt" id="iniciocaja"  />
                <input name="tefectivo" type="texttttt" id="tefectivo"  />
                <input name="ttarjeta" type="texttttt" id="ttarjeta"  />
                <input name="ttransferencia" type="texttttt" id="ttransferencia"  />
                <input name="tcheque" type="texttttt" id="tcheque"  />
                <input name="tretiros" type="texttttt" id="tretiros"  />
                <input name="tnotascredito" type="texttttt" id="tretiros"  />
                <input name="cambiafecha" type="texttttt" id="cambiafecha" /></td>
          </tr>
          <tr>
            <td colspan="4">
