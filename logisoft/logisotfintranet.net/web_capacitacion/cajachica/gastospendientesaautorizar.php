...
<table width="600" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
  <tr>
    <td width="596" class="FondoTabla Estilo4">GASTOS PENDIENTES DE AUTORIZAR</td>
  </tr>
  <tr>
    <td><div align="center">
      <table width="579" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td><table width="600" border="0" align="left" cellpadding="0" cellspacing="0">
            <tr>
              <td colspan="20" align="left"><div id="detalle" name="detalle" style="width:600px; height:300px; overflow:auto" align="left">
                  <? $line = 0; ?>
                  <table width="692" border="0" cellspacing="0" cellpadding="0">
                  <tr>
					  <td width="4" height="30" style="background: url(../img/bordeb1_1.jpg) no-repeat right">
					  <img src="../img/space.gif" alt="Space" width="1" height="1" /></td>
            ...
            <?		
				...
				$sWhere = " WHERE autorizado = 'N' AND (keyfoliosgastoscajachica = '' or ISNULL(keyfoliosgastoscajachica) or keyfoliosgastoscajachica = '0')";
			...
			?>
                    <tr class="<? if ($line % 2 ==0){ echo 'Balance2' ;}else{ echo 'Balance' ;} ?>" >
                      ...
                      <td align="center" class="style31"  >
                      	<input name="gasto<?=$row->id ?>" value="<?=$row->tipogastodesc ?>" type="text" class="style2" id="gasto<?=$row->id ?>" readonly="" 
						style="font-size:8px; font:tahoma; font-weight:bold" size="32"  />
                      </td>
                      <td align="center" class="style31">
                      	<input name="sucursal<?=$row->id ?>" value="<?=$row->prefijosucursal ?>" type="text" class="style2" id="sucursal<?=$row->id ?>" 
						style="font-size:8px; font:tahoma;font-weight:bold" readonly="" size="6" />
                      </td>
                      <td class="style31" align="center">
                      	<input name="folio<?=$row->id ?>" value="<?=$row->id ?>" type="text" class="style2" id="folio<?=$row->id ?>" 
						style="font-size:8px; font:tahoma;font-weight:bold" readonly="" size="6" />
                      </td>
                      <td class="style31" align="center">
                      	<input name="fecha<?=$row->id ?>" value="<?=$row->fecha ?>" type="text" readonly="" class="style2" id="fecha<?=$row->id ?>" 
						style="font-size:8px; font:tahoma;font-weight:bold" size="10" />
                      </td>
                      <td  class="style31" align="center">
                      	<input name="factura<?=$row->id ?>" value="<?=$row->factura ?>" type="text" class="style2" id="factura<?=$row->id ?>" readonly="" 
						style="font-size:8px; font:tahoma;font-weight:bold" size="10" />
                      </td>
                      <td  class="style31" align="center">
                      	<input name="fechafacturavale<?=$row->id ?>" value="<?=$row->fechafacturavale ?>" type="text" class="style2" 
						id="fechafacturavale<?=$row->id ?>" readonly="" style="font-size:8px; font:tahoma;font-weight:bold" size="10" />
                      </td>
					  <td  align="center" class="style31"  >
                      	<input name="proveedor<?=$row->id ?>" value="<?=$row->nombreproveedor ?>" type="text" class="style2" id="proveedor<?=$row->id ?>" 
						readonly="" style="font-size:8px; font:tahoma; font-weight:bold" size="20" />
                      </td>
					  <td align="center" class="style31"  >
                      	<input name="concepto<?=$row->id ?>" value="<?=$row->descripcionconcepto ?>" type="text" class="style2" id="concepto<?=$row->id ?>" 
						readonly="" style="font-size:8px; font:tahoma; font-weight:bold" size="25" />
                      </td>
					  <td align="center" class="style31"  >
                      	<input name="descripcion<?=$row->id ?>" value="<?=$row->descripcion ?>" type="text" class="style2" id="descripcion<?=$row->id ?>" 
						readonly="" style="font-size:8px; font:tahoma; font-weight:bold" size="28" />
                      </td>
					  <td align="center" class="style31"  >
                      	<input name="total<?=$row->id ?>" value="<?=number_format($row->total, 2, ',','.') ?>" type="text" class="style2" id="total<?=$row->id ?>" 
						readonly="" style="font-size:8px; font:tahoma; font-weight:bold" size="10" />
                      </td>
					  <td align="center" class="style31"  >
                      	<input name="folioautorizacion<?=$row->id ?>" value="<?=$row->folioautorizacion ?>" type="text" class="style2" 
						id="folioautorizacion<?=$row->id ?>" readonly="" style="font-size:8px; font:tahoma; font-weight:bold" size="20" />
                      </td>
					  <td align="center" class="style31"  >
                      	<input name="motivonoautorizacion<?=$row->id ?>" value="<?=$row->motivonoautorizacion ?>" type="text" class="style2" 
						id="motivonoautorizacion<?=$row->id ?>" style="font-size:8px; font:tahoma; font-weight:bold" size="25" />
                      </td>
	...
	?>
			<tr class="Balance">
                ...
                <td align="center" class="style31"  >
                   	<input name="gasto<?=$row->id ?>" value="<?=$row->tipogastodesc ?>" type="text" class="style2" id="gasto<?=$row->id ?>" 
					readonly="" style="font-size:8px; font:tahoma; font-weight:bold" size="32"  />
                </td>
                <td align="center" class="style31">
                  	<input name="sucursal<?=$row->id ?>" value="<?=$row->prefijosucursal ?>" type="text" class="style2" id="sucursal<?=$row->id ?>" 
					style="font-size:8px; font:tahoma;font-weight:bold" readonly="" size="6" />
			    ...
			    <td  class="style31" align="center">
		          	<input name="factura<?=$row->id ?>" value="<?=$row->factura ?>" type="text" class="style2" id="factura<?=$row->id ?>" 
					readonly="" style="font-size:8px; font:tahoma;font-weight:bold" size="10" />
				</td>
			    <td  class="style31" align="center">
		          	<input name="fechafacturavale<?=$row->id ?>" value="<?=$row->fechafacturavale ?>" type="text" class="style2" 
		  		...
		  		<td  align="center" class="style31"  >
                 	<input name="proveedor<?=$row->id ?>" value="<?=$row->nombreproveedor ?>" type="text" class="style2" 
					id="proveedor<?=$row->id ?>" readonly="" style="font-size:8px; font:tahoma; font-weight:bold" size="20" />
                </td>
				<td align="center" class="style31"  >
			      	<input name="concepto<?=$row->id ?>" value="<?=$row->descripcionconcepto ?>" type="text" class="style2" 
					id="concepto<?=$row->id ?>" readonly="" style="font-size:8px; font:tahoma; font-weight:bold" size="25" />
                </td>
			    <td align="center" class="style31"  >
			      	<input name="descripcion<?=$row->id ?>" value="<?=$row->descripcion ?>" type="text" class="style2" 
					id="descripcion<?=$row->id ?>" readonly="" style="font-size:8px; font:tahoma; font-weight:bold" size="28" />
				</td>
				<td align="center" class="style31"  >
                   	<input name="total<?=$row->id ?>" value="<?=$row->total ?>" type="text" class="style2" id="total<?=$row->id ?>" 
					readonly="" style="font-size:8px; font:tahoma; font-weight:bold" size="10" />
                </td>
				<td align="center" class="style31"  >
                   	<input name="folioautorizacion<?=$row->id ?>" value="<?=$row->folioautorizacion ?>" type="text" class="style2" 
...
<script language="javascript">
	...
	function enviar(){		
		abrirVentanaFija('../buscadores_generales/logueo_permisos.php?modulo=GuiaVentanilla&usuario=<?=$_SESSION[NOMBREUSUARIO] ?>&funcion=enviarReal', 370, 400, 'ventana', 'Inicio de Sesión Secundaria');
	}
