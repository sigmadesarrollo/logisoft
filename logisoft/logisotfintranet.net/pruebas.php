...
function validar(){ 
	if (document.getElementById('usuario').value==""){ 
		...
		consultaTexto("respuestaLogin", "index_consultas4.php?usuario="+document.getElementById('usuario').value+
...
function validarEntrada(menu){
	if(menu == 'PMM EN SU EMPRESA'){
		...
		mens.show("A","En Desarrollo","¡Atención!");
	}else{
		consultaTexto('resValidarEntrada',"validarTablero4.php?accion=1&modulo="+menu);
	}
}
