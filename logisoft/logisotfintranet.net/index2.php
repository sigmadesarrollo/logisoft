...
<script type="text/javascript" src="web_pruebas/javascript/ClaseMensajes.js"></script>
<style type="text/css">
...
mens.iniciar("web_pruebas/javascript");
...
function validar(){ 
	if (document.getElementById('usuario').value==""){ 
		...
		consultaTexto("respuestaLogin", "index_consultas2.php?usuario="+document.getElementById('usuario').value+
...
function validarEntrada(menu){
	if(menu == 'PMM EN SU EMPRESA'){
		...
		consultaTexto('resValidarEntrada',"validarTablero2.php?accion=1&modulo="+menu);
	}
}
    	...
    	<div id="headerp">
                ...
                <div id="menus">
                  <ul> 
                    ...
                    <li><a href="#" onclick="window.open('clientes/web_pruebas/guias/cotizarguia.php','','width=620 height=570')">cotizador</a></li>
                    <li><a href="#">servicios</a></li>
                    <li><a href="index.php">login</a></li>
                    </ul>
                </div>
                <div id="menus1">
                  Sistema para Pruebas PMM y Empresaria
                </div>
        	</div>
            <div id="cuadroFotos">
               ...
               <div id="loginimg"></div>
                ...
                <div id="cuadroIconos">
                    ...
                    <div id="icono" onclick="validarEntrada('GERENTE SUCURSAL')">
                		...
                		<div id="texto">Gerente General</div>
                    </div>
