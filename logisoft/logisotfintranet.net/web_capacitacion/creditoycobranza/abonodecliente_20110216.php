...
<script>
	...
	window.onload = function(){
		tabla1.create();
		consultaTexto("mostrarDetalles", "abonodecliente_con.php?accion=6&valram="+Math.random());
	}
	...
	function quitarPago(factura){
		consultaTexto("resQuitar","abonodecliente_con.php?accion=5&factura="+factura+'&rdnm='+Math.random());
	}
	...
	function pedirCliente(valor){
		consultaTexto("mostrarCliente", "abonodecliente_con.php?accion=1&valor="+valor+"&cliente="+valor+"&valram="+Math.random());
	}
	...
	function modificarPago(factura){
		...
		consultaTexto("resModificacion","abonodecliente_con.php?accion=4&arre="+arr+"&factura="+factura+'&rdnm='+Math.random());
	}
	...
	function agrupar(){
		...
		consultaTexto("resAgrupar","abonodecliente_con.php?accion=2&facturas="+facturas+"&rand="+Math.random());
	}
	...
	function desagrupar(){
		...
		consultaTexto("resDesagrupar","abonodecliente_con.php?accion=3&facturas="+facturas+"&rand="+Math.random());
	}
	...
	function guardarPagos(){
		...
		consultaTexto("resGuardar", "abonodecliente_con.php?accion=7"
							+"&folio="+u.folio.value
	...
	function OptenerAbonoCliente(id){
		consultaTexto("mostrarAbonoCliente", "abonodecliente_con.php?accion=8&id="+id+"&valram="+Math.random());
	}
