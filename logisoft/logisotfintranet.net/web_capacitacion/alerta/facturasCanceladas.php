...
<script>
	...
	tabla1.setAttributes({
		nombre:"detalle",
		campos:[
			{nombre:"FACTURA", medida:50, alineacion:"center",  datos:"folio"},
			{nombre:"FECHA", medida:80, alineacion:"center",  datos:"fecha"},
			{nombre:"CLIENTE", medida:180, alineacion:"left", datos:"cliente"},
			{nombre:"IMPORTE", medida:90, alineacion:"center", tipo:"moneda", datos:"importe"},
			{nombre:"TIPO FACTURA", medida:85, alineacion:"center", datos:"tipofactura"},
			{nombre:"FECHA CANCELACION", medida:90, alineacion:"center", datos:"fechacancelacion"}			
		],
		filasInicial:25,
		alto:250,
		seleccion:true,
	...
	function obtenerDetalle(){		
		consultaTexto("resTabla1","consultasAlertas.php?accion=8&contador="+u.pag1_contador.value
		+"&s="+Math.random());
	}
	...
	function paginacion(movimiento){
		switch(movimiento){
			case 'primero':
				consultaTexto("resTabla1","consultasAlertas.php?accion=8&contador=0&s="+Math.random());
				break;
			case 'adelante':
				if(u.pag1_adelante.value==1){
					consultaTexto("resTabla1","consultasAlertas.php?accion=8&contador="+(parseFloat(u.pag1_contador.value)+1)					
					+"&s="+Math.random());
				}
				break;
			case 'atras':
			...
			case 'ultimo':
				...
				consultaTexto("resTabla1","consultasAlertas.php?accion=8&contador="+contador
				+"&s="+Math.random());
				break;
		}
	}
...
<form id="form1" name="form1" method="post" action="">
  <table width="550" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
    <tr>
      <td class="FondoTabla">FACTURAS CANCELADAS  </td>
    </tr>
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><div id="txtDir" style=" height:280px; width:620px; overflow:auto" align="left">
