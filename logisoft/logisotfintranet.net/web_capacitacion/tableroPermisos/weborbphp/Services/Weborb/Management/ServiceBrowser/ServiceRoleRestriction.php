...
class ServiceRoleRestriction extends ServiceRestriction
{
    var $RoleName;
    ...
    public function ServiceRoleRestriction($roleNameRestriction)
    {
        $this->RoleName = $roleNameRestriction->getRoleName();
    }
    ...
    {
    	return new RoleNameRestriction($this->RoleName);
    }
}
?>
