...
<script>
	...
	function respuestaGuia(datos){
		...
		if(encon>0){
			...
			if(datos.getElementsByTagName('sustituciondeguia').item(0)!=null){
				...
				document.all.sustitucionguia.innerHTML = sustituciondeguia;
			}
	...
	function limpiar_remitente(){
		...
		u.rem_cliente.value 	= "";
		u.rem_numero.value		= "";
		u.celda_rem_calle.innerHTML = '<input name="rem_calle" readonly="true" type="text" style="background:#d9e6f0;font:tahoma; font-size:9px" value="" size="35" /><input type="hidden" name="rem_direcciones">';
		u.rem_cp.value			= "";
		u.rem_colonia.value		= "";
	...
	function limpiar_destinatario(){
		...
		u.des_numero.value		= "";
		u.des_cp.value			= "";
		u.celda_des_calle.innerHTML = '<input name="des_calle" readonly="true" type="text" style="background:#d9e6f0;font:tahoma; font-size:9px" value="" size="35" /><input type="hidden" name="des_direcciones">'
	...
	function limpiar_evaluacion(){
			...
			document.all.sustitucionguia.innerHTML = "&nbsp;";
	...
	function devolverDatosEvaluacion(datos){
		...
		if(encon>0){
			...
			bloquearocurre		= datos.getElementsByTagName('bloquearocurre').item(0).firstChild.data;
			frontera			= datos.getElementsByTagName('frontera').item(0).firstChild.data;
			subdestinos			= datos.getElementsByTagName('subdestinos').item(0).firstChild.data;
			idsucursalrecoleccion = datos.getElementsByTagName('idsucursalrecoleccion').item(0).firstChild.data;
			origensubdestinos	= datos.getElementsByTagName('origensubdestinos').item(0).firstChild.data;
			nombreorigen		= datos.getElementsByTagName('nombreorigen').item(0).firstChild.data;
			...
			vdlimite			= datos.getElementsByTagName('vd_limite').item(0).firstChild.data;
			vdcostoextra		= datos.getElementsByTagName('vd_costoextra').item(0).firstChild.data;
	...
	function mostrarRemitente(datos){
		...
		if(encon>0){
			...
			if(endir==1){
				...
				+'style="background:#d9e6f0;font:tahoma; font-size:9px" value="" size="35" /><input type="hidden" name="rem_direcciones">';
	...
	function mostrarDestinatario(datos){
		...
		if(encon>0){
			...
			if(endir==1){
				...
				+'style="background:#d9e6f0;font:tahoma; font-size:9px" value="" size="35" /><input type="hidden" name="des_direcciones">';
...
<table width="669" border="0" cellpadding="0" cellspacing="0" align="center">
  <tr>
    <td width="630" class="FondoTabla Estilo3" style="font-size:12px"><h1>GUÍA DE VENTANILLA</h1></td>
  </tr>
  <tr>
    <td><table width="668" border="0" align="left" cellpadding="0" cellspacing="0">
      <tr>
       ...
       <tr>
        <td height=25 colspan="2" >
        	<table width="619" cellpadding="0" cellspacing="0" border="0">
             <tr>
                <td width="204" align="left" id="folioSeleccionado" style="color:#F00000; font-size:15px; font-weight:bold"></td>
                <td width="77"></td>
            	<td width="338" align="right" id="unidadSubida" style="color:#006; font-size:15px; font-weight:bold">&nbsp;</td>
            </tr>
        	  <tr>
        	    <td colspan="3" align="center" id="danosfaltantes" style="color:#C60; font-size:15px; font-weight:bold"></td>
        	    </tr>
              <tr>
              	<td colspan="3" id="sustitucionguia" style="color:#C60; font-size:15px; font-weight:bold">&nbsp;</td>
              </tr>
        	</table>
        </td>
</tr>
      <tr>
		...
		?>
                &nbsp;&nbsp;
                <input name="fecha" readonly="true" type="text" id="fecha" style="background:#d9e6f0;font:tahoma; font-size:9px" value="<?=$f->fecha ?>" size="13" align="top" />
        ...
        onClick="mostrarInformacionExtra()"></td>
              <td width="5%" align="right"></td>
            </tr>
        </table></td>
      </tr>
      <tr>
        <td colspan="2" ><table width="677" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td width="10" class="Tablas">&nbsp;</td>
              <td width="46" class="Tablas">T. Flete:</td>
              <td width="142"><select name="lstflete" style="width:77px; font-size:9px" onChange="solicitarDatosConv(); calculartotales()">
                  <option value="0">Pagado</option>
                  <option value="1">Por Cobrar</option>
              </select></td>
              <td width="55">Entrega:</td>
              <td width="154"><select name="chocurre" id="chocurre" onchange="solicitarDatosConv(); if(document.all.restringiread.value==1){alerta('El destino tiene restringida la Entrega a Domicilio','¡Atencion!','chocurre'); this.value=1;}else{if(this.value==0){document.all.t_txtead.value = document.all.t_txteadh.value}else{document.all.t_txtead.value = '$ 0.00';}} calculartotales();" style="width:77px; font-size:9px">
                <option value="0">EAD</option>
                <option value="1">Ocurre</option>
              </select></td>
              <td width="78" class="Tablas">Cond. Pago:</td>
              <td width="127"><select name="lstpago" id="lstpago" style="width:70px; font-size:9px">
      ...
      <tr>
      	<td colspan="2">
        	<table width="679" border="0" cellpadding="0" cellspacing="0" align="">
            	<tr>
                	<td width="11">&nbsp;</td>
                	<td width="46">Origen</td>
                	<td width="141"><div id="nombresucursalorigen">&nbsp;</div></td>
                	<td width="55"><span class="Tablas">Destino:</span></td>
                	<td width="155"><input type="text" name="destino" readonly="true" id="destino" style="background:#d9e6f0;width:100px; font-size:9px" />
               	    <input type="hidden" name="destino_hidden" />
               	    <input type="hidden" name="npobdes" /></td>
                	<td width="78"><span class="Tablas">Suc. Destino:</span></td>
                	<td width="193"><input name="sucdestino" type="text" id="sucdestino" style="background:#d9e6f0;font:tahoma; font-size:9px" readonly value="<?=$destino?>" poblacion="" size="20" />
      ...
      <tr>
        <td colspan="2"><table width="664" border="0" align="center">
            <tr>
              <td width="630"><table width="658" border="1" align="left" cellpadding="0" cellspacing="0" bordercolor="#016193">
                  <tr bgcolor="#016193" style="color:#FFF">
                  ...
                  <tr>
                    <td><table width="100%" border="0" cellpadding="0" cellspacing="1">
                        <tr>
                          ...
                          <td width="55%" colspan="3">&nbsp;&nbsp;<span class="Tablas">R.F.C.:</span>
                              <input name="rem_rfc" readonly="true" type="text" style="background:#d9e6f0;font:tahoma; font-size:9px" value="<?=$rrfc ?>" size="24" /></td>
                        </tr>
                        <tr>
                          <td><span class="Tablas">Cliente:</span></td>
                          <td colspan="4"><table border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                <td><input name="rem_cliente" readonly="true" type="text" style="background:#d9e6f0;font:tahoma; font-size:9px" 
                    value="<?=$rcliente ?>" size="54" />                                </td>
                        ...
                        <tr>
                          ...
                          <td colspan="4"><table border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                <td width="153" height="16" id="celda_rem_calle"><input name="rem_calle" readonly="true" type="text" style="background:#d9e6f0;font:tahoma; font-size:9px" value="" size="35" />
                                    <input type="hidden" name="rem_direcciones"></td>
                                <td width="97"><span class="Tablas">Numero: </span><span class="Tablas">
                                  <input name="rem_numero" type="text" readonly="true" style=" width:50px; background:#d9e6f0;font:tahoma; font-size:9px" value="<?=$rnumero ?>" />
                                </span></td>
                              </tr>
                          </table></td>
                        </tr>
                        <tr>
                          ...
                          <td width="29%"><input name="rem_cp" readonly="true" type="text" style="background:#d9e6f0;font:tahoma; font-size:9px" value="<?=$rcp ?>" size="15" /></td>
                          <td colspan="3"><span class="Tablas">Colonia:&nbsp;&nbsp;
                                <input name="rem_colonia" type="text" readonly="true" style="background:#d9e6f0;font:tahoma; font-size:9px" value="<?=$rcolonia ?>" size="24" />
                          </span></td>
                        </tr>
                        <tr>
                          <td><span class="Tablas">Poblaci&oacute;n:</span></td>
                          <td colspan="4"><input name="rem_poblacion" readonly="true" type="text" style="background:#d9e6f0;font:tahoma; font-size:9px" value="<?=$rpoblacion ?>" size="25" />
                              <span class="Tablas">&nbsp;Tel&eacute;fono:
                                <input name="rem_telefono" type="text" readonly="true" style="background:#d9e6f0;font:tahoma; font-size:9px" value="<?=$rtelefono ?>" size="14" />
                            </span></td>
                        </tr>
                    </table></td>
                    <td><table width="100%" border="0" cellpadding="0" cellspacing="1">
                        <tr>
                          ...
                          <td width="55%" colspan="3">&nbsp;&nbsp;<span class="Tablas">R.F.C.:</span>
                              <input name="des_rfc" type="text" readonly="true" id="rrfc22" style="background:#d9e6f0;font:tahoma; font-size:9px" value="<?=$rrfc ?>" size="24" /></td>
                        </tr>
                        <tr>
                          <td colspan="4"><table border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                <td><input name="des_cliente" readonly="true" type="text" 
                  style="background:#d9e6f0;font:tahoma; font-size:9px" value="<?=$rcliente ?>" size="54" />                                </td>
                        ...
                        <tr>
                          <td colspan="4"><table border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                <td width="153" height="16" id="celda_des_calle"><input name="des_calle" readonly="true" type="text" style="background:#d9e6f0;font:tahoma; font-size:9px" value="" size="35" />
                                    <input type="hidden" name="des_direcciones"></td>
                                <td width="97"><span class="Tablas">Numero: </span><span class="Tablas">
                                  <input name="des_numero" type="text" readonly="true" style=" width:50px; background:#d9e6f0;font:tahoma; font-size:9px" value="<?=$rnumero ?>" />
                                </span></td>
                              </tr>
                          </table></td>
                        </tr>
                        <tr>
                          <td width="29%"><input name="des_cp" type="text" readonly="true" style="background:#d9e6f0;font:tahoma; font-size:9px" value="<?=$rcp ?>" size="15" /></td>
                          <td colspan="3"><span class="Tablas">Colonia:&nbsp;&nbsp;
                                <input name="des_colonia" type="text" readonly="true" style="background:#d9e6f0;font:tahoma; font-size:9px" value="<?=$rcolonia ?>" size="24" />
                          </span></td>
                        </tr>
                        <tr>
                          <td colspan="4"><input name="des_poblacion" readonly="true" type="text" style="background:#d9e6f0;font:tahoma; font-size:9px" value="<?=$rpoblacion ?>" size="25" />
                              <span class="Tablas">&nbsp;Tel&eacute;fono:
                                <input name="des_telefono" type="text" readonly="true" style="background:#d9e6f0;font:tahoma; font-size:9px" value="<?=$rtelefono ?>" size="14" />
                            </span></td>
                        </tr>
                    </table></td>
                  </tr>
              ...
              <td width="188"><table width="177" height="90" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td><table width="163" height="0" align="center" bordercolor="#016193">
                              <tr>
                                ...
                                <td width="40"><input name="txtocu" readonly="true" type="text" style="background:#d9e6f0;font:tahoma; font-size:9px" value="<?=$drfc ?>" size="5" />                                </td>
                                <td width="28" class="Tablas">EAD:</td>
                                <td width="34"><input name="txtead" readonly="true" type="text" style="background:#d9e6f0;font:tahoma; font-size:9px" value="<?=$drfc ?>" size="5" />
                  ...
                  <tr>
                    <td><table width="176" height="0" border="0" align="right" cellpadding="0" cellspacing="0" bordercolor="#016193">
                        ...
                        <tr>
                          <td><label>
                            <textarea name="txtrestrinccion" readonly style="width:170px; font-size:9px; background-color:#d9e6f0; text-transform:uppercase"></textarea>
      ...
      <tr>
        <td><table width="335" border="0" align="right" cellpadding="0" cellspacing="0">
            <tr>
              <td width="56" class="Tablas">T. Paquetes: </td>
              <td width="43" class="Tablas"><input name="totalpaquetes" type="text" readonly="true" style="background:#d9e6f0;font:tahoma; font-size:9px; width:40px" value="<?=$rcp ?>"/></td>
              <td width="51" class="Tablas">T. Peso Kg: </td>
              <td width="48" class="Tablas"><input name="totalpeso" type="text" readonly="true" style="background:#d9e6f0;font:tahoma; font-size:9px; width:40px" value="<?=$rcp ?>" /></td>
              <td width="61" class="Tablas">T. Volumen: </td>
              <td width="66" class="Tablas"><input name="totalvolumen" type="text" readonly="true" style="background:#d9e6f0;font:tahoma; font-size:9px; width:60px" value="<?=$rcp ?>" /></td>
            </tr>
        </table></td>
        <td width="48%" rowspan="2"><table width="320" border="1" align="left" cellpadding="0" cellspacing="0" bordercolor="#74B051">
            <tr>
            ...
            <tr>
              <td height="140"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td class="Tablas"><input name="flete" readonly="true" type="text" style="background:#d9e6f0;font:tahoma; font-size:9px; text-align:right" value="<?=$rrfc ?>" size="10" /></td>
                    <td class="Tablas">Excedente:</td>
                    <td class="Tablas"><input name="t_txtexcedente" readonly="true" type="text" style="background:#d9e6f0;font:tahoma; font-size:9px; text-align:right" value="<?=$rrfc ?>" size="10" /></td>
                  </tr>
                  <tr>
                    <td class="Tablas">&nbsp;&nbsp;Descuento:</td>
                    <td class="Tablas"><input readonly="true" name="t_txtdescuento1" type="text" style="background:#d9e6f0;font:tahoma; font-size:9px; text-align:right" value="<?=$rrfc ?>" size="2" onKeyPress="if(event.keyCode==13 && this.readOnly==false){ if(parseFloat(this.value)>parseFloat(document.all.pc_maximodescuento.value)){ this.value=document.all.pc_maximodescuento.value; alerta('El maximo descuento permitido es '+document.all.pc_maximodescuento.value+' %','¡Atencion!','t_txtdescuento1')} calcularDescuento()}else{return solonumeros(event);}" />
                        <input name="t_txtdescuento2" type="text" readonly="true" style="background:#d9e6f0;font:tahoma; font-size:9px; text-align:right" value="<?=$rrfc ?>" size="4" />
                    ...
                    <td class="Tablas"><input name="t_txtcombustible" readonly="true" type="text" style="background:#d9e6f0;font:tahoma; font-size:9px; text-align:right" value="<?=$rrfc ?>" size="10" /></td>
                  </tr>
                  <tr>
                    <td class="Tablas">&nbsp;&nbsp;EAD:</td>
                    <td class="Tablas"><input readonly="true" name="t_txtead" type="text" style="background:#d9e6f0;font:tahoma; font-size:9px; text-align:right" value="<?=$rrfc ?>" size="10" />
                        <input name="t_txteadh" type="hidden" />
                      <input name="t_txteadh2" type="hidden" /></td>
                    <td class="Tablas">Subtotal:</td>
                    <td class="Tablas"><input name="t_txtsubtotal" readonly="true" type="text" style="background:#d9e6f0;font:tahoma; font-size:9px; text-align:right" value="<?=$rrfc ?>" size="10" /></td>
                  </tr>
                  <tr>
                    <td class="Tablas">&nbsp;&nbsp;Recolecci&oacute;n:</td>
                    <td class="Tablas"><input readonly="true" name="t_txtrecoleccion" type="text" style="background:#d9e6f0;font:tahoma; font-size:9px; text-align:right" value="<?=$rrfc ?>" size="10" />
                        <input name="t_txtrecoleccionh" type="hidden" /></td>
                    <td class="Tablas">IVA:</td>
                    <td class="Tablas"><input name="t_txtiva" readonly="true" type="text" style="background:#d9e6f0;font:tahoma; font-size:9px; text-align:right" value="<?=$rrfc ?>" size="10" /></td>
                  </tr>
                  <tr>
                    <td width="24%" class="Tablas">&nbsp;&nbsp;Seguro:</td>
                    <td class="Tablas"><input readonly="true" name="t_txtseguro" type="text" style="background:#d9e6f0;font:tahoma; font-size:9px; text-align:right" value="<?=$rrfc ?>" size="10" /></td>
                    <td width="23%" class="Tablas">IVA Retenido: </td>
                    <td width="17%" class="Tablas"><input name="t_txtivaretenido" readonly="true" type="text" style="background:#d9e6f0;font:tahoma; font-size:9px; text-align:right" value="<?=$rrfc ?>" size="10" /></td>
                  </tr>
                  <tr>
                    <td class="Tablas">&nbsp;&nbsp;Otros:</td>
                    <td class="Tablas"><input name="t_txtotros" readonly="true" type="text" style="background:#d9e6f0;font:tahoma; font-size:9px; text-align:right" value="<?=$rrfc ?>" size="10" /></td>
                    <td class="Tablas">Total:</td>
                    <td class="Tablas"><input name="t_txttotal" readonly="true" type="text" style="background:#d9e6f0;font:tahoma; font-size:9px; text-align:right" value="<?=$rrfc ?>" size="10" /></td>
                  </tr>
                  <tr>
      ...
      <tr>
        <td width="52%" ><table border="0" align="right" cellpadding="0" cellspacing="0">
            <tr>
              <td width="318"><table width="339" height="140" border="0" align="right" cellpadding="0" cellspacing="0" bordercolor="#016193">
                  <tr>
                  ...
                  <tr>
                    <td valign="top"><table width="100%" height="76" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td class="Tablas" align="right"><input readonly="true" name="txtacuserecibo" type="text" style="background:#d9e6f0;font:tahoma; font-size:9px; text-align:right" value="<?=$rrfc ?>" size="8" />
                        ...
                        <tr>
                          ...
                          <td width="21%" class="Tablas" align="right"><input readonly="true" name="txtcod" type="text" style="background:#d9e6f0;font:tahoma; font-size:9px; text-align:right" value="<?=$rrfc ?>" size="8" />
                              <input name="txtcodh" type="hidden" />                          </td>
                        </tr>
                        <tr>
                          <td><input name="chkavisocelular" type="checkbox" style="width:8px; height:8px" value="SI" onClick="if(!this.checked){document.all.txtavisocelular2.readOnly=true; document.all.txtavisocelular2.style.backgroundColor='#d9e6f0'; document.all.txtavisocelular2.value='';document.all.txtavisocelular1.value=''; }else{document.all.txtavisocelular1.value=document.all.txtavisocelular1h.value;document.all.txtavisocelular2.readOnly=false; document.all.txtavisocelular2.style.backgroundColor='#FFFFFF'; document.all.txtavisocelular2.value=document.all.txtavisocelular2h.value;document.all.txtavisocelular2.focus();}  calculartotales();" /></td>
                          <td colspan="4" class="Tablas">Aviso Celular
                            <input name="txtavisocelular1" readonly="true" type="text" style="background:#d9e6f0;font:tahoma; font-size:9px; text-align:right" size="10" />
                              <input name="txtavisocelular1h" type="hidden" />
                              <input name="txtavisocelular2" readonly="true" type="text" style="background:#d9e6f0;font:tahoma; font-size:9px" value="<?=$rrfc ?>" size="10" />
               ...
               onClick="if(!this.checked){document.all.txtdeclarado.value='';document.all.txtdeclarado.readOnly=true; document.all.txtdeclarado.style.backgroundColor='#d9e6f0'; document.all.txtdeclarado.readOnly=true;}else{document.all.txtdeclarado.readOnly=false; document.all.txtdeclarado.style.backgroundColor='#FFFFFF'; document.all.txtdeclarado.readOnly=false;document.all.txtdeclarado.focus();} calculartotales();" /></td>
            ...
            <tr>
              <td colspan="2"><table width="616" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td width="211" class="Tablas"><input type="text" name="recibio" readonly="true" style="background:#d9e6f0;width:200px; font-size:9px; text-transform:uppercase" ></td>
                    <td width="75" class="Tablas">Fecha Entrega</td>
                    <td width="122" class="Tablas"><input type="text" name="fechaentrega" readonly="true" style="background:#d9e6f0;width:110px; font-size:9px" ></td>
                    <td width="38" class="Tablas">Factura</td>
                    <td width="120" class="Tablas"><input type="text" name="factura" readonly="true" style="background:#d9e6f0;width:110px; font-size:9px" /></td>
                  </tr>
              </table></td>
            </tr>
        </table></td>
