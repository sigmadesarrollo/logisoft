    ...
    <td height="13"><div align="center">
      <table width="510" border="0" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td width="118"><input name="folio" type="text" class="Tablas" id="folio" style="width:80px;background:#FFFF99" value="<?=$folio ?>" readonly=""/>
        ...
        <tr>
          ...
          <td><span class="Tablas"><img src="../img/Buscar_24.gif" width="24" height="23" align="absbottom" style="cursor:pointer" onClick=            "mostrarBuscador()"></span></td>
