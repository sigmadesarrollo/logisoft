<?
    ...
    if($_POST[accion]==3){
		...
		$s = "INSERT INTO facturacion SET facturaestado = 'GUARDADO', tipofactura='GENERAL', tipoguia='ventanilla',
		idsucursal='$_SESSION[IDSUCURSAL]',
		nombrecliente = '$_POST[nombrecliente]', rfc = '$_POST[rfc]', credito='NO',
		...
		excedente = '$_POST[excedente]',ead = '$_POST[ead]',recoleccion = '$_POST[recoleccion]',
		...
		total = '$_POST[total]',otroscantidad = '$_POST[otroscantidad]',
		...
		if($_POST[otrosmontofacturar]>0){
			...
			$arre_cliente['producto'][$var_contadordetalle]['preciounitario'] = $_POST[otrosimporte];
		   	...
		   	$arre_cliente['producto'][$var_contadordetalle]['importe'] = $_POST[otrossubtotal];
		}
