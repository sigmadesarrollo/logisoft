...
<script>
	...
	tabla1.setAttributes({
		nombre:"detalle",
		campos:[
			{nombre:"# CREDITO", medida:60, alineacion:"left",  datos:"credito"},
			{nombre:"CLIENTE", medida:100, alineacion:"left", datos:"cliente"},
			{nombre:"DIRECCION", medida:100, alineacion:"left", datos:"direccion"},
			{nombre:"LIMITE DE CREDITO", medida:100, tipo:"moneda", alineacion:"center", datos:"limitecredito"},
			{nombre:"MONTO CONSUMIDO", medida:100, tipo:"moneda", alineacion:"center", datos:"consumido"},
			{nombre:"MONTO VENCIDO", medida:100, tipo:"moneda", alineacion:"center", datos:"montovencido"},
			{nombre:"VENDEDOR ASIGNADO", medida:100, alineacion:"left", datos:"vendedorasigando"}			
		],
		filasInicial:15,
		alto:250,
		seleccion:true,
	...
	function obtenerDetalle(){		
		consultaTexto("resTabla1","consultasAlertas.php?accion=22&contador="+u.pag1_contador.value
		+"&s="+Math.random());
	}
	...
	function paginacion(movimiento){
		switch(movimiento){
			case 'primero':
				consultaTexto("resTabla1","consultasAlertas.php?accion=22&contador=0&s="+Math.random());
				break;
			case 'adelante':
				if(u.pag1_adelante.value==1){
					consultaTexto("resTabla1","consultasAlertas.php?accion=22&contador="+(parseFloat(u.pag1_contador.value)+1)					
					+"&s="+Math.random());
				}
				break;
			case 'atras':
			...
			case 'ultimo':
				...
				consultaTexto("resTabla1","consultasAlertas.php?accion=22&contador="+contador
				+"&s="+Math.random());
				break;
		}
	}
...
<form id="form1" name="form1" method="post" action="">
  <table width="710" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
    <tr>
      <td width="700" class="FondoTabla Estilo4">Cr&eacute;ditos Con Limites Saturados</td>
    </tr>
    <tr>
