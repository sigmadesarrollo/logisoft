...
<link  href="../../moduloDireccionSucursal/css/estilosclaseacordeon.css" rel="stylesheet" type="text/css">
	  	...
	  	<td align="left">
			...
			<ul class="acc" id="acc">
              ...
              <?
				...
				INNER JOIN permisos_grupospermisos AS pm ON permisos_modulos.id = pm.idpermiso
				...
				<div class="acc-section">
					...
					<div class="acc-content">
                    	...
                    	<?
							...
							WHERE permisos_modulos.grupo = $f->id
