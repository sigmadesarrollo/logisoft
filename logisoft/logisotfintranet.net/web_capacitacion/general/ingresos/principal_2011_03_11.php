...
<script>
	...
	window.onload = function (){
		...
		tabs.iniciar({
			...
			paginainicial:"principalingresos.php"
		...
		cn.crearNavegador();
			...
			contenidos:[
				...
				{nombre:"Ingresos por Guias Contado"},

				{nombre:"Ingresos por Cobranza"},

				{nombre:"Ingresos por Guias Entregadas"}
		...
		function disable(){
			...
			document.all.barratabs_contenedor_id1.disabled=true;	
		...
		function enable(){
			...
			document.all.barratabs_contenedor_id1.disabled=false;	
...
<form id="form1" name="form1" method="post" action="">
  ...
  <table width="600" height="496" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td height="29" align="center" class="FondoTabla Estilo4">Reporte Principal de Ingresos </td>
