...
function addReglement( $mode )
{
	...
	$this->SetFont( "Arial", "B", 10);
	$this->Cell(10,4, "EMISOR", 0, 0, "C");
	$this->SetXY( $r1 + ($r2-$r1)/2 -6 , $y1 + 5 );
	$this->SetFont( "Arial", "", 10);
...
function addReglement1( $mode )
{
	...
	$this->SetFont( "Arial", "B", 10);
	//$this->Cell(10,4, "EMISOR", 0, 0, "C");
	$this->SetXY( $r1 + ($r2-$r1)/2.7 -5 , $y1 + 5 );
	$this->SetFont( "Arial", "", 10);
	$this->Cell(10,15,$mode, 0,0, "C");
}
function addReglement2( $mode )
{
	...
	$this->SetFont( "Arial", "B", 10);
	//$this->Cell(10,4, "EMISOR", 0, 0, "C");
	$this->SetXY( $r1 + ($r2-$r1)/3.3 -5 , $y1 + 5 );
	$this->SetFont( "Arial", "", 10);
	$this->Cell(10,25,$mode, 0,0, "C");
}
function addReglement3( $mode )
{
	...
	$this->SetFont( "Arial", "B", 10);
	//$this->Cell(10,4, "EMISOR", 0, 0, "C");
	$this->SetXY( $r1 + ($r2-$r1)/3.4 -5 , $y1 + 5 );
	$this->SetFont( "Arial", "", 10);
	$this->Cell(10,35,$mode, 0,0, "C");
}
