...
<OBJECT ID="HuellaDigital"
CLASSID="CLSID:8CC1C994-579B-4FF3-9200-9FC9647C9C40">
</OBJECT>
<script>
	var huella;
	var u = document.all;	
	...
	window.onload = function(){
		...
		try{
			...
			huella.Inicializar();
			huella.ponerBaseDatos("pmm_dbpruebas","pmmintranet.net");
			verificarSiPuso();
		}catch(e){
			e=null;
		}
	...
	function seleccionarUnidad(idempleado){
		...
		for(var i=0; i<tabla1.getRecordCount();i++){			
			/*if((document.all['detalle_COND1'][i].value==idempleado || document.all['detalle_COND2'][i].value==idempleado || document.all['detalle_COND3'][i].value==idempleado) && (document.all['detalle_TIPO'][i].value == 1 || document.all['detalle_TIPO'][i].value == 3)){
				...
				info("Usuario encontrado","¡Atención!");
				var guardar = true;
	...
	function ponerPermiso(){
		...
		abrirVentanaFija('../buscadores_generales/logueo_permisos.php?modulo=llegadaUnidad&usuario=Admin&funcion=validarDatosLogueo',370, 500, 'ventana', 'Inicio de Sesión Secundaria');	
	}
...
<table width="495" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
  ...
  <tr>
    <td><table width="492" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td height="14" align="center" bgcolor="#016193" style="font-size:12px; color:#FFF">&nbsp;</td>
        <td width="118">&nbsp;</td>
        <td width="68">&nbsp;</td>
        <td width="187">&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        <td width="112" height="79" align="center" bgcolor="" style="background:#016193 url(../img/FondoHuella.gif) center no-repeat;">
        <img src="../img/huella_azul.jpg" width="47" height="56" id="imagenHuella" style="visibility:hidden">
        </td>
