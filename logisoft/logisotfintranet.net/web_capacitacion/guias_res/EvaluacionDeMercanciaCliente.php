...
tabla1.setAttributes({
	...
	function resSolicitarDatosConve(datos){
		...
		if(objeto.encontro=="0"){
			...
			info("El folio que desea utilizar esta bloqueado", "¡Atención!");
			u.NGuias.value = "";
		}
	}	
              ...
              <th width="612" height="64" scope="row"><table width="638" height="75" border="0" cellspacing="0" class="Tablas">
                ...
                <tr>
                  ...
                  <td colspan="2" class="Tablas">Destino:
                    <input name="country" type="text" class="Tablas" id="country" style="font-size:9px; text-transform:uppercase;background:#FFFF99" readonly="readonly"  value="<?=$country ?>" size="35" maxlength="60" autocomplete="array:desc" onKeyPress="if(event.keyCode==13){document.all.countryid.value=this.codigo; devolverDestino();}" onblur="if(this.value!=''){document.all.countryid.value = this.codigo; devolverDestino();}"></td></tr>
                <tr>
