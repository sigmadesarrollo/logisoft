...
<script>
	...
	function calcularservicios(){
		u = document.all;
			...
			//alert("xx");
			if(u.pc_recoleccion.value != "" && u.pc_recoleccion.value != " " && u.t_txtrecoleccion.value != "" && u.t_txtrecoleccion.value != "$ 0.00" && u.t_txtrecoleccionh.value=="0"){
...
<div class="content" style="width:830px">
  ...
  <div class="remi-desti">
    <div class="remi"> <img src="../css_ne/style/arrow.jpg" style="position:absolute; left:260px;"/>
      ...
      <input type="button" id="b_remitente_dir" value=" " class="add-btn" title="Agregar" onClick="mostrarCatClientes()"/>
      <br />
    ...
    <div class="desti">
      ...
      <input type="button" id="b_destinatario_dir" value=" " class="add-btn" title="Agregar" onClick="mostrarCatClientes()"/>
      <br />
...
<div id="<?=$nombreBuscador?>" style="position:absolute; display:; background-image:url(../img/fondo_nuevoBuscar.jpg); left: 89px; top: 1132px; width: 691px; height: 361px; z-index:999;">
      ...
      <table width="672" align="center" cellpadding="0" cellspacing="0" border="0" style="width:500px;">
          ...
          <tr>
            <td colspan="7" class="Tablas"><table width="200" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td class="Tablas"><input id="<?=$nombreBuscador?>_rdmoral" name="<?=$nombreBuscador?>_rdmoral" type="radio" value="SI" onClick="<?=$nombreBuscador?>_habilitar();" style="width:12px" />
                  Moral</td>
          ...
          <tr> 
            ...
            <td colspan="6" class="Tablas"><input name="<?=$nombreBuscador?>_numero" type="text" class="Tablas" id="<?=$nombreBuscador?>_numero" size="9" onblur="<?=$nombreBuscador?>_trim(document.getElementById('<?=$nombreBuscador?>_numero').value,'<?=$nombreBuscador?>_numero');" value="<?=$numero; ?>" onkeydown="" style="font:tahoma;font-size:9px; text-transform:uppercase"/></td>
          </tr>
          <tr> 
          ...
          <tr> 
            <td colspan="7" align="center" class="Tablas"><table width="666" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td><img src="../img/Buscar_24.gif" style="cursor:pointer"></td>
                </tr>
              <tr>
...
<div id="<?=$nombreBuscador?>_buscarColonia" style="position:absolute; display:; background-image:url(../img/fondo_nuevoBuscar.jpg); left: 722px; top: 1149px; width: 443px; height: 261px; z-index:1000;">
	<table width="421" height="254" class="FondoTabla" align="center">
    	<tr style="color:#FFF">
        	<td height="16">
            	Buscar Colonias
            </td>
        	...
        	<td height="230">
            	<table width="416">
                	<tr>
                        ...
                        <td width="153"><input type="text" name="<?=$nombreBuscador?>_buscaColonia" /></td>
                        <td width="48">Ciudad</td>
                        <td width="144"><input type="text" name="<?=$nombreBuscador?>_buscaCiudad" /></td>
                    </tr>
                	<tr>
...
<script>
	...
	function <?=$nombreBuscador?>_CodigoPostal(e,cp){
		...
		if((tecla==13 || tecla==9) && cp!=""){
			window.open("<?=$raiz?>buscadores_generales/consultasColonias.php?accion=1&cp="+cp+"&sid="+Math.random());
	...
	<?=$nombreBuscador?>_tabla1.setAttributes({
		...
		campos:[
			{nombre:"N_Colonia", medida:4, alineacion:"left", datos:"colonia"},
			{nombre:"N_Poblacion", medida:144, alineacion:"left", datos:"poblacion"},
			{nombre:"N_Cp", medida:69, alineacion:"left", tipo:"oculto", datos:"codigo"},
			{nombre:"N_Municipio", medida:144, alineacion:"left", tipo:"oculto", datos:"municipio"},
			{nombre:"N_Estado", medida:69, alineacion:"right", tipo:"oculto", datos:"estado"},
			{nombre:"N_Pais", medida:72, alineacion:"right", tipo:"oculto", datos:"pais"},
		],
		filasInicial:6,
		alto:100,
		seleccion:true,
