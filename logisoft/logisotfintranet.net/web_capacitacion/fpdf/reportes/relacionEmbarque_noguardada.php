<?	require('../fpdf.php');
	...
	$s = "SELECT GROUP_CONCAT(DISTINCT(sucursal)) sucursal FROM (
	...
	class PDF extends FPDF{
		...
		function ImprovedTable($header,$data,$fechaseleccionada){
			...
			for($ii=0;$ii<count($data);$ii++){
				...
				AND (gv.estado='ALMACEN ORIGEN' OR gv.estado='ALMACEN TRASBORDO') AND sg.fecha = '$fechaseleccionada'
				...
				AND (ge.estado='ALMACEN ORIGEN' OR ge.estado='ALMACEN TRASBORDO') AND sg.fecha = '$fechaseleccionada'
