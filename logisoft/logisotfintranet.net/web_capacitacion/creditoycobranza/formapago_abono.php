<?
	...
	$sq = "SELECT round(sum(ifnull(total,0) + ifnull(sobmontoafacturar,0) + ifnull(otrosmontofacturar,0)),2) AS total
    ...
    <table width="405" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
          ...
          <td height="147"><br><table width="362" border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td><input type="checkbox" onClick="verificarCheque(this.checked)" value="" <? if($spc->pagocheque==1){echo "disabled='true'";} ?>></td>
                  </tr>
                  <tr>
