...
<script>
	...
	tabla3.setAttributes({
		...
		campos:[
			...
			{nombre:"SUCURSAL", medida:140, alineacion:"center", datos:"prefijosucursal"},
			{nombre:"NORMALES", medida:130, tipo:"moneda", alineacion:"right",  datos:"normales"},
			{nombre:"PREPAGADAS", medida:130, tipo:"moneda", alineacion:"right",  datos:"prepagadas"},
			{nombre:"CONSIGNACION", medida:130, tipo:"moneda", alineacion:"right", datos:"consignacion"},
	...
	tabla4.setAttributes({
		...
		campos:[
			...
			{nombre:"TOTAL", medida:90, tipo:"moneda", onDblClick:"obtenerTotalTabla4", alineacion:"right", datos:"total"}
		],
		filasInicial:30,
		alto:250,
		seleccion:true,
	...
	tabla7.setAttributes({//PREPAGADAS SIN FACTURAR
		...
		campos:[
			{nombre:"SUCURSAL", medida:50, alineacion:"center", datos:"prefijosucursal"},
			{nombre:"# CLIENTE", medida:50, alineacion:"center", datos:"idcliente"},
			{nombre:"CLIENTE", medida:80, alineacion:"center", datos:"cliente"},
			{nombre:"Q GUIAS", medida:60, alineacion:"center", datos:"cantidad"},
			{nombre:"GUIAS", medida:300, alineacion:"center", datos:"pfolios"},
			{nombre:"FLETE", medida:40, tipo:"moneda", alineacion:"right", datos:"flete"},
			{nombre:"SOBREPESO", medida:5, tipo:"oculto", alineacion:"right", datos:"sobrepeso"},
			{nombre:"COSTO SEGURO", medida:9, tipo:"oculto", alineacion:"right", datos:"costoseguro"},
			{nombre:"EAD", medida:9, tipo:"oculto", alineacion:"right", datos:"costoead"},
	...
	tabla8.setAttributes({//CONSIGNACION SIN FACTURAR
		...
		campos:[
			...
			{nombre:"CLIENTE", medida:100, alineacion:"center",datos:"cliente"},
			{nombre:"IMPORTE POR FACTURAR", tipo:"moneda", medida:120, alineacion:"right",  datos:"porfacturar"},
			{nombre:"SOBREPESO", medida:70, tipo:"moneda", alineacion:"right", datos:"sobrepeso"},
			...
			{nombre:"TOTAL", medida:85, tipo:"moneda", alineacion:"right", datos:"total"}
		],
		filasInicial:30,
		alto:250,
		seleccion:true,
	...
	function paginacion2(movimiento){
		switch(movimiento){
			case 'primero':
				consultaTexto("resTabla3","consultas.php?accion=1&contador=0&s="+Math.random()
				+"&sucursal="+u.sucursal_hidden.value
				+"&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text);
				break;
			case 'adelante':
				if(u.pag3_adelante.value==1){
					consultaTexto("resTabla3","consultas.php?accion=1&contador="+(parseFloat(u.pag3_contador.value)+1)
					+"&sucursal="+u.sucursal_hidden.value
					+"&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text					
					+"&s="+Math.random());
				}
			...
			case 'ultimo':
				...
				consultaTexto("resTabla3","consultas.php?accion=1&contador="+contador
				+"&sucursal="+u.sucursal_hidden.value
				+"&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text				
				+"&s="+Math.random());
				break;
	...
	function obtenerTotalTabla4(){
		...
		consultaTexto("resTabla5","consultas.php?accion=5&sucursal="+v_suc1
		+"&cliente="+v_cliente
		+"&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text
		...
		switch(movimiento){
			...
			case 'adelante':
				if(u.pag8_adelante.value==1){
					consultaTexto("resTabla8","consultas.php?accion=8&contador="+(parseFloat(u.pag7_contador.value)+1)
					+"&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text					
					+"&sucursal="+u.sucursal_hidden.value
					+"&s="+Math.random());
				}
	...
	function obtenerVigentes1(){
		...
		consultaTexto("resTabla10","consultas.php?accion=10&sucursal="+((v_suc3!="")?v_suc3:u.sucursal_hidden.value)
		+"&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text
    ...
    function obtenerVencidos1(){
		...
		consultaTexto("resTabla11","consultas.php?accion=11&sucursal="+((v_suc4!="")?v_suc4:u.sucursal_hidden.value)
		+"&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text
		...
		switch(movimiento){
			...
			case 'adelante':
				if(u.pag13_adelante.value==1){
					consultaTexto("resTabla13","consultas.php?accion=13&contador="+(parseFloat(u.pag12_contador.value)+1)
					+"&cliente="+((v_clien10!="")?v_clien10:v_clien11)
					+"&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text					
					+"&s="+Math.random());
				}
	...
	function imprimirReporte(tipo){
		...
		switch (tipo){
			...
			case 10:
				window.open(v_dir+"convenioExcel.php?accion=1&vigentes=s&titulo=CONVENIOS VIGENTES&sucursal="+((v_suc3!="")?v_suc3:u.sucursal_hidden.value)
				+"&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text+"&val="+Math.random());
			break;
			
			case 11:
				window.open(v_dir+"convenioExcel.php?accion=1&vencidos=s&titulo=CONVENIOS VENCIDOS&sucursal="+((v_suc4!="")?v_suc4:u.sucursal_hidden.value)
				+"&fecha="+u.cmbfecha.options[u.cmbfecha.selectedIndex].text+"&val="+Math.random());
			break;
  ...
  <tr>
    <td colspan="6"><table width="100%" height="16" border="0" cellpadding="0" cellspacing="0" class="Tablas">
      ...
      <tr>
        ...
        <td width="117" align="right"><div class="ebtn_imprimir" onclick="imprimirReporte(3)"></div></td>
      </tr>
    </table></td>
  </tr>
</table>
