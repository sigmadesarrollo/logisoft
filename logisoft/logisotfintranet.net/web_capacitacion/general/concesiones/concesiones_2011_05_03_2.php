...
<div style="position:absolute; left: 2px; top: 24px; width: 621px; visibility:visible;" id="tab_tab_id0">
	...
	<tr>
      <td colspan="2" align="right">
	  	TOTAL:<input name="totales1" type="text" class="Tablas" id="totales1" readonly style="background-color:#FFFF99; text-align:right;">
	  </td>
    </tr>
  </table>
</div>
...
<tr>
	...
	<tr>
      <td align="right">TOTAL COMISION:
	  	<input name="total2" type="text" class="Tablas" id="total2" readonly style="background-color:#FFFF99; text-align:right;">
	  </td>
	  <td align="right">TOTAL GENERAL:
	  	<input name="totales2" type="text" class="Tablas" id="totales2" readonly style="background-color:#FFFF99; text-align:right;">
	  </td>
    </tr>
  </table>
</div>
...
<tr>
   ...
   <tr>
	...
	<tr>
	  <td align="right">TOTAL COMISION:
	  	<input name="total3" type="text" class="Tablas" id="total3" readonly style="background-color:#FFFF99; text-align:right;">
	  </td>
      <td align="right">TOTAL GENERAL:
	  	<input name="totales3" type="text" class="Tablas" id="totales3" readonly style="background-color:#FFFF99; text-align:right;">
	  </td>
    </tr>
  </table>
</div>
