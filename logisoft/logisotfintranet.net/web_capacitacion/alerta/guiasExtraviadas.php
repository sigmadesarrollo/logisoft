...
<script>
	...
	tabla1.setAttributes({
		...
		campos:[
			...
			{nombre:"REMITENTE", medida:150, alineacion:"center", datos:"remitente"},
			{nombre:"DESTINATARIO", medida:150, alineacion:"center", datos:"destinatario"},
			{nombre:"SUC. DESTINO", medida:70, alineacion:"center", datos:"destino"},
			{nombre:"FEC. EMBARQUE", medida:80, alineacion:"center", datos:"fechaembarque"},
			{nombre:"FEC. RECEPCION", medida:80, alineacion:"center", datos:"fecharecepcion"},
			{nombre:"F. REPT. FALTANTES", medida:100, alineacion:"center", datos:"foliodano"}
		],
		filasInicial:20,
		alto:250,
		seleccion:true,
	...
	function obtenerDetalle(){		
		consultaTexto("resTabla1","consultasAlertas.php?accion=11&contador="+u.pag1_contador.value
		+"&s="+Math.random());
	}
	...
	function paginacion(movimiento){
		switch(movimiento){
			case 'primero':
				consultaTexto("resTabla1","consultasAlertas.php?accion=11&contador=0&s="+Math.random());
				break;
			case 'adelante':
				if(u.pag1_adelante.value==1){
					consultaTexto("resTabla1","consultasAlertas.php?accion=11&contador="+(parseFloat(u.pag1_contador.value)+1)					
					+"&s="+Math.random());
				}
				break;
			case 'atras':
			...
			case 'ultimo':
				...
				consultaTexto("resTabla1","consultasAlertas.php?accion=11&contador="+contador
				+"&s="+Math.random());
				break;
		}
	}
...
<form id="form1" name="form1" method="post" action="">
  <table width="800" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
    <tr>
      <td class="FondoTabla">GUIAS EXTRAVIADAS  </td>
    </tr>
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><div id="txtDir" style=" height:280px; width:790px; overflow:auto" align="left">
