...
<table width="419" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
  ...
  <tr>
    ...
    <td width="554" class="FondoTabla Estilo4">REPORTE DE RECUPERACI&Oacute;N CARTERA</td>
...
<script>
	...
	parent.frames[1].document.getElementById('titulo').innerHTML = 'REPORTE RECUPERACIÓN DE CARTERA';
