...
function Limpiar(){
	...
	document.all.restringir.checked=false;
...
abrirVentanaFija('buscarcatservicio.php', 550, 450, 'ventana', 'Busqueda')
    ...
    <tr>
      ...
      <td><table width="310" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
        ...
        <tr>
          ...
          <td class="FondoTabla">CAT&Aacute;LOGO SERVICIOS</td>
          ...
          <td><br><table width="309" border="0" align="center">
            ...
            <tr>
              ...
              <td width="159">
                ...
                &nbsp;<img src="../../img/Buscar_24.gif" alt="Buscar" width="24" height="23" align="absbottom" style="cursor:pointer" onClick="abrirVentanaFija('buscarcatservicio.php', 600, 500, 'ventana', 'Busqueda')"></td>
