...
<style>
	...
	<table width="1176" border="0" cellpadding="1" cellspacing="0">
    	...
    	<tr>
    	  ...
    	  <td colspan="9">ENTREGAS ESPECIALES EAD</td>
   	  </tr>
    	<tr>
    	  <td></td>
    	...
    	<tr>
    	  <td></td>
    	  <td colspan="9" align="left"><?=date("d/m/Y");?></td>
   	  </tr>
    	<tr>
    	  <td height="9px"></td>
    	  <td width="72">&nbsp;</td>
    	...
    	<tr>
    	      ...
    	      <td colspan="5" align="left" class="cabecera" >ORIGENDESTINOEMISIONCANCELACI&Oacute;NIMPORTE</td>
    	    ...
    	    <?
					$s = "SELECT e.folio, DATE_FORMAT(e.fechaead,'%d/%m/%Y') AS fechaespecial,
					...
					WHERE e.fechaespecial BETWEEN ".cambiaf_a_mysql($_GET[inicio])." AND ".cambiaf_a_mysql($_GET[fin])."
					".(($_SESSION[IDSUCURSAL]!=1)? " AND e.sucursal = $_GET[sucursal]" : "")."
					UNION
    	    ...
    	    <tr>
    	      ...
    	      <td colspan="5" align="left"><?=$f->persona?></td>
