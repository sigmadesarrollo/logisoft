...
function pedirDatos(zonai,zonaf,intzon,tarifai,tarifaf,inttarifa,folio){
	//donde se mostrará el formulario con los datos
                 

	divFormulario = document.getElementById('detalle');
        divFormulario.innerHTML= '<img src="anim.gif">';
	...
	ajax.send("vpzonai="+zonai+"&vpzonaf="+zonaf+"&vpintzon="+intzon+"&vptarifai="+tarifai+"&vptarifaf="+tarifaf+"&vpinttarifa="+inttarifa+"&vpfolio="+folio);
}