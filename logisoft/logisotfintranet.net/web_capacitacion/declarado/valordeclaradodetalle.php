...
<script>
	...
	tabla1.setAttributes({
		...
		campos:[			
			...
			{nombre:"NO.GUIAS", medida:70, alineacion:"left", datos:"guias"},			
			{nombre:"FECHA GUIA", medida:80, alineacion:"left", datos:"fecha"},
			{nombre:"REMITENTE", medida:160, alineacion:"left", datos:"remitente"},
			{nombre:"DESTINATARIO", medida:160, alineacion:"left", datos:"destinatario"},
			{nombre:"VALOR DECLARADO", medida:100, alineacion:"left", tipo:"moneda" , datos:"valordeclarado"},
			{nombre:"SEGURO", medida:100, alineacion:"left", tipo:"moneda" ,datos:"seguro"}
		],
		filasInicial:30,
		alto:150,
		seleccion:true,
	...
	function ObtenerDetalle(){
		...
		if (u.sucursal.value==""){
			...
			alerta("Debe capturar "+((u.fecha.value=="")? " fecha inicio" : "fecha fin"),"¡Atención!",((u.fecha.value=="")? "fecha" : "fecha2" ));	 	
		}else if (f2 < f1){
			alerta("La fecha final debe ser mayor a la fecha de inicio","¡Atención!","fecha2");
		}else{
			...
			consultaTexto("mostrardetalle","valordeclaradodetalle_con.php?accion=1"+sucursal+fecha+fecha2);	
		}
	}
	...
	function imprimirReporte(tipo){
		...
		if(tipo == "Archivo"){
			if(document.URL.indexOf("web/")>-1){
				window.open("http://www.pmmintranet.net/web/reportes/valorDeclaradoDetalle.php?fechainicio="+u.fecha.value
				+"&fechafin="+u.fecha2.value+"&sucursal="+u.sucursal_hidden.value);
			
			}else if(document.URL.indexOf("web_capacitacion/")>-1){
			window.open("http://www.pmmintranet.net/web_capacitacion/reportes/valorDeclaradoDetalle.php?fechainicio="+u.fecha.value
				+"&fechafin="+u.fecha2.value+"&sucursal="+u.sucursal_hidden.value);
			
			}else if(document.URL.indexOf("web_pruebas/")>-1){
				window.open("http://www.pmmintranet.net/web_pruebas/reportes/valorDeclaradoDetalle.php?fechainicio="+u.fecha.value
				+"&fechafin="+u.fecha2.value+"&sucursal="+u.sucursal_hidden.value);
			}
			
		}else{
			if(document.URL.indexOf("web/")>-1){		
				window.open("http://www.pmmintranet.net/web/fpdf/reportes/valorDeclaradoDetalle.php?fechainicio="+u.fecha.value
				+"&fechafin="+u.fecha2.value+"&sucursal="+u.sucursal_hidden.value);
						
			}else if(document.URL.indexOf("web_capacitacion/")>-1){
			window.open("http://www.pmmintranet.net/web_capacitacion/fpdf/reportes/valorDeclaradoDetalle.php?fechainicio="+u.fecha.value
				+"&fechafin="+u.fecha2.value+"&sucursal="+u.sucursal_hidden.value);
			
			}else if(document.URL.indexOf("web_pruebas/")>-1){
				window.open("http://www.pmmintranet.net/web_pruebas/fpdf/reportes/valorDeclaradoDetalle.php?fechainicio="+u.fecha.value
				+"&fechafin="+u.fecha2.value+"&sucursal="+u.sucursal_hidden.value);
			}
		}
	}
...
<br>
<table width="713" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
  <tr>
    <td width="1496" class="FondoTabla Estilo4">VALOR DECLARADO DETALLE</td>
  </tr>
  <tr>
    <td><table width="712" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="563"> Sucursal<span class="Tablas">
        ...
        <td width="149">&nbsp;</td>
            ...
            <tr>
              <td>Fecha Inicio
                ...
                <img src="../img/calendario.gif" alt="Alta" width="25" height="25" align="absbottom" style="cursor:pointer" title="Calendario" onclick="displayCalendar(document.all.fecha,'dd/mm/yyyy',this)" /> </span> Fecha Fin
        ...
        <td><div align="center"><span class="Estilo6 Tablas"><img id="img_refrescar" src="../img/Boton_Refrescar.gif" width="74" height="20" align="absbottom" style="cursor:pointer" onclick="ObtenerDetalle();" /></span></div></td>
      </tr>
          ...
          <tr>
       <td align="right"></td>
        <td align="right"><img id="img_refrescar" src="../img/Boton_Imprimir.gif" width="74" height="20" align="absbottom" style="cursor:pointer" onclick="abrirVentanaFija('../buscadores_generales/formaImpresion.php?funcion=imprimirReporte', 300, 230, 'ventana', 'Busqueda')" /></td>
      </tr>
      <tr align="center">
