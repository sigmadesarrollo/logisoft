...
<script>
	...
	tabla1.setAttributes({
		nombre:"detalle",
		campos:[			
			{nombre:"SUCURSAL", 		medida:150, alineacion:"center", datos:"sucursal"},
			{nombre:"FOLIO INICIAL", 	medida:250, alineacion:"center", datos:"folioinicial"},
			{nombre:"FOLIO FINAL", 		medida:250, alineacion:"center", datos:"foliofinal"}
		],
		filasInicial:15,
		alto:250,
		seleccion:true,
	...
	function obtenerDetalle(){		
		consultaTexto("resTabla1","reportePrecintosAsignados_con.php?accion=1&contador="+u.pag1_contador.value
		+"&s="+Math.random());
	}
	...
	function paginacion(movimiento){
		switch(movimiento){
			case 'primero':
				consultaTexto("resTabla1","reportePrecintosAsignados_con.php?accion=1&contador=0&s="+Math.random());
				break;
			case 'adelante':
				if(u.pag1_adelante.value==1){
					consultaTexto("resTabla1","reportePrecintosAsignados_con.php?accion=1&contador="+(parseFloat(u.pag1_contador.value)+1)					
					+"&s="+Math.random());
				}
				break;
			case 'atras':
			...
			case 'ultimo':
				...
				consultaTexto("resTabla1","reportePrecintosAsignados_con.php?accion=1&contador="+contador
				+"&s="+Math.random());
				break;
		}
	}
...
<form id="form1" name="form1" method="post" action="">
  <table width="620" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
    <tr>
      <td class="FondoTabla">Historial Precintos Asignados </td>
    </tr>
    <tr>
