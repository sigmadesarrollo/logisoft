...
<script>
	...
	var botonesdesguardar = '<img src="../img/Boton_Imprimir.gif" onclick="imprimir()" style="cursor:hand">&nbsp;&nbsp;<img src="../img/Boton_Nuevo.gif" style="cursor:hand" onClick="limpiar_evaluacion();limpiar_destinatario();limpiar_remitente();parent.frames[4].document.all.foliobusqueda.value = \'\';">';

	var botonesconsulta = '<img src="../img/Boton_Imprimir.gif" onclick="imprimir()" style="cursor:hand">&nbsp;<img src="../img/Boton_Cancela_Guia.gif" style="cursor:hand" onClick="cancelarGuia()">&nbsp;<img src="../img/Boton_Nuevo.gif" style="cursor:hand" onClick="limpiar_evaluacion();limpiar_destinatario();limpiar_remitente();bloquear(false); parent.frames[4].document.all.foliobusqueda.value = \'\';">';
	...
	function imprimir(){
		...
		window.open("imprimiretiquetaguia.php?codigo="+parent.frames[4].document.all.folioSeleccionado.innerHTML,"1","");
	...
	function cambiarImpresora1(){
		...
		window.open("imprimiretiquetapaquete.php?codigo="+parent.frames[4].document.all.folioSeleccionado.innerHTML,"2","");
	...
	function paraConvenio(datos){
		...
		if((u.idremitente.value!="" && u.lstflete.value==0) || (u.iddestinatario.value!="" && u.lstflete.value==1) || (u.idremitente.value!="" && u.iddestinatario.value != "")){
				...
				consultaTexto('obtenerMecanciaConvenio',"guia_consulta_conv.php?accion=1&idsucdestino="+u.sucdestino_hidden.value+"&fevaluacion="+u.folioevaluacion.value
	...
	function cancelarForanea(){
		...
		document.location.href = "guia_cancsust.php?funcion=solicitarGuiaCan('"+parent.frames[4].document.all.folioSeleccionado.innerHTML+"');"
...
<script language="javascript" type="text/javascript" src="../estilosform/niceforms.js"></script>

<style type="text/css" media="screen">@import url(../estilosform/niceforms-default.css);</style>
...
<table width="601" border="1" cellpadding="0" cellspacing="0" bordercolor="#016193">
  ...
  <tr>
    ...
    <td class="FondoTabla Estilo3">Datos Generales </td>
  ...
  <tr>
    ...
    <td><table width="600" border="0" align="left" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        onClick="abrirVentanaFija('informacionextra.php?tipo=1&folio='+parent.frames[4].document.all.folioSeleccionado.innerHTML, 625, 418, 'ventana', 'Detalle')"></td>
