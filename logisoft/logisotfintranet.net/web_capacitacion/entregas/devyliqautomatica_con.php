<?	session_start();
	...
	if($_GET[accion]==1){
		...
		if(mysql_num_rows($r)>0){
			...
			WHERE reparto = '$_GET[idreparto]' AND sucursal = '$_SESSION[IDSUCURSAL]' AND gv.fechaentrega = current_date)
			UNION
			...
			WHERE reparto = '$_GET[idreparto]' AND sucursal = '$_SESSION[IDSUCURSAL]' AND ge.fechaentrega = current_date)";
