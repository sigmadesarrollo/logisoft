...
<?
	...
	if($_GET[tipo]==1){//GUIAS DE VENTANILLA
		...
		IF(gv.condicionpago='0','CREDITO','CONTADO') AS condicionpago, gv.observaciones
		...
		gv.tipopago AS condicionpago, gv.observaciones
		...
		csd.poblacion AS dpoblacion, csd.telefono AS dtelefono, gv.observaciones
...
<tr>
      ...
      <tr>
        ...
        <table width="228" border="0" cellpadding="0" cellspacing="0">
        	<tr>
            	<td height="19" class="texto_bold" valign="top">GUIA</td>
            </tr>
        </table>
        	<?
   	  ...
   	  <tr>
               	<td width="57"><img src="../img/logopmmazul.png" width="52" height="49" /></td>
                    <td width="206" class="texto_normal5">ENTREGAS PUNTUALES <br />
                    S DE RL DE CV
                    <br />
					av. benemerito de las americas 301 <BR /> col. palos prietos
                    <br />
                    MAZATLAN SINALOA
                    <br />
                    epu1004244x2
      ...
      <table width="263" border="0" cellpadding="0" cellspacing="0">
		...
		?>
        <tr>
   	    <td colspan="4"><font class="texto_bold2">OBS:</font> <?=$f->observaciones?></td>
   	    </tr>
	  <tr>
