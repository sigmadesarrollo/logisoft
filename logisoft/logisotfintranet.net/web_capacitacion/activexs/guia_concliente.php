                  ...
                  <table width="651" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td style="text-align:center">
                        <img src="<?=$raiz?>img/Boton_Guardar.gif" />
                      </td>
                      </tr>
                  </table></td>
                </tr>
    	...
    	<tr style="color:#FFF">
        	<td height="16">
            	<table width="415" border="0" cellpadding="0" cellspacing="0">
                	<tr>
		            	<td width="367">Buscar Colonias</td>
                        <td width="48">Cerrar</td>
                    </tr>
                </table>
          </td>
        </tr>
        <tr style="background-color:#FFF">
        	<td height="230">
            	<table width="416">
                	...
                	<tr>
                	  <td height="181" colspan="5" style="background-color:#000">
...
<script>
	...
	<?=$nombreBuscador?>_tabla1.setAttributes({
		...
		campos:[
			...
			{nombre:"N_Cp", medida:4, alineacion:"left", tipo:"oculto", datos:"codigo"},
	...
	function <?=$nombreBuscador?>_ponerColonia(){
		...
		document.getElementById('<?=$nombreBuscador?>_cp').value=fila.codigo; 
