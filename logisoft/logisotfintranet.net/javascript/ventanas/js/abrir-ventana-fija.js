function abrirVentanaFija(pagina, ancho, alto, nombre, titulo, alcerrar) {

	if(alcerrar==undefined){
		alcerrar="";
	}
	...
	var src = var_retroceder+'../javascript/ventanas/img/ventana/';
	...
	var onClick = 'onclick="'+alcerrar+'VentanaModal.cerrar();"';
