<?	header('Content-type: application/vnd.ms-excel');
	...
	WHERE gv.id like '%A' AND  gv.tipoflete = 0 AND gv.condicionpago = 1 AND gv.idsucursalorigen = ".$_GET[sucursal]." 
	AND gv.fecha BETWEEN '".cambiaf_a_mysql($_GET[fechainicio])."' AND '".cambiaf_a_mysql(((!empty($_GET[fechafin]))?$_GET[fechafin]:$_GET[fechainicio]))."'
	AND gv.estado<>'CANCELADO' ORDER BY gv.idusuario";
	...
	WHERE gv.id like '%A' AND  gv.tipoflete = 1 AND gv.condicionpago = 0 AND gv.idsucursalorigen = ".$_GET[sucursal]." 
	AND gv.fecha BETWEEN '".cambiaf_a_mysql($_GET[fechainicio])."' AND '".cambiaf_a_mysql(((!empty($_GET[fechafin]))?$_GET[fechafin]:$_GET[fechainicio]))."'
	AND gv.estado<>'CANCELADO' ORDER BY gv.idusuario";
	...
	WHERE gv.id like '%A' AND  gv.tipoflete = 1 AND gv.condicionpago = 1 AND gv.idsucursalorigen = ".$_GET[sucursal]." 
	AND gv.fecha BETWEEN '".cambiaf_a_mysql($_GET[fechainicio])."' AND '".cambiaf_a_mysql(((!empty($_GET[fechafin]))?$_GET[fechafin]:$_GET[fechainicio]))."'
	AND gv.estado<>'CANCELADO' ORDER BY gv.idusuario";
	...
	$criterioprepagadascontado = "SELECT CONCAT('Fact-',f.folio) AS guia, DATE_FORMAT(se.fecha,'%d/%m/%Y') AS fecha,
	CONCAT_WS(' ', cc.nombre,cc.paterno,cc.materno) AS cliente,
	cs.prefijo AS destino, se.total AS importe, se.idusuario,
	CONCAT_WS(' ',ce.nombre,ce.apellidopaterno,ce.apellidomaterno) AS empleado
	FROM facturacion f
	INNER JOIN solicitudguiasempresariales se ON f.folio = se.factura
	INNER JOIN catalogosucursal cs ON f.idsucursal = cs.id
	INNER JOIN catalogocliente cc ON se.idcliente = cc.id
	LEFT JOIN catalogoempleado ce ON se.idusuario = ce.id
	WHERE se.prepagada='SI' AND se.estado='GUARDADA' AND f.facturaestado='GUARDADO' AND
	se.fecha BETWEEN '".cambiaf_a_mysql($_GET[fechainicio])."' AND '".cambiaf_a_mysql(((!empty($_GET[fechafin]))?$_GET[fechafin]:$_GET[fechainicio]))."'
	AND se.condicionpago='CONTADO' AND f.idsucursal = ".$_GET[sucursal]." AND se.factura<>0 ORDER BY se.idusuario";	
	...
	$criterioprepagadascredito = "SELECT CONCAT('Fact-',f.folio) AS guia, DATE_FORMAT(se.fecha,'%d/%m/%Y') AS fecha,
	CONCAT_WS(' ', cc.nombre,cc.paterno,cc.materno) AS cliente,
	cs.prefijo AS destino, se.total AS importe, se.idusuario,
	CONCAT_WS(' ',ce.nombre,ce.apellidopaterno,ce.apellidomaterno) AS empleado
	FROM facturacion f
	...
	WHERE se.prepagada='SI' AND se.estado='GUARDADA' AND f.facturaestado='GUARDADO' AND 
	se.fecha BETWEEN '".cambiaf_a_mysql($_GET[fechainicio])."' AND '".cambiaf_a_mysql(((!empty($_GET[fechafin]))?$_GET[fechafin]:$_GET[fechainicio]))."'
	AND se.condicionpago='CREDITO' AND f.idsucursal = ".$_GET[sucursal]." AND se.factura<>0 ORDER BY se.idusuario";	
	...
	$criterioconsignacioncontado = "SELECT fd.folio, DATE_FORMAT(f.fecha,'%d/%m/%Y') AS fecha,
	CONCAT_WS(' ', cc.nombre,cc.paterno,cc.materno) AS cliente,
	cs.prefijo AS destino, IFNULL(fd.total,0) AS importe,
	...
	WHERE f.tipoguia='empresarial' AND f.credito = 'NO' AND f.tipofactura='NORMAL' AND f.facturaestado='GUARDADO' 
	AND fd.tipoguia='CONSIGNACION' AND f.idsucursal = ".$_GET[sucursal]."
	AND f.fecha BETWEEN '".cambiaf_a_mysql($_GET[fechainicio])."' AND '".cambiaf_a_mysql(((!empty($_GET[fechafin]))?$_GET[fechafin]:$_GET[fechainicio]))."'
	...
	$criterioconsignacioncredito = "SELECT fd.folio, DATE_FORMAT(f.fecha,'%d/%m/%Y') AS fecha,
	CONCAT_WS(' ', cc.nombre,cc.paterno,cc.materno) AS cliente,
	cs.prefijo AS destino, IFNULL(fd.total,0) AS importe,
	f.idusuario, CONCAT_WS(' ',ce.nombre,ce.apellidopaterno,ce.apellidomaterno) AS empleado
	FROM facturacion f
	...
	INNER JOIN catalogocliente cc ON f.cliente = cc.id
	LEFT JOIN catalogoempleado ce ON f.idusuario = ce.id
	WHERE f.tipoguia='empresarial' AND f.credito = 'SI' AND f.tipofactura='NORMAL' AND f.facturaestado='GUARDADO' AND fd.tipoguia='CONSIGNACION' 
	...
	$criteriofacturacionsobrepesocontado = "SELECT f.folio, DATE_FORMAT(f.fecha,'%d/%m/%Y') AS fecha,
	CONCAT_WS(' ', cc.nombre,cc.paterno,cc.materno) AS cliente,
	cs.prefijo AS destino, fd.total AS importe, f.idusuario, 
	CONCAT_WS(' ',ce.nombre,ce.apellidopaterno,ce.apellidomaterno) AS empleado
	FROM facturacion f
	...
	INNER JOIN catalogocliente cc ON f.cliente = cc.id
	LEFT JOIN catalogoempleado ce ON f.idusuario = ce.id
	WHERE f.credito = 'NO' AND f.tipofactura='NORMAL' AND f.idsucursal = ".$_GET[sucursal]." AND f.facturaestado='GUARDADO'
	AND f.fecha BETWEEN '".cambiaf_a_mysql($_GET[fechainicio])."' AND '".cambiaf_a_mysql(((!empty($_GET[fechafin]))?$_GET[fechafin]:$_GET[fechainicio]))."'
	...
	$criteriofacturacionsobrepesocredito = "SELECT f.folio, DATE_FORMAT(f.fecha,'%d/%m/%Y') AS fecha,
	CONCAT_WS(' ', cc.nombre,cc.paterno,cc.materno) AS cliente,
	cs.prefijo AS destino, fd.total AS importe, f.idusuario, 
	CONCAT_WS(' ',ce.nombre,ce.apellidopaterno,ce.apellidomaterno) AS empleado
	FROM facturacion f
	...
	INNER JOIN catalogocliente cc ON f.cliente = cc.id
	LEFT JOIN catalogoempleado ce ON f.idusuario = ce.id
	WHERE f.credito = 'SI' AND f.tipofactura='NORMAL' AND f.idsucursal = ".$_GET[sucursal]." AND f.facturaestado='GUARDADO'
	AND f.fecha BETWEEN '".cambiaf_a_mysql($_GET[fechainicio])."' AND '".cambiaf_a_mysql(((!empty($_GET[fechafin]))?$_GET[fechafin]:$_GET[fechainicio]))."'
	AND fd.concepto LIKE '%EXCEDENTE%'
	ORDER BY f.idusuario";
	...
	$criteriofacturacionvalordeclaradocontado = "SELECT f.folio, DATE_FORMAT(f.fecha,'%d/%m/%Y') AS fecha,
	CONCAT_WS(' ', cc.nombre,cc.paterno,cc.materno) AS cliente,
	cs.prefijo AS destino, fd.total AS importe, f.idusuario, 
	CONCAT_WS(' ',ce.nombre,ce.apellidopaterno,ce.apellidomaterno) AS empleado
	FROM facturacion f
	...
	$criteriofacturacionvalordeclaradocredito = "SELECT f.folio, DATE_FORMAT(f.fecha,'%d/%m/%Y') AS fecha,
	CONCAT_WS(' ', cc.nombre,cc.paterno,cc.materno) AS cliente,
	cs.prefijo AS destino, fd.total AS importe, f.idusuario, 
	CONCAT_WS(' ',ce.nombre,ce.apellidopaterno,ce.apellidomaterno) AS empleado
	FROM facturacion f
	...
	$criteriofacturacionotrosconceptoscontado = "SELECT f.folio, DATE_FORMAT(f.fecha,'%d/%m/%Y') AS fecha,
	CONCAT_WS(' ', cc.nombre,cc.paterno,cc.materno) AS cliente,
	...
	INNER JOIN catalogocliente cc ON f.cliente = cc.id
	LEFT JOIN catalogoempleado ce ON f.idusuario = ce.id
	WHERE f.idsucursal = ".$_GET[sucursal]." AND f.facturaestado='GUARDADO' AND f.tipofactura='NORMAL' AND f.credito = 'NO' AND f.otrosmontofacturar > 0
	AND f.fecha BETWEEN '".cambiaf_a_mysql($_GET[fechainicio])."' AND '".cambiaf_a_mysql(((!empty($_GET[fechafin]))?$_GET[fechafin]:$_GET[fechainicio]))."'
	ORDER BY f.idusuario";
	...
	$criteriofacturacionotrosconceptoscredito = "SELECT f.folio, DATE_FORMAT(f.fecha,'%d/%m/%Y') AS fecha,
	CONCAT_WS(' ', cc.nombre,cc.paterno,cc.materno) AS cliente,
	cs.prefijo AS destino, f.otrosmontofacturar AS importe, f.idusuario, 
	CONCAT_WS(' ',ce.nombre,ce.apellidopaterno,ce.apellidomaterno) AS empleado FROM facturacion f
	INNER JOIN catalogosucursal cs ON f.idsucursal = cs.id
	INNER JOIN catalogocliente cc ON f.cliente = cc.id
	LEFT JOIN catalogoempleado ce ON f.idusuario = ce.id
	WHERE f.idsucursal = ".$_GET[sucursal]." AND f.facturaestado='GUARDADO' AND f.tipofactura='NORMAL' AND f.credito = 'SI' AND f.otrosmontofacturar > 0
	AND f.fecha BETWEEN '".cambiaf_a_mysql($_GET[fechainicio])."' AND '".cambiaf_a_mysql(((!empty($_GET[fechafin]))?$_GET[fechafin]:$_GET[fechainicio]))."'
	ORDER BY f.idusuario";
	...
	obtenerDatos($s.$criterioguiasforaneapagadacreditoentregadas,"RELACION DE GUIAS CANCELADAS","SI",$l,$sucursalNombre);
