    ...
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
		  ...
		  ?>
          <td width="44%"><input name="sucursal" class="Tablas" value="<?=$f->sucursal?>" type="text" id="sucursal" style="width:250px" autocomplete="array:desc" onkeypress="if(event.keyCode==13){document.all.sucursal_hidden.value = this.codigo; document.all.embarque.focus();}" onblur="document.all.sucursal_hidden.value = this.codigo; document.all.embarque.focus();" /></td>
