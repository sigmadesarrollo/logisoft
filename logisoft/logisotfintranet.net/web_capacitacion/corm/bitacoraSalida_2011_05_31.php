...
PCD</td>
        ...
        <tr>
          ...
          <td>Precinto:</td>
          <td><span class="Tablas">
        <input name="precinto" type="text" class="Tablas" id="precinto" style="width:70px; background-color:#FFFF99" onkeypress="if(event.keyCode==13){buscarPrecinto(this.value)};"/>
