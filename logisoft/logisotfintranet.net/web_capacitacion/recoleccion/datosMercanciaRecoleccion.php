...
" onKeyUp="if(event.keyCode==13){document.all.descripcion.focus();}" value="<?=$cantidad ?>" size="5" maxlength="5" />
          ...
          <tr>
            ...
            <td width="81" class="Tablas"><input name="peso" type="text" class="Tablas" id="peso" onBlur="CalcularUnitarioFoco()" onKeyPress="return SoloND(event,this.value)
...
" onKeyDown="CalcularUnitario(event); return tabular(event,this)" value="<?=$peso ?>" size="10" maxlength="15" /></td>
            ...
            <td width="83" class="Tablas"><input name="largo" type="text" class="Tablas" id="largo" onKeyPress="return SoloND(event,this.value)
...
" onKeyDown="return tabular(event,this)" value="<?=$ancho ?>" size="10" maxlength="10" />
            ...
            <td class="Tablas"><input name="alto" type="text" class="Tablas" id="alto" onBlur="CalcularVolumenFoco()" onKeyPress="if(event.keyCode==13){Validar();}else{return SoloND(event,this.value)}" onKeyDown="CalcularVolumen(event);" value="<?=$alto ?>" size="7" maxlength="10" />
              cm</td>
          </tr>
          <tr>
            ...
            <td colspan="5">
              ...
              <table width="148" border="0" align="right" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="70"><img src="../img/Boton_Cerrar_.gif" alt="Cerrar" width="70" height="20" style="cursor:pointer" onClick="parent.ponerFoco();parent.VentanaModal.cerrar()" /></td>
                  </tr>
              </table></td>
          </tr>
        </table>
