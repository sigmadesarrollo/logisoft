...
<script>
	...
	tabla1.setAttributes({
		nombre:"detalle",
		campos:[
			{nombre:"GUIA", medida:75, alineacion:"center",  datos:"guia"},
			{nombre:"FECHA", medida:70, alineacion:"center",  datos:"fecha"},
			{nombre:"REMITENTE", medida:170, alineacion:"center", datos:"remitente"},
			{nombre:"DESTINATARIO", medida:170, alineacion:"center", datos:"destinatario"},
			{nombre:"DIRECCION", medida:160, alineacion:"center", datos:"direccion"},
			{nombre:"SECTOR", medida:80, alineacion:"center", datos:"sector"},
			{nombre:"TIPO FLETE", medida:80, alineacion:"center", datos:"tipoflete"},
			{nombre:"IMPORTE", medida:100, alineacion:"center", datos:"importe"},
			{nombre:"TIPO ENTREGA", medida:85, alineacion:"center", datos:"entrega"}		
		],
		filasInicial:20,
		alto:250,
		seleccion:true,
	...
	function obtenerDetalle(){		
		consultaTexto("resTabla1","consultasAlertas.php?accion=24&contador="+u.pag1_contador.value
		+"&s="+Math.random());
	}
	...
	function paginacion(movimiento){
		switch(movimiento){
			case 'primero':
				consultaTexto("resTabla1","consultasAlertas.php?accion=24&contador=0&s="+Math.random());
				break;
			case 'adelante':
				if(u.pag1_adelante.value==1){
					consultaTexto("resTabla1","consultasAlertas.php?accion=24&contador="+(parseFloat(u.pag1_contador.value)+1)					
					+"&s="+Math.random());
				}
				break;
			case 'atras':
			...
			case 'ultimo':
				...
				consultaTexto("resTabla1","consultasAlertas.php?accion=24&contador="+contador
				+"&s="+Math.random());
				break;
		}
	}
	...
	function imprimirReporte(){
		if(document.URL.indexOf("web/")>-1){		
			var v_dir = "http://www.pmmintranet.net/web/alerta/";
		
		}else if(document.URL.indexOf("web_capacitacion/")>-1){
			var v_dir = "http://www.pmmintranet.net/web_capacitacion/alerta/";
		
		}else if(document.URL.indexOf("web_pruebas/")>-1){
			var v_dir = "http://www.pmmintranet.net/web_pruebas/alerta/";
		}
		var suc='<?=$_SESSION[IDSUCURSAL] ?>';
		window.open(v_dir+"guiasSinRutaExcel.php?titulo=GUIAS SIN RUTA DE CLIENTES CORPORATIVOS&sucursal="+suc+"&val="+Math.random());
	}
</script>
...
<form id="form1" name="form1" method="post" action="">
  <table width="800" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
    <tr>
      <td class="FondoTabla">GUIAS SIN RUTA DE CLIENTES CORPORATIVOS </td>
    </tr>
    <tr>
      <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><div id="txtDir" style=" height:280px; width:780px; overflow:auto" align="left">
		  ...
		  <tr>
            <td align="center"><div class="ebtn_imprimir" onclick="imprimirReporte()"></div></td>
          </tr>
      </table></td>
    </tr>
  </table>
