...
<table width="450" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
  ...
  <tr>
    <td><table width="469" border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td width="130" style="text-align:center" bgcolor="#016193">
<!--        <OBJECT ID="DGhuella"
            CLASSID="CLSID:FB90BEF3-564C-48F7-B391-0EFE14A0BD08" width="121" height="129">
         </OBJECT> -->
        </td>
        <td width="339"><table width="300" align="center">
          <tr>
	  ...
	  <tr>
	    <td align="center" bgcolor="#016193"><span style="font-size:12px; color:#FFF"></span></td>
	    <td align="center">&nbsp;</td>
	    <td align="center">&nbsp;</td>
	  </tr>		
      <tr>
        <td colspan="6" align="center"><table id="detalle" width="448" border="0" cellspacing="0" cellpadding="0">          
          </table>         </td>
      </tr>
	  <tr>
