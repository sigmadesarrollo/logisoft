...
<script>
	...
	tabla1.setAttributes({
		nombre:"detalle0",
		campos:[						
			{nombre:"id", medida:4, tipo:"oculto", alineacion:"left", datos:"id"},
	...
	function obtenerDetalle(){
		consultaTexto("resTabla1","reporteCobranza_con.php?accion=1&contador="+u.pag1_contador.value
		+"&sucursal=<?=$_SESSION[IDSUCURSAL]?>&s="+Math.random());
	}
	...
	function paginacion1(movimiento){
		switch(movimiento){
			case 'primero':
				consultaTexto("resTabla1","reporteCobranza_con.php?accion=1&contador=0&s="+Math.random()+"&sucursal="+<?=$_SESSION[IDSUCURSAL]?>);
				break;
			case 'adelante':
				if(u.pag1_adelante.value==1){
					consultaTexto("resTabla1","reporteCobranza_con.php?accion=1&contador="+(parseFloat(u.pag1_contador.value)+1)
					+"&sucursal="+<?=$_SESSION[IDSUCURSAL]?>+"&s="+Math.random());
				}
				break;
			case 'atras':
			...
			case 'ultimo':
				...
				consultaTexto("resTabla1","reporteCobranza_con.php?accion=1&contador="+contador+"&s="+Math.random()+"&sucursal="+<?=$_SESSION[IDSUCURSAL]?>);
				break;
		}
	}
	
	function cf_t1clientes(valor){
		u.pag2_sucursal.value = tabla1.getSelectedRow().id;
		consultaTexto("resTabla2","reporteCobranza_con.php?accion=2&contador="+u.pag2_contador.value+"&prefijosucursal="+u.pag2_sucursal.value+"&s="+Math.random());
	}
	...
	function cf_t2clientes(valor){
		...
		+"&sucursal=<?=$_SESSION[IDSUCURSAL]?>&idcliente="+u.pag3_idcliente.value+"&s="+Math.random());
	}
	...
	function paginacion3(movimiento){
		switch(movimiento){
			...
			case 'adelante':
				if(u.pag3_adelante.value==1){
					consultaTexto("resTabla3","reporteCobranza_con.php?accion=3&contador="+(parseFloat(u.pag3_contador.value)+1)
						+"&sucursal="+<?=$_SESSION[IDSUCURSAL]?>+"&idcliente="+u.pag3_sucursal.value+"&s="+Math.random());
					break;
				}
				break;
			case 'atras':
			...
			case 'ultimo':
				...
				consultaTexto("resTabla3","reporteCobranza_con.php?accion=3&contador="+contador+"&idcliente="+u.pag3_sucursal.value
					+"&sucursal="+<?=$_SESSION[IDSUCURSAL]?>+"&s="+Math.random());
				break;
		}
	}
	...
	function cf_t1total(valor){
		u.pag4_sucursal.value = tabla1.getSelectedRow().id;
		consultaTexto("resTabla4","reporteCobranza_con.php?accion=4&contador="+u.pag3_contador.value+
					  "&sucursalprefijo="+u.pag4_sucursal.value+"&s="+Math.random());
	}
	...
	function cf_t2ncliente(valor){
		...
		consultaTexto("resTabla5","reporteCobranza_con.php?accion=5&contador="+u.pag5_contador.value+
					  ...
					  "&prefijosucursal="+u.pag2_sucursal.value+"&s="+Math.random());
	}
	function generarT5(){
		consultaTexto("resTabla5","reporteCobranza_con.php?accion=5&contador="+u.pag5_contador.value+
					  "&idcliente="+u.pag5_idcliente.value+"&fecha1="+u.t5_fecha1.value+"&fecha2="+u.t5_fecha2.value+
	...
	function imprimirReporte(tipo){
		...
		switch (tipo){
			case 1:
				window.open(v_dir+"generarExcelCobranza.php?accion=1&titulo=ESTADO DE CUENTAS POR COBRAR&val="+Math.random()+"&sucursal="+<?=$_SESSION[IDSUCURSAL]?>);
			break;
			case 2:
			...
			break;
			case 3:
				window.open(v_dir+"generarExcelCobranza.php?accion=3&titulo=HISTORIAL DE LINEA DE CREDITO&idcliente="+u.pag3_idcliente.value
				+"&sucursal="+<?=$_SESSION[IDSUCURSAL]?>+"&val="+Math.random());
			break;
			...
			case 5:
				window.open(v_dir+"generarExcelAntiguedadSaldos2.php?titulo=ANTIGÜEDAD DE SALDOS&sucursalprefijo="+u.pag4_sucursal.value
				+"&val="+Math.random());
			break;
		}
	}
