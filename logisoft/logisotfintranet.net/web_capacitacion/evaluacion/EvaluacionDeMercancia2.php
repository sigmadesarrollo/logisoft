...
tabla1.setAttributes({
	...
	function obtenerGenerales(datos){
		...
		consultaTexto("mostrarGenerales","evaluacionMercancia_con.php?accion=3&bolsa=1&emplaye=2");
	...
	function mostrarEvaluacion(datos){
		...
		u.CantidadEmpaque.value		= obj[0].cantidadbolsa;

		u.TotalEmpaque.value		= obj[0].totalbolsaempaque;

		u.TotalEmplaye.value		= obj[0].totalemplaye;			
		...
		consultaTexto("mostrarDetalle","evaluacionMercancia_con.php?accion=9&evaluacion="+u.folio.value+"&sd="+Math.random());
			...
			alerta("El folio de Evaluación de Mercancia no existe","¡Atención!","folio");
	...
	function Validar(){	
		...
		if(u.SucDestino.value==""){

			alerta3("Proporcione un destino valido");
	...
	function mostrarDestino(datos){
		...
		u.SucDestino.value = datos;

		if(tabla1.getRecordCount()==0){

		abrirVentanaFija('EvaluacionMercanciaAgregarFilas.php?funcion=agregarDatos', 400, 350, 'ventana', 'Datos Evaluación');
            ...
            <tr>
              ...
              <th width="612" height="64" scope="row"><table width="608" height="75" border="0" cellspacing="0" class="Tablas">
                ...
                <tr>
                  ...
                  <td width="77" class="Tablas"><input name="NRecoleccion" type="text" class="Tablas" id="NRecoleccion" value="<?=$NRecoleccion ?>" size="10" onKeyDown="return tabular(event,this)" onKeyPress="return Numeros(event)" onKeyUp="return habilitar(event,this.name)"  ></td>
                  ...
                  <td colspan="2" class="Tablas"><input name="country" type="text" class="Tablas" id="country" style="font-size:9px; text-transform:uppercase" onKeyUp="ajax_showOptions(this,'getCountriesByLetters',event,'../buscadores_generales/ajax-list-destinos.php')" value="<?=$country ?>" size="35"  onKeyPress="if(event.keyCode==13){devolverDestino();}" maxlength="60">
            ...
            <tr>
              ...
              <th height="87" scope="row"><table width="600" height="73" border="0" cellpadding="0" cellspacing="0" class="Tablas">
                ...
                <tr>
                  ...
                  <td width="333"><table width="50" border="0" align="right" cellpadding="0" cellspacing="0">
