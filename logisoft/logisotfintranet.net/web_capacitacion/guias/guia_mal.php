...
CODEBASE="http://www.pmmintranet.net/web_pruebas/activexs/ImpEtiqueta.CAB#version=10,0,0,0">
</OBJECT>
...
<script>
	...
	function ImprimirEtiquetasXX(){
		//Etiqueta.Impresora = "\\PCMARIELA\ZEBRA";
		...
		Etiqueta.Datos_Paquetes = "760000000200A|07/09/2010 20:20|7 P.VOL: 139.5   P. KG: 201.5";
		Etiqueta.Contenido_Paquetes = "1|CAJA(S)|Colageno|40x80x80|488 KG|64 KG|1|CAJA(S)|Ropa|30x80x80|388 KG|34 KG|2|CAJA(S)|Zapatos|20x80x80|288 KG|24 KG|1|CAJA(S)|Libros|10x80x80|188 KG|14 KG|1|CAJA(S)|Llantas|60x80x80|88 KG|4 KG|1|CAJA(S)|Pintura|70x80x80|788 KG|74 KG";
		...
		Etiqueta.Datos_Guia = "TLQ|MTY|TIPO DE ENTREGA: EAD|TIPO DE FLETE: POR COBRAR|VALOR DECLARADO: 0|CONDICION DE PAGO: CONTADO|DOCUMENTO: TLQ1581";
		Etiqueta.Datos_Totales = "LA OBSERVACION|588.00|0.00|58.84|8.00|655.22|104.84|0.00|760.06|58.84|0.00|0.00|0.00|0.00|54.84|322020100907X4760";
		Etiqueta.Imprimir();*/
		
		 Etiqueta.Impresora_Guias = "";
		Etiqueta.Impresora_Paquetes = "";
		
		Etiqueta.Datos_Paqueteria = "entregas puntuales|s de rl de cv|av. benemerito de las americas 301|palos prietos|mazatlan, sinaloa|epu1004244x2";
		Etiqueta.Datos_Paquetes = "760000000200A|07/09/2010 20:20|1 P.VOL: 139.5   P. KG: 201.5";
		Etiqueta.Contenido_Paquetes = "1|CAJA(S)|Colageno|40x80x80|488 KG|64 KG";
		Etiqueta.Datos_Remitente = "Gnt Val s De Rl De Cv|CTE: 17372    RFC: GNT090220396|Av. La Calma 3775 NO 0|ARBOLEDAS 1A SECC C.P. 45070|ZAPOPAN|TEL:";
		Etiqueta.Datos_Destinatario = "MARIA EUGENIA SEGOVIA|23424    RFC:  |BURGOS 4113 |LAS TORRES C.P. 64103|MONTERREY |SIN SECTOR   TEL: 018183658175 ";
		Etiqueta.Datos_Guia = "TLQ|MTY|TIPO DE ENTREGA: EAD|TIPO DE FLETE: POR COBRAR|VALOR DECLARADO: 0|CONDICION DE PAGO: CONTADO|DOCUMENTO: TLQ1581";
		Etiqueta.Datos_Totales = "LA OBSERVACION|588.00|0.00|58.84|8.00|655.22|104.84|0.00|760.06|58.84|0.00|0.00|0.00|0.00|54.84|322020100907X4760";
		...
		//try{
			...
			//Etiqueta.Cargar_Datos();
			//alert(0);
/*			Etiqueta.Imprimir_Guia();			
			Etiqueta.Imprimir_Paquetes();*/
