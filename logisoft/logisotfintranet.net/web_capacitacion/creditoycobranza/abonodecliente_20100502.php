...
tabla1.setAttributes({
	...
	function mostrarFactura(datos){
		if (datos!=0) {
			...
			alerta("Este cliente no tiene facturas disponibles","¡Atención!","idcliente");
		}
	}
	...
	function mostrarGuiaBusqueda(datos){
		if (datos=="") {
			alerta("Esta guia no existe","¡Atención!","idcliente");
		}else if (datos==0){
			alerta("Esta guia no existe o no esta facturada","¡Atención!","idcliente");
		}else{
