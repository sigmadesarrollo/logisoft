<?
	...
	if($_GET[accion]==5){
		...
		'$_GET[valordeclarado]', '$_GET[limite]', '$_GET[porcada]','$_GET[costoextra]','$_GET[legal]','$_GET[compromiso]','$_GET[ncliente]'";
	...
	if($_GET[accion]==6){
		...
		usuario, idusuario, valordeclarado, limite, porcada, costoextra,legal,compromisomes,ncliente FROM propuestaconvenio WHERE folio = $_GET[valor]";
		$r = mysql_query($s,$l) or die($s);
		$f = mysql_fetch_object($r);
	...
	if($_GET[accion]==8){		
		...
		estado='$_GET[estadodir]', pais='$_GET[pais]', celular='$_GET[celular]', telefono='$_GET[telefono]', email='$_GET[email]',compromisomes=$_GET[compromiso],
		ncliente=$_GET[ncliente]	where folio = $_GET[folio]";
		mysql_query($s,$l) or die($s);
	...
	if($_GET[accion]==9){
		...
		valordeclarado,limite,porcada,costoextra,legal,compromisomes,ncliente FROM propuestaconvenio
