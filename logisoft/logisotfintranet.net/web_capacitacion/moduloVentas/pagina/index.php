...
<param name="movie" value="../css/ventas.swf" /><param name="quality" value="high"/><param name="bgcolor" value="#ffffff" /><embed src="../css/ventas.swf" quality="high" bgcolor="#ffffff" width="1000" height="150" name="Header" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
</object>
	<!-- 
		FIN AREA BANNER
	-->
...
<tr>
	...
	<!-- PARTE CENTRO -->
			...
			<iframe name="pagina" src="../../catalogos/cliente/client.php" id="pagina" scrolling="auto" width="740" height="450"  frameborder="0"></iframe>
