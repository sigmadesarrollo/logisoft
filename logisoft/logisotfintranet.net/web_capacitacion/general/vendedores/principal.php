...
<script>
	...
	window.onload = function (){
		...
		tabs.iniciar({
			...
			paginainicial:"principalvendedores.php"
		...
		cn.crearNavegador();
			...
			contenidos:[
				...
				{nombre:"Generados por Convenio"},


				{nombre:"Cobradas por Vendedor"},


				{nombre:"Detallada por Vendedor"},


				{nombre:"Comision por Vendedor"},
...
<form id="form1" name="form1" method="post" action="">
  ...
  <table width="600" height="496" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td height="29" align="center" class="FondoTabla Estilo4">Reporte Principal de Ventas Por Vendedor </td>
