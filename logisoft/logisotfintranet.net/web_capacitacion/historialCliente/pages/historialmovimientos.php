...
<script>
	...
	tabla1.setAttributes({
		...
		campos:[
			...
			{nombre:"Origen", medida:30, alineacion:"left", datos:"origen"},
			{nombre:"Destino", medida:30, alineacion:"left",  datos:"destino"},
			...
			{nombre:"IvaRet", medida:50, tipo:"moneda", alineacion:"left", datos:"ivaretenido"},
