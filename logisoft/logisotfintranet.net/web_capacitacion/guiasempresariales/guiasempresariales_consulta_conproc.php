<?
	...
	if($_GET[accion] == 4){
		...
		$s = "call proc_guardarGuiaEmpresarial(
			$_GET[idpagina],
			$_GET[evaluacion],
			'$_GET[newfolio]',
			'$estado',
			...
			$_GET[ocurre],
			'$_GET[tipoguia]',
			$_GET[idsucursalorigen],
			$_GET[iddestino],
			$_GET[idsucursaldestino],
			'$_GET[tipopago]',
			$_GET[idremitente],
			$_GET[iddireccionremitente],
			$_GET[iddestinatario],
			$_GET[iddirecciondestinatario],
			$_GET[entregaocurre],
			$_GET[entregaead],
			'$_GET[restrinccion]',
			$_GET[totalpaquetes],
			...
			'$_GET[tarjeta]',
			'$_GET[trasferencia]',
			'$_GET[clienteconvenio]',
			'$_GET[sucursalconvenio]',
			'$_GET[idvendedorconvenio]',
			'$_GET[nvendedorconvenio]',
			'$_GET[convenioaplicado]',
			'$_GET[nuevootros]',
			'$_SESSION[IDUSUARIO]',
		...
		$r = mysql_query($s,$l) or $rb->rollBackGuiaempresarial(0,$s,$l);
