<?	require_once('../../fpdf.php');
	...
	$l = Conectarse("webpmm");
		...
		(ge.tcostoead*(cs.porcead/100)) comisionead,((((ge.tflete+ge.texcedente)-ge.tdescuento)*(cs.recibido/100))+
		...
		(gv.tcostoead*(cs.porcead/100)) comisionead,((((gv.tflete+gv.texcedente)-gv.tdescuento)*(cs.recibido/100))+
		...
		((gv.tcostoead*(cs.porcead/100))*-1) comisionead,(((((gv.tflete+gv.texcedente)-gv.tdescuento)*(cs.recibido/100))+
		(gv.tcostoead*(cs.porcead/100)))*-1) total,(gv.total) tgral,gv.estado,
		CONCAT(IF(gv.tipoflete=0,'PAGADA','POR COBRAR'),'-',IF(gv.condicionpago=0,'CONTADO','CREDITO')) condicion
		FROM catalogosucursal cs INNER JOIN guiasventanilla gv  ON cs.id=gv.idsucursaldestino
