...
<script>
	...
	tabla1.setAttributes({
		nombre:"detalle",
		campos:[
			{nombre:"SUCURSAL", medida:65, alineacion:"left", datos:"nombresucursal"},
			...
			{nombre:"CAJA", medida:45, alineacion:"center",  datos:"caja"}
		],
		filasInicial:30,
		alto:280,
		seleccion:true,
	...
	function mostrarDescuento(tipo){
		...
		if(tipo == "atras"){
			...
			consultaTexto("mostrardetalle2","total_con.php?accion=5&fecha="+u.fecha.value+"&fecha2="+u.fecha2.value+"&sucursal="+u.sucursal.value+"&inicio=0");
			...
			consultaTexto("mostrardetalle2","total_con.php?accion=5&fecha="+u.fecha.value+"&fecha2="+u.fecha2.value+"&sucursal="+u.sucursal.value+"&inicio="+u.totaldes.value);
			}			
		}else{
	...
	function imprimirReporte(){
		...
		window.open(v_dir+"generarExcelIngresos.php?accion=5&titulo=INGRESOS POR GUIAS ENTREGADAS&fecha="+u.fecha.value
  ...
  <table width="680" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      <td><div id="txtDir" style=" height:300px; width:680px; overflow:auto" align="left">
        ...
        <table width="645" height="16" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="3">&nbsp;</td>
            ...
            <td width="165" align="center">Total Gral:</td>
            <td width="105" align="center"><div align="right"><strong><strong>
            ...
            <td width="101" align="center"><input name="total" type="text" class="Tablas" id="total" style="text-align:right; width:100px; background:#FFFF99" value="<?=$total ?>
