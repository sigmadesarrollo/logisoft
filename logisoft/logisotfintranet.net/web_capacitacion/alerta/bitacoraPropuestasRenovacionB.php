...
<script>
	...
	tabla1.setAttributes({
		nombre:"detalle",
		campos:[
			{nombre:"FOLIO", medida:80, alineacion:"center",  datos:"folio"},
			{nombre:"RENOVACIONDE", medida:80, alineacion:"center",  datos:"renovacionde"},
			{nombre:"FECHA", medida:70, alineacion:"center", datos:"fecha"},
			{nombre:"VIGENCIA", medida:70, alineacion:"center", datos:"vigencia"},
			{nombre:"NOMBRE", medida:110, alineacion:"center", datos:"nombre"},
			{nombre:"EMPLEADO", medida:110, alineacion:"center", datos:"empleado"},
			{nombre:"SUCURSAL", medida:70, alineacion:"center", datos:"sucursal"}
		],
		filasInicial:30,
		alto:300,
		seleccion:true,
	...
	function obtenerDetalle(){		
		consultaTexto("resTabla1","consultasAlertas.php?accion=31&contador="+u.pag1_contador.value
		+"&s="+Math.random());
	}
	...
	function paginacion(movimiento){
		switch(movimiento){
			case 'primero':
				consultaTexto("resTabla1","consultasAlertas.php?accion=31&contador=0&s="+Math.random());
				break;
			case 'adelante':
				if(u.pag1_adelante.value==1){
					consultaTexto("resTabla1","consultasAlertas.php?accion=31&contador="+(parseFloat(u.pag1_contador.value)+1)					
					+"&s="+Math.random());
				}
				break;
			case 'atras':
			...
			case 'ultimo':
				...
				consultaTexto("resTabla1","consultasAlertas.php?accion=31&contador="+contador
				+"&s="+Math.random());
				break;
		}
	}
...
<table width="550" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
    <tr>
      <td class="FondoTabla">BITACORA DE PROPUESTAS GENERADAS POR RENOVACI&Oacute;N</td>
    </tr>
    <tr>
    	<td>
