function alerta(mensaje, titulo,caja) {	
	...
	var var_ubicacion_direccion = document.location.href.split("/").length -6;
	var var_retroceder = "";
	
	for(i=0;i<var_ubicacion_direccion;i++){
		var_retroceder += "../";
	}
	
	var src = var_retroceder+'../../javascript/ventanas/img/ventana-info/';
	...
	+ '<img src="' + src + 'aceptar.gif" alt="Aceptar" title="Aceptar" style="cursor: pointer;" onclick="document.all.' + caja + '.focus(); VentanaModal.cerrar()">'
	+ '</td></tr></table>'
...
function alerta2(mensaje, titulo,caja) {	
	var alto = '50';
	var ancho = '300';
	var icono = 'alerta.gif';
	VentanaModal.inicializar();
...
function alerta3(mensaje, titulo, vancho, valto){ 	
	var alto = (valto!=null)?valto:'50';
	var ancho = (vancho!=null)?vancho:'300';
	var icono = 'alerta.gif';
	VentanaModal.inicializar();
	VentanaModal.setSize(ancho, alto);
	VentanaModal.setClaseVentana("");
...
function confirmar(mensaje, titulo, accionTrue, accionFalse) {
	...
	var src = var_retroceder+'../../javascript/ventanas/img/ventana-confirmar/';
	var styleTitulo = 'font-family: Arial, Verdana, Helvetica, sans-serif; font-size: 12px; font-weight: bold; color: #000000;';
	var styleMensaje = 'font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 10px; color: #000000; height: ' + (alto - 150) + 'px; vertical-align: top;';
...
function error(mensaje, titulo) {
	...
	var src = var_retroceder+'../../javascript/ventanas/img/ventana-error/';
	var styleTitulo = 'font-family: Arial, Verdana, Helvetica, sans-serif; font-size: 12px; font-weight: bold; color: #000000;';
	var styleMensaje = 'font-family: Verdana, Arial, Helvetica, sans-serif; font-size: 10px; color: #000000; height: ' + (alto - 150) + 'px; vertical-align: top;';
...
function bgImg(imgSrc) {
	if (VentanaModal.MSIE) {
		...
		return " background-image: url(javasctipt/ventanas/" + imgSrc + "); ";
	}
}