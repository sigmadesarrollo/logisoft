...
<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td colspan="2"><table width="654" border="0" align="center">
      ...
      <tr>
        ...
        <td width="6%" class="Tablas">Fecha:</td>
        ...
        <td width="11%" colspan="2"><input name="estado" type="text" id="estado" style="background:#FFFF99;font:tahoma; font-size:9px" value="<?=$estado ?>" size="13" align="top" /></td>
              ...
              <td><table width="101%" border="0">
                  ...
                  <tr>
                    ...
                    <td width="55%" colspan="3">&nbsp;&nbsp;<span class="Tablas">R.F.C.:</span>
                      ...
                      <input name="rrfc2" type="text" id="rrfc2" style="background:#FFFF99;font:tahoma; font-size:8px" value="<?=$rrfc ?>" size="15" /></td>
                  ...
                  <tr>
                    ...
                    <td colspan="4"><input name="rcliente2" type="text" id="rcliente2" style="background:#FFFF99;font:tahoma; font-size:8px" value="<?=$rcliente ?>" size="55" /></td>
                  ...
                  <tr>
                    ...
                    <td colspan="4"><input name="rcalle2" type="text" id="rcalle2" style="background:#FFFF99;font:tahoma; font-size:8px" value="<?=$rcalle ?>" size="35" />
                  ...
                  <tr>
                    ...
                    <td width="29%"><input name="rcp5" type="text" id="rcp5" style="background:#FFFF99;font:tahoma; font-size:8px" value="<?=$rcp ?>" size="15" /></td>
                  ...
                  <tr>
                    ...
                    <td colspan="4"><input name="rpoblacion2" type="text" id="rpoblacion2" style="background:#FFFF99;font:tahoma; font-size:8px" value="<?=$rpoblacion ?>" size="28" />

                      <span class="Tablas">&nbsp;Tel&eacute;fono:

                      <input name="rtelefono2" type="text" id="rtelefono2" style="background:#FFFF99;font:tahoma; font-size:8px" value="<?=$rtelefono ?>" size="15" />
  ...
  <tr>
    ...
    <td width="51%"><table width="334" border="0" align="left">

      <tr>

        <td width="63" class="Tablas">T. Paquetes: </td>

        <td width="27" class="Tablas"><input name="rcp2" type="text" id="rcp2" style="background:#FFFF99;font:tahoma; font-size:8px" value="<?=$rcp ?>" size="5" /></td>

        <td width="67" class="Tablas">T. Peso Kg: </td>

        <td width="21" class="Tablas"><input name="rcp3" type="text" id="rcp3" style="background:#FFFF99;font:tahoma; font-size:8px" value="<?=$rcp ?>" size="5" /></td>

        <td width="57" class="Tablas">T. Volumen: </td>

        <td width="73" class="Tablas"><input name="rcp4" type="text" id="rcp4" style="background:#FFFF99;font:tahoma; font-size:8px" value="<?=$rcp ?>" size="5" /></td>
      ...
      <tr>
        ...
        <td width="244"><table width="170" border="0" align="left">
          ...
          <tr>
            ...
            <td><label><img src="../img/impguias.gif" width="212" height="24"></label></td>
