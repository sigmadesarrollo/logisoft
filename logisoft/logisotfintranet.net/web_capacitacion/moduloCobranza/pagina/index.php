		...
		window.onload = function (){
			...
			/*tree.create({
				...
				estructura: [
					...
					{nombre:"Guías", contenido:[ 

						{nombre:"Cotizador de Guías", contenido:"", onclick:"", imagen:""},

						{nombre:"Consulta de Guías", contenido:"", onclick:"", imagen:""},

						{nombre:"Elaboración de Guías", contenido:[
						...
						{nombre:"Historial de Guías", contenido:"", onclick:"", imagen:""},

						{nombre:"Evaluación de Mercancía", contenido:[

							{nombre:"Evaluaciones Pendientes de Generar Guía", contenido:"", onclick:"", imagen:""}
					...
					{nombre:"Cancelaciones", contenido:[ 
						...
						{nombre:"Guías Canceladas", contenido:"", onclick:"", imagen:""},

						{nombre:"Guías Sin Ruta Cliente Corporativo", contenido:"", onclick:"", imagen:""},

						{nombre:"Guías Empresariales Pendientes", contenido:"", onclick:"", imagen:""},						

						], onclick:"", imagen:""},						

					{nombre:"Entregas", contenido:[ 

						{nombre:"Guías EAD", contenido:[

							{nombre:"Guías Foráneas", contenido:"", onclick:"", imagen:""},

							{nombre:"Cliente Corporativo", contenido:"", onclick:"", imagen:""},

							{nombre:"Guías Faltantes de Liquidación EAD", contenido:"", onclick:"", imagen:""},
						...
						{nombre:"Ocurre", contenido:[
							...
							{nombre:"Entregas Ocurre en Almacén", contenido:"", onclick:"", imagen:""}
					...
					{nombre:"Facturación", contenido:[ 

						{nombre:"Facturación", contenido:"", onclick:"", imagen:""},

						{nombre:"Facturas Canceladas", contenido:"", onclick:"", imagen:""},

						{nombre:"Guías de Ventanilla Pendientes de Facturar", contenido:"", onclick:"", imagen:""}
					...
					{nombre:"Clientes", contenido:[ 
						...
						{nombre:"Directorio de clientes", contenido:[
							...
							{nombre:"Código Postal", contenido:"", onclick:"", imagen:""},

							{nombre:"Colonias", contenido:"", onclick:"", imagen:""},

							{nombre:"Solicitud de Guía Empresarial", contenido:"", onclick:"", imagen:""}							
					...
					{nombre:"CAT", contenido:[ 
						...
						{nombre:"Daños y Faltantes()", contenido:"",onclick:"", imagen:""},	

						{nombre:"EAD mal efectuadas()", contenido:"", onclick:"", imagen:""},

						{nombre:"Recolecciones NO realizadas()", contenido:"", onclick:"", imagen:""},

						{nombre:"Cancelaciones de Guías()", contenido:"", onclick:"", imagen:""},

						{nombre:"Guías Extraviadas()", contenido:"", onclick:"", imagen:""}
...
<param name="movie" value="../css/cobranza.swf" /><param name="quality" value="high"/><param name="bgcolor" value="#ffffff" /><embed src="../css/cobranza.swf" quality="high" bgcolor="#ffffff" width="1000" height="150" name="Header" align="middle" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
...
<tr>
	...
	<td width="260" valign="top" style="overflow:auto">	
