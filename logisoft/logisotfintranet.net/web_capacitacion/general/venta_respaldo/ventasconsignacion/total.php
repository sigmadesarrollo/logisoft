...
<script>
	...
	function obtenerDetalle(){
		...
		consultaTexto("mostrarDetalle","../ventas/consultasVentas.php?accion=9&cliente=<?= (($_GET[cliente]!='')?$_GET[cliente]:0) ?>&fechaini=<?=$_GET[fechaini] ?>&fechafin=<?=$_GET[fechafin] ?>");
	...
	function tipoImpresion(valor){
		...
		if(valor=="Archivo"){			
			...
			window.open("http://www.pmmentuempresa.com/web/general/venta/ventaConsignacionTotalExcel.php?accion=9&cliente=<?=$_GET[cliente] ?>&fechaini=<?=$_GET[fechaini] ?>&fechafin=<?=$_GET[fechafin] ?>&m="+Math.random()+"&titulo=GUIAS Y SERVICIOS");			
