<?
	...
	if($_GET[accion] == 2){
		...
		AND pg.sucursalacobrar=$_GET[sucorigen] and pg.pagado <> 'C')		
		UNION
	...
	if($_GET[accion] == 3){
		...
		gv.tflete, gv.texcedente, gv.tcostoead, gv.trecoleccion, gv.tcombustible, gv.totros, 
		...
		ge.tflete,  ge.texcedente, ge.tcostoead, ge.trecoleccion, ge.tcombustible, ge.totros, 
		...
		sge.subtotal AS tflete, 0 AS texcedente, 0 AS tcostoead, 0 AS trecoleccion, 
