...
<script>
	...
	tabla1.setAttributes({
		...
		antes estaba asi
		campos:[
			{nombre:"FOLIO EAD", medida:100, alineacion:"left", datos:"folioead"},
			{nombre:"FACTURA", medida:100, alineacion:"left", datos:"factura"},
			{nombre:"FECHA FACTURA", medida:70, alineacion:"center", datos:"fecha"},
			{nombre:"CLIENTE", medida:200, alineacion:"left", datos:"cliente"},
			{nombre:"IMPORTE", medida:120, alineacion:"right", tipo:"moneda", datos:"importe"}
		],*/
		campos:[
			{nombre:"FOLIO EAD", medida:110, alineacion:"left", datos:"folioead"},
			{nombre:"GUIA", medida:120, alineacion:"left", datos:"guia"},
			{nombre:"CLIENTE", medida:220, alineacion:"left", datos:"cliente"},
			{nombre:"FECHA GUIA", medida:100, alineacion:"center", datos:"fecha"},
			{nombre:"FACT", medida:100, alineacion:"center", datos:"factura"},
			{nombre:"IMPORTE", medida:120, alineacion:"right", tipo:"moneda", datos:"total"}
		],
		filasInicial:15,
		alto:250,
		seleccion:true,
	...
	function obtenerDetalle(){
		consultaTexto("resTabla1","consultas_con.php?accion=13&contador="+u.pag1_contador.value
		+"&s="+Math.random());
	}
	...
	function paginacion(movimiento){
		switch(movimiento){
			case 'primero':
				consultaTexto("resTabla1","consultas_con.php?accion=13&contador=0&s="+Math.random());
				break;
			case 'adelante':
				if(u.pag1_adelante.value==1){
					consultaTexto("resTabla1","consultas_con.php?accion=13&contador="+(parseFloat(u.pag1_contador.value)+1)					
					+"&s="+Math.random());
				}
				break;
			case 'atras':
			...
			case 'ultimo':
				...
				consultaTexto("resTabla1","consultas_con.php?accion=13&contador="+contador
				+"&s="+Math.random());
				break;
		}
	}
...
<form id="form1" name="form1" method="post" action="">
  <table width="800" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
    <tr>
      <td class="FondoTabla">LIQUIDACIONES EAD  </td>
    </tr>
    <tr>
      <td align="center"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><div id="txtDir" style=" height:270px; width:800px; overflow:auto" align="center">
