...
<?
	...
	if($_POST['generar_datos'])
	{
		...
		idcheque = '".str_pad($autocheque,9,"0",STR_PAD_LEFT)."', concepto='Reposicion de Caja Chica Suc $fx->prefijo a favor de Coord $_POST[gerenteb]', totalcheque = '$_POST[totalgasto]', usuario='$_SESSION[IDUSUARIO]'";
        ...
        <tr>
          <td><table width="612" border="0" align="left" cellpadding="0" cellspacing="0">
            ...
            <tr>
			  ...
			  <td width="50" align="left" class="formato_columnasg">Motivo No Autorizacin </td>
          ...
          <td><table width="610" height="21" border="0" cellpadding="0" cellspacing="0">
            ...
            <?
				...
				if(mysql_num_rows($sq) > 0)
				{
					...
					$varnocuenta = mysql_result($sq, 0, 5);
				}

			?>
              <td width="52"># Cuenta</td>
              <td width="152"><span class="Tablas">
                <input name="nocuenta" type="text" class="Tablas" id="nocuenta" style="width:120px;background:#FFFF99;" readonly="" value="<?=$nocuenta;?>" />
              </span></td>
              	<td width="217"></td>
                <td width="45">&nbsp;</td>
              <td width="86"></td>
          ...
          <td><table width="610" height="21" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="125"><span class="Tablas">
                <input name="fecha_cheque" type="text" class="Tablas" id="fecha_cheque" style="width:120px;"  value="<?=$varfechacheque;?>" onKeyUp="mascara(this,'/',patron,true)" /></span></td>
          ...
          <td><table width="611" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td width="75"><span class="Tablas">
                <input name="gerente" type="text" class="Tablas" id="gerente" style="width:70px;background:#FFFF99;" readonly="" value="<?=$vargerente == 0 ? '' : $vargerente; ?>" />
              </span></td>
        ...
        <tr>
          <td><table width="612" border="0" cellpadding="0" cellspacing="0">
            <tr><!--kryzzo home-->
              ...
              <td width="283"><div class="ebtn_imprimir"></div></td>
            </tr>
          </table></td>
        </tr>
        <tr>
...
<p><div align="center"><a href="../menu/webministator.php" ><img src="../img/inicio_30.gif" alt="Home" name="IMG0"  border="0"  id="IMG0" /></a></div></p>
...
<script language="javascript">
	...
	parent.frames[1].document.getElementById('titulo').innerHTML = 'REPORTE GASTOS CAJA CHICA';
