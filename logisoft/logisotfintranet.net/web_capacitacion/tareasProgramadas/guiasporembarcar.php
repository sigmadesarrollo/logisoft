...
<script>
	...
	tabla1.setAttributes({
		...
		campos:[
			...
			{nombre:"IMPORTE TOTAL", medida:100, alineacion:"left", datos:"importetotal"},

			{nombre:"TIPO DE ENTREGA", medida:100, alineacion:"left", datos:"tipodeentrega"}
	...
	function obtener(){
		...
		consultaTexto("mostrar","consultas_con.php?accion=5&valram="+Math.random());
