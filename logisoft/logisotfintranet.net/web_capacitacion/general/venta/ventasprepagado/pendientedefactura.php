...
<form id="form1" name="form1" method="post" action=""><br>
  ...
  <table width="670" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td width="41">Cliente:</td>

      <td width="81"><input name="cliente" type="text" class="Tablas" id="cliente" style="width:80px;background:#FFFF99" readonly="" value="<?=$_GET[cliente] ?>"/></td>

      <td width="878"><input name="cliente2" type="text" class="Tablas" id="cliente2" style="width:250px;background:#FFFF99" readonly="" value="<?=$f->nombre ?>"/></td>
    </tr>
