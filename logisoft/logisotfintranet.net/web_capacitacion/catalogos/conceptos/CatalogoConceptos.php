<? session_start();
	...
	if($accion == ""){
		$row	=folio('catalogoconcepto','webpmm');
		$codigo	=$row[0];
	}
		
		if($accion == "grabar"){
			$sqlins	=mysql_query("INSERT INTO catalogoconcepto (id, descripcion, usuario, fecha)
VALUES(null, UCASE('$descripcion'), '$usuario', current_timestamp())",$link); 		
			...
			$sqlupd	=mysql_query("UPDATE catalogoconcepto SET descripcion=UCASE('$descripcion'), usuario='$usuario', fecha=current_timestamp() WHERE id='$codigo'",$link);
  ...
  <table width="100%" border="0">
    ...
    <tr>
      <td><table width="310" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
        <tr>
          <td class="FondoTabla">CAT&Aacute;LOGO CONCEPTOS</td>
        </tr>
        <tr>
          <td><br><table width="309" border="0" align="center">
            ...
            <tr>
              ...
              <td width="159">
                ...
                &nbsp;<img src="../../img/Buscar_24.gif" alt="Buscar" width="24" height="23" align="absbottom" style="cursor:pointer" onClick="abrirVentanaFija('CatalogoConceptos_Buscar.php', 550, 450, 'ventana', 'Busqueda')"></td>
              <td width="137">&nbsp;</td>
              </tr>
            <tr>
