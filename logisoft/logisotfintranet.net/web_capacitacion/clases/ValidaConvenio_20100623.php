	...
	class ValidaConvenio{
		...
		function ValidaConvenio($idremitente, $iddestinatario, $iddestino, $idsucdestino){	
			...
			if($this->idremitente!=""){
				...
				prepagadas, limitekg, costo, preciokgexcedente, consignaciondescantidad, valordeclarado, porcada, limite, costoextra
			...
			if($this->iddestinatario!=""){	
				...
				if(mysql_num_rows($r)>0){
					...
					$this->des_consignaciondescuento = $f->consignaciondescantidad;
