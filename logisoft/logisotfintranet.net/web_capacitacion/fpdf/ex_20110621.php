...
$pdf->addReglement5("Razón Social: ".strtoupper($f->nombre));
$pdf->addReglement6("Domicilio: ".strtoupper($f->calle1)." No ".$f->n1);
$pdf->addReglement7("Colonia: ".strtoupper($f->colonia1));
$pdf->addReglement8("CP: ".$f->cp1);
$pdf->addReglement9("Población: ".strtoupper($f->p1).", ".$f->e1);
