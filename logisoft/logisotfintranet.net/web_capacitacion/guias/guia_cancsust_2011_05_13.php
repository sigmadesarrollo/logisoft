...
<script>
	...
	function registrarGuia(){
		...
		var pagina = "guiacs_consulta.php?accion=4&evaluacion="+evaluacion+"&fecha="+fecha+"&tipoflete="+tipoflete+"&idpagina="+u.idpagina.value+
				 +"&ocurre="+ocurre+"&idsucursalorigen="+idsucursalorigen+"&iddestino="+iddestino+"&idsucursaldestino="+idsucursaldestino
