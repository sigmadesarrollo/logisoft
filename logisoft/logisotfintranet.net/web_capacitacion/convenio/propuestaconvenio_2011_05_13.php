	...
	function darEstadoPropuesta(estado){
		...
		if(ubi.motivonoautorizar.value == '' && estado == 'NO AUTORIZADA'){
			...
			consultaTexto("resDarEstadoP","propuestaconvenio_con.php?accion=8&estado="+estado+"&folio="+ubi.folio.value+
							'&motivonoautorizar='+ubi.motivonoautorizar.value
							+"&calle="+calle+"&numero="+numero+"&cp="+cp+"&colonia="+colonia
							+"&poblacion="+poblacion+"&municipio="+municipio+"&estadodir="+estadodir+"&pais="+pais
							+"&celular="+celular+"&telefono="+telefono+"&email="+email);
		}
	}
...
Persona F&iacute;sica</td>
        ...
        <input type="hidden" name="provienedefolio" value="" />
        <input type="hidden" name="motivonoautorizar" value="" />
        </th>
				  </tr>
					<tr>
					  <th>Nick</th>
