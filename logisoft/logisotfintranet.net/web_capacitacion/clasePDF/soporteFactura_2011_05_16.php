<?php
	...
	#detallado superior
	$s = "SELECT * FROM facturadetalle WHERE factura = $_GET[folio]";
	...
	if(mysql_num_rows($rx)>0){
		...
		$s = "SELECT *, date_format(fecha,'%d/%m/%Y') as fecha FROM facturadetalle WHERE factura = $_GET[folio]";
		$r = mysql_query($s,$l) or die($s);
		$col = array('0'=>"Folio",'1'=>'Tipo Guia',	'2'=>'Fecha','3'=>'Flete','4'=>'Desc','5'=>'Exced',
		'6'=>'EAD', '7'=>'Recol', '8'=>'Seguro', '9'=>'Combus', '10'=>'Otros', '11'=>'Subtotal',
		'12'=>'Iva','13'=>'Iva Ret', '14'=>'Total');
		
		$opt = array('0'=>array('justification'=>'left'),'1'=>array('justification'=>'center'),	
		'2'=>array('justification'=>'center'),'3'=>array('justification'=>'right'),
		'4'=>array('justification'=>'right'),'5'=>array('justification'=>'right'),
		'6'=>array('justification'=>'right'), '7'=>array('justification'=>'right'), '8'=>array('justification'=>'right'), 
		'9'=>array('justification'=>'right'), '10'=>array('justification'=>'right'), '11'=>array('justification'=>'right'),
		'12'=>array('justification'=>'right'),'13'=>array('justification'=>'right'), '14'=>array('justification'=>'right'));
