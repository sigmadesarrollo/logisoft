...
<script>
	...
	function obtenerDetalle(){
		consultaTexto("obtenerTotal","reporteHistorialGuias_con.php?accion=1&tipo=0");
	}
	...
	function obtenerTotal(datos){
		...
		consultaTexto("mostrarDetalle","reporteHistorialGuias_con.php?accion=1&tipo=1&inicio=0");
	}
		...
		if(tipo == "atras"){
			...
			if(parseFloat(u.totaldes.value) <= "1"){
				...
				if(u.ultimo.value == "SI"){
					...
					u.ultimo.value = "";
			consultaTexto("mostrarDetalle","reporteHistorialGuias_con.php?accion=1&tipo=1&inicio="+u.totaldes.value);
				}else{
					u.d_atrasdes.style.visibility = "hidden";
					u.primero.style.visibility = "hidden";
					consultaTexto("mostrarDetalle","reporteHistorialGuias_con.php?accion=1&tipo=1&inicio=0");
				...
				consultaTexto("mostrarDetalle","reporteHistorialGuias_con.php?accion=1&tipo=1");
			}
		}else{
			cont++;
	...
	function obtenerUltimo(){
		...
		u.d_sigdes.style.visibility = "hidden";
		u.d_ultimo.style.visibility = "hidden";
		consultaTexto("mostrarDetalle","reporteHistorialGuias_con.php?accion=2");
	}
	...
	function imprimirReporte(){
		...
		window.open("http://www.pmmintranet.net/web_pruebas/guias/reporteHistorialGuiaExcel.php?sucursal=<?=$_SESSION[IDSUCURSAL]?>");
	}
</script>
