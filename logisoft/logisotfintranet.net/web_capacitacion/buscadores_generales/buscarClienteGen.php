...
function ObtenerConsulta(e,nombrecaja,valor){
	...
	if(tecla==13){
		...
		if(document.all.buscarpaterno.value!=""){
			datosenviados += "&paterno="+document.all.buscarpaterno.value;
		}
		if(document.all.buscarmaterno.value!=""){
			datosenviados += "&materno="+document.all.buscarmaterno.value;
		}
		...
		if(document.all.tipo.value!=""){	
			consulta("resultado","buscarClienteGen_con.php?accion=1"+((document.all.tipo.value=="moral")?'&tipo=SI':'&tipo=NO')+
						datosenviados+"&suert="+Math.random());		
		}else{		
			consulta("resultado","buscarClienteGen_con.php?accion=1<?=($_GET[tiposol])?"&tiposol=$_GET[tiposol]":""?>"+datosenviados+"&suert="+Math.random());		
		}
	}
}
...
filas ->> class="FondoTabla"
 -->
  <table width="790" class="Tablas"  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
    <tr>
      <td width="78" class="FondoTabla">Nick</td>
      <td width="78" class="FondoTabla">R.F.C</td>
      <td width="69" class="FondoTabla"># Cliente</td>
      <td width="110" class="FondoTabla">Nombre</td>
      <td width="102" class="FondoTabla">Paterno</td>
      <td width="132" class="FondoTabla">Materno</td>
	  <td width="75" class="FondoTabla">Sucursal</td>
	  <td width="63" class="FondoTabla">&nbsp;</td>
	  <td width="63" class="FondoTabla">&nbsp;</td>
    </tr>
    <tr>
      ...
      <td class="FondoTabla"><span class="Tablas">
        <input name="buscarnombre" type="text" id="buscarnombre" value="" class="Tablas" style="border:none; text-transform:uppercase; width:75px;" onKeyPress="ObtenerConsulta(event,this.name,this.value)" />
      </span></td>
      <td class="FondoTabla"><span class="Tablas">
        <input name="buscarpaterno" type="text" id="buscarpaterno" value="" class="Tablas" style="border:none ;text-transform:uppercase; width:75px;" onKeyPress="ObtenerConsulta(event,this.name,this.value)" />
      </span></td>
      <td class="FondoTabla"><span class="Tablas">
        <input name="buscarmaterno" type="text" id="buscarmaterno" value="" class="Tablas" style="border:none;text-transform:uppercase; width:75px;" onKeyPress="ObtenerConsulta(event,this.name,this.value)" />
      </span></td>
	  <td class="FondoTabla">
    ...
    <tr>
      ...
      <table width="762" id="tablaclientes" border="0" align="left" alagregar="" alborrar="" cellpadding="0" cellspacing="2">
            ...
            <td width="105" class="Tablas"></td>
            <td width="135" class="Tablas"></td>
