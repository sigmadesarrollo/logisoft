...
<script>
	...
	function tipoImpresion(tipo){	
		...
		if(tipo=="Pantalla"){			
				window.open(direccion+"fpdf/reportes/cierreCajaDetalle.php?sucursal=<?=$_SESSION[IDSUCURSAL]?>&fechainicio="+u.inicio.value+"&fechafin="+u.fin.value,null, "toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0");
		}else{			
			window.open(direccion+"Caja/cierreDetalladoExcel.php?sucursal=<?=$_SESSION[IDSUCURSAL]?>&fechainicio="+u.inicio.value+"&fechafin="+u.fin.value);
		}
	}
</script>
...
<form id="form1" name="form1" method="post" action="">
  <table width="400" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
    <tr>
      <td class="FondoTabla">GENERAR REPORTE DE CORTE DIARIO DETALLADO </td>
    </tr>
    <tr>
