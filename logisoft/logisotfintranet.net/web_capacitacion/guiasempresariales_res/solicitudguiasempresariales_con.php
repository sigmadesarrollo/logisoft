<?	session_start();
	...
	if($_GET[accion]==1){ //asignacionguiasempresariales.php
		...
		cg.cargocombustible, cg.ivaretenido, cs.iva
	...
	if($_GET[accion]==4){ //asignacionguiasempresariales.php
		...
		usuario='$_SESSION[NOMBREUSUARIO]', idusuario='$_SESSION[IDUSUARIO]'".(($_GET[prepagada]=="SI")?", foliosactivados='NO'":", foliosactivados='SI'");
	...
	if($_GET[accion]==5){ //asignacionguiasempresariales.php
		...
		consignaciondescuento, consignaciondescantidad
	...
	if($_GET[accion]==7){ //asignacionguiasempresariales.php
		...
		(folio, ncliente, nombre, paterno, materno,preocon,cantidad, usuario, fecha, status)
		VALUES 
		(NULL, '".$_GET[cliente]."', '".$_GET[nombre]."', '".$_GET[paterno]."', '".$_GET[materno]."',
		'".$_GET[preocon]."','".$_GET[cantidad]."','$_SESSION[IDUSUARIO]', CURRENT_DATE,' ')";
