<? session_start();
	...
	$s = "SELECT count(*) FROM traspasocreditoconcre";
	$get = mysql_query($s);
  ...
  <table width="500"  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#016193">
    ...
    <tr>
      <td height="300px" colspan="3" valign="top" class="Tablas" ><table width="100%" border="0" align="center" class="Tablas">
          <?			
		$s = "SELECT t.folio, date_format(t.fechatraspaso, '%d/%m/%Y') as fechatraspaso, cs.descripcion 
		FROM traspasocreditoconcre t
